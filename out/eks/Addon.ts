...
export default class extends aws.eks.Addon {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.eks.Addon>) {
        super(...args)
    ...
    invokeDeleteAddon(partialParams: ToOptional<{
      [K in keyof DeleteAddonRequest & keyof DeleteAddonRequest & keyof DeleteAddonRequest & keyof Omit<DeleteAddonRequest, "clusterName"> & keyof DeleteAddonRequest & keyof DeleteAddonRequest & keyof DeleteAddonRequest & keyof DeleteAddonRequest]: (DeleteAddonRequest & DeleteAddonRequest & DeleteAddonRequest & Omit<DeleteAddonRequest, "clusterName"> & DeleteAddonRequest & DeleteAddonRequest & DeleteAddonRequest & DeleteAddonRequest)[K]
    ...
    invokeDescribeAddon(partialParams: ToOptional<{
      [K in keyof DescribeAddonRequest & keyof DescribeAddonRequest & keyof DescribeAddonRequest & keyof Omit<DescribeAddonRequest, "clusterName"> & keyof DescribeAddonRequest & keyof DescribeAddonRequest & keyof DescribeAddonRequest & keyof DescribeAddonRequest]: (DescribeAddonRequest & DescribeAddonRequest & DescribeAddonRequest & Omit<DescribeAddonRequest, "clusterName"> & DescribeAddonRequest & DescribeAddonRequest & DescribeAddonRequest & DescribeAddonRequest)[K]
    ...
    invokeListAddons(partialParams: ToOptional<{
      [K in keyof ListAddonsRequest & keyof ListAddonsRequest & keyof ListAddonsRequest & keyof Omit<ListAddonsRequest, "clusterName"> & keyof ListAddonsRequest & keyof ListAddonsRequest & keyof ListAddonsRequest & keyof ListAddonsRequest]: (ListAddonsRequest & ListAddonsRequest & ListAddonsRequest & Omit<ListAddonsRequest, "clusterName"> & ListAddonsRequest & ListAddonsRequest & ListAddonsRequest & ListAddonsRequest)[K]
    ...
    invokeUpdateAddon(partialParams: ToOptional<{
      [K in keyof Omit<UpdateAddonRequest, "addonName"> & keyof UpdateAddonRequest & keyof UpdateAddonRequest & keyof Omit<UpdateAddonRequest, "clusterName"> & keyof UpdateAddonRequest & keyof UpdateAddonRequest & keyof UpdateAddonRequest & keyof UpdateAddonRequest]: (Omit<UpdateAddonRequest, "addonName"> & UpdateAddonRequest & UpdateAddonRequest & Omit<UpdateAddonRequest, "clusterName"> & UpdateAddonRequest & UpdateAddonRequest & UpdateAddonRequest & UpdateAddonRequest)[K]
    ...
    invokeUpdateClusterConfig(partialParams: ToOptional<{
      [K in keyof UpdateClusterConfigRequest & keyof UpdateClusterConfigRequest & keyof UpdateClusterConfigRequest & keyof UpdateClusterConfigRequest & keyof UpdateClusterConfigRequest & keyof UpdateClusterConfigRequest & keyof UpdateClusterConfigRequest & keyof UpdateClusterConfigRequest]: (UpdateClusterConfigRequest & UpdateClusterConfigRequest & UpdateClusterConfigRequest & UpdateClusterConfigRequest & UpdateClusterConfigRequest & UpdateClusterConfigRequest & UpdateClusterConfigRequest & UpdateClusterConfigRequest)[K]
    ...
    invokeUpdateClusterVersion(partialParams: ToOptional<{
      [K in keyof UpdateClusterVersionRequest & keyof UpdateClusterVersionRequest & keyof UpdateClusterVersionRequest & keyof UpdateClusterVersionRequest & keyof UpdateClusterVersionRequest & keyof UpdateClusterVersionRequest & keyof UpdateClusterVersionRequest & keyof UpdateClusterVersionRequest]: (UpdateClusterVersionRequest & UpdateClusterVersionRequest & UpdateClusterVersionRequest & UpdateClusterVersionRequest & UpdateClusterVersionRequest & UpdateClusterVersionRequest & UpdateClusterVersionRequest & UpdateClusterVersionRequest)[K]
    ...
    invokeUpdateNodegroupVersion(partialParams: ToOptional<{
      [K in keyof UpdateNodegroupVersionRequest & keyof UpdateNodegroupVersionRequest & keyof UpdateNodegroupVersionRequest & keyof Omit<UpdateNodegroupVersionRequest, "clusterName"> & keyof UpdateNodegroupVersionRequest & keyof UpdateNodegroupVersionRequest & keyof UpdateNodegroupVersionRequest & keyof UpdateNodegroupVersionRequest]: (UpdateNodegroupVersionRequest & UpdateNodegroupVersionRequest & UpdateNodegroupVersionRequest & Omit<UpdateNodegroupVersionRequest, "clusterName"> & UpdateNodegroupVersionRequest & UpdateNodegroupVersionRequest & UpdateNodegroupVersionRequest & UpdateNodegroupVersionRequest)[K]
