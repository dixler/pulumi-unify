...
export default class extends aws.elasticache.ParameterGroup {
    ...
    invokeCompleteMigration(partialParams: ToOptional<{
      [K in keyof CompleteMigrationMessage]: (CompleteMigrationMessage)[K]
    ...
    invokeCreateCacheParameterGroup(partialParams: ToOptional<{
      [K in keyof CreateCacheParameterGroupMessage & keyof Omit<CreateCacheParameterGroupMessage, "Description">]: (CreateCacheParameterGroupMessage)[K]
    ...
    invokeCreateCacheSecurityGroup(partialParams: ToOptional<{
      [K in keyof CreateCacheSecurityGroupMessage & keyof Omit<CreateCacheSecurityGroupMessage, "Description">]: (CreateCacheSecurityGroupMessage)[K]
    ...
    invokeCreateReplicationGroup(partialParams: ToOptional<{
      [K in keyof CreateReplicationGroupMessage]: (CreateReplicationGroupMessage)[K]
    ...
    invokeCreateSnapshot(partialParams: ToOptional<{
      [K in keyof CreateSnapshotMessage]: (CreateSnapshotMessage)[K]
    ...
    invokeCreateUser(partialParams: ToOptional<{
      [K in keyof CreateUserMessage]: (CreateUserMessage)[K]
    ...
    invokeCreateUserGroup(partialParams: ToOptional<{
      [K in keyof CreateUserGroupMessage]: (CreateUserGroupMessage)[K]
    ...
    invokeDecreaseReplicaCount(partialParams: ToOptional<{
      [K in keyof DecreaseReplicaCountMessage]: (DecreaseReplicaCountMessage)[K]
    ...
    invokeDeleteReplicationGroup(partialParams: ToOptional<{
      [K in keyof DeleteReplicationGroupMessage]: (DeleteReplicationGroupMessage)[K]
    ...
    invokeDeleteSnapshot(partialParams: ToOptional<{
      [K in keyof DeleteSnapshotMessage]: (DeleteSnapshotMessage)[K]
    ...
    invokeDisassociateGlobalReplicationGroup(partialParams: ToOptional<{
      [K in keyof DisassociateGlobalReplicationGroupMessage]: (DisassociateGlobalReplicationGroupMessage)[K]
    ...
    invokeIncreaseReplicaCount(partialParams: ToOptional<{
      [K in keyof IncreaseReplicaCountMessage]: (IncreaseReplicaCountMessage)[K]
    ...
    invokeModifyReplicationGroup(partialParams: ToOptional<{
      [K in keyof ModifyReplicationGroupMessage]: (ModifyReplicationGroupMessage)[K]
    ...
    invokeModifyReplicationGroupShardConfiguration(partialParams: ToOptional<{
      [K in keyof ModifyReplicationGroupShardConfigurationMessage]: (ModifyReplicationGroupShardConfigurationMessage)[K]
    ...
    invokeStartMigration(partialParams: ToOptional<{
      [K in keyof StartMigrationMessage]: (StartMigrationMessage)[K]
    ...
    invokeTestFailover(partialParams: ToOptional<{
      [K in keyof TestFailoverMessage]: (TestFailoverMessage)[K]
