...
export default class extends aws.elasticache.ReplicationGroup {
    ...
    invokeCreateReplicationGroup(partialParams: ToOptional<{
      [K in keyof CreateReplicationGroupMessage & keyof Omit<CreateReplicationGroupMessage, "ReplicationGroupId" | "ReplicationGroupDescription">]: (CreateReplicationGroupMessage)[K]
    ...
    invokeDisassociateGlobalReplicationGroup(partialParams: ToOptional<{
      [K in keyof DisassociateGlobalReplicationGroupMessage & keyof Omit<DisassociateGlobalReplicationGroupMessage, "GlobalReplicationGroupId" | "ReplicationGroupId">]: (DisassociateGlobalReplicationGroupMessage)[K]
    ...
    invokeFailoverGlobalReplicationGroup(partialParams: ToOptional<{
      [K in keyof FailoverGlobalReplicationGroupMessage & keyof Omit<FailoverGlobalReplicationGroupMessage, "GlobalReplicationGroupId">]: (FailoverGlobalReplicationGroupMessage)[K]
