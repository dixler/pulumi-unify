...
export default class extends aws.elasticache.User {
    ...
    invokeCreateUser(partialParams: ToOptional<{
      [K in keyof CreateUserMessage & keyof Omit<CreateUserMessage, "UserId" | "UserName" | "Engine" | "AccessString">]: (CreateUserMessage)[K]
    ...
    invokeDeleteUser(partialParams: ToOptional<{
      [K in keyof DeleteUserMessage & keyof Omit<DeleteUserMessage, "UserId">]: (DeleteUserMessage)[K]
    }>): Request<User, AWSError> {
        this.boot();
    ...
    invokeModifyUser(partialParams: ToOptional<{
      [K in keyof ModifyUserMessage & keyof Omit<ModifyUserMessage, "UserId">]: (ModifyUserMessage)[K]
    }>): Request<User, AWSError> {
        this.boot();
