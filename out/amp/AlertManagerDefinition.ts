...
export default class extends aws.amp.AlertManagerDefinition {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.amp.AlertManagerDefinition>) {
        super(...args)
    ...
    invokeCreateAlertManagerDefinition(partialParams: ToOptional<{
      [K in keyof CreateAlertManagerDefinitionRequest & keyof CreateAlertManagerDefinitionRequest]: (CreateAlertManagerDefinitionRequest & CreateAlertManagerDefinitionRequest)[K]
    ...
    invokeCreateRuleGroupsNamespace(partialParams: ToOptional<{
      [K in keyof CreateRuleGroupsNamespaceRequest & keyof CreateRuleGroupsNamespaceRequest]: (CreateRuleGroupsNamespaceRequest & CreateRuleGroupsNamespaceRequest)[K]
    ...
    invokeDeleteAlertManagerDefinition(partialParams: ToOptional<{
      [K in keyof DeleteAlertManagerDefinitionRequest & keyof DeleteAlertManagerDefinitionRequest]: (DeleteAlertManagerDefinitionRequest & DeleteAlertManagerDefinitionRequest)[K]
    ...
    invokeDeleteRuleGroupsNamespace(partialParams: ToOptional<{
      [K in keyof DeleteRuleGroupsNamespaceRequest & keyof DeleteRuleGroupsNamespaceRequest]: (DeleteRuleGroupsNamespaceRequest & DeleteRuleGroupsNamespaceRequest)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeDeleteWorkspace(partialParams: ToOptional<{
      [K in keyof DeleteWorkspaceRequest & keyof DeleteWorkspaceRequest]: (DeleteWorkspaceRequest & DeleteWorkspaceRequest)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeDescribeAlertManagerDefinition(partialParams: ToOptional<{
      [K in keyof DescribeAlertManagerDefinitionRequest & keyof DescribeAlertManagerDefinitionRequest]: (DescribeAlertManagerDefinitionRequest & DescribeAlertManagerDefinitionRequest)[K]
    ...
    invokeDescribeRuleGroupsNamespace(partialParams: ToOptional<{
      [K in keyof DescribeRuleGroupsNamespaceRequest & keyof DescribeRuleGroupsNamespaceRequest]: (DescribeRuleGroupsNamespaceRequest & DescribeRuleGroupsNamespaceRequest)[K]
    ...
    invokeDescribeWorkspace(partialParams: ToOptional<{
      [K in keyof DescribeWorkspaceRequest & keyof DescribeWorkspaceRequest]: (DescribeWorkspaceRequest & DescribeWorkspaceRequest)[K]
    ...
    invokeListRuleGroupsNamespaces(partialParams: ToOptional<{
      [K in keyof ListRuleGroupsNamespacesRequest & keyof ListRuleGroupsNamespacesRequest]: (ListRuleGroupsNamespacesRequest & ListRuleGroupsNamespacesRequest)[K]
    ...
    invokePutAlertManagerDefinition(partialParams: ToOptional<{
      [K in keyof PutAlertManagerDefinitionRequest & keyof PutAlertManagerDefinitionRequest]: (PutAlertManagerDefinitionRequest & PutAlertManagerDefinitionRequest)[K]
    ...
    invokePutRuleGroupsNamespace(partialParams: ToOptional<{
      [K in keyof PutRuleGroupsNamespaceRequest & keyof PutRuleGroupsNamespaceRequest]: (PutRuleGroupsNamespaceRequest & PutRuleGroupsNamespaceRequest)[K]
    ...
    invokeUpdateWorkspaceAlias(partialParams: ToOptional<{
      [K in keyof UpdateWorkspaceAliasRequest & keyof UpdateWorkspaceAliasRequest]: (UpdateWorkspaceAliasRequest & UpdateWorkspaceAliasRequest)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
