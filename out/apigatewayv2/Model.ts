...
export default class extends aws.apigatewayv2.Model {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.apigatewayv2.Model>) {
        super(...args)
        this.booted = false;
    ...
    invokeCreateModel(partialParams: ToOptional<{
      [K in keyof CreateModelRequest & keyof Omit<CreateModelRequest, "ApiId" | "Schema" | "Name">]: (CreateModelRequest)[K]
