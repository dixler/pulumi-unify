...
export default class extends aws.apigatewayv2.Stage {
    ...
    invokeCreateAuthorizer(partialParams: ToOptional<{
      [K in keyof CreateAuthorizerRequest & keyof Omit<CreateAuthorizerRequest, "ApiId" | "Name">]: (CreateAuthorizerRequest)[K]
    ...
    invokeCreateModel(partialParams: ToOptional<{
      [K in keyof CreateModelRequest & keyof Omit<CreateModelRequest, "ApiId" | "Name">]: (CreateModelRequest)[K]
    ...
    invokeCreateStage(partialParams: ToOptional<{
      [K in keyof CreateStageRequest & keyof Omit<CreateStageRequest, "ApiId" | "StageName">]: (CreateStageRequest)[K]
    ...
    invokeGetDeployment(partialParams: ToOptional<{
      [K in keyof GetDeploymentRequest & keyof Omit<GetDeploymentRequest, "ApiId" | "DeploymentId">]: (GetDeploymentRequest)[K]
    ...
    invokeGetStage(partialParams: ToOptional<{
      [K in keyof GetStageRequest & keyof Omit<GetStageRequest, "StageName" | "ApiId">]: (GetStageRequest)[K]
    ...
    invokeUpdateDeployment(partialParams: ToOptional<{
      [K in keyof UpdateDeploymentRequest & keyof Omit<UpdateDeploymentRequest, "ApiId" | "DeploymentId">]: (UpdateDeploymentRequest)[K]
    ...
    invokeUpdateStage(partialParams: ToOptional<{
      [K in keyof UpdateStageRequest & keyof Omit<UpdateStageRequest, "StageName" | "ApiId">]: (UpdateStageRequest)[K]
