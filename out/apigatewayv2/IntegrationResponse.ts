...
export default class extends aws.apigatewayv2.IntegrationResponse {
    ...
    invokeCreateIntegrationResponse(partialParams: ToOptional<{
      [K in keyof CreateIntegrationResponseRequest & keyof Omit<CreateIntegrationResponseRequest, "ApiId" | "IntegrationId" | "IntegrationResponseKey">]: (CreateIntegrationResponseRequest)[K]
    ...
    invokeGetIntegration(partialParams: ToOptional<{
      [K in keyof GetIntegrationRequest & keyof Omit<GetIntegrationRequest, "ApiId" | "IntegrationId">]: (GetIntegrationRequest)[K]
    ...
    invokeGetIntegrationResponse(partialParams: ToOptional<{
      [K in keyof GetIntegrationResponseRequest & keyof Omit<GetIntegrationResponseRequest, "ApiId" | "IntegrationId">]: (GetIntegrationResponseRequest)[K]
    ...
    invokeGetIntegrationResponses(partialParams: ToOptional<{
      [K in keyof GetIntegrationResponsesRequest & keyof Omit<GetIntegrationResponsesRequest, "IntegrationId" | "ApiId">]: (GetIntegrationResponsesRequest)[K]
    ...
    invokeUpdateIntegration(partialParams: ToOptional<{
      [K in keyof UpdateIntegrationRequest & keyof Omit<UpdateIntegrationRequest, "ApiId" | "IntegrationId">]: (UpdateIntegrationRequest)[K]
    ...
    invokeUpdateIntegrationResponse(partialParams: ToOptional<{
      [K in keyof UpdateIntegrationResponseRequest & keyof Omit<UpdateIntegrationResponseRequest, "ApiId" | "IntegrationId">]: (UpdateIntegrationResponseRequest)[K]
