...
export default class extends aws.apigatewayv2.RouteResponse {
    ...
    invokeCreateRouteResponse(partialParams: ToOptional<{
      [K in keyof CreateRouteResponseRequest & keyof Omit<CreateRouteResponseRequest, "ApiId" | "RouteId" | "RouteResponseKey">]: (CreateRouteResponseRequest)[K]
    ...
    invokeGetRoute(partialParams: ToOptional<{
      [K in keyof GetRouteRequest & keyof Omit<GetRouteRequest, "ApiId" | "RouteId">]: (GetRouteRequest)[K]
    ...
    invokeGetRouteResponse(partialParams: ToOptional<{
      [K in keyof GetRouteResponseRequest & keyof Omit<GetRouteResponseRequest, "ApiId" | "RouteId">]: (GetRouteResponseRequest)[K]
    ...
    invokeGetRouteResponses(partialParams: ToOptional<{
      [K in keyof GetRouteResponsesRequest & keyof Omit<GetRouteResponsesRequest, "RouteId" | "ApiId">]: (GetRouteResponsesRequest)[K]
    ...
    invokeUpdateRoute(partialParams: ToOptional<{
      [K in keyof UpdateRouteRequest & keyof Omit<UpdateRouteRequest, "ApiId" | "RouteId">]: (UpdateRouteRequest)[K]
    ...
    invokeUpdateRouteResponse(partialParams: ToOptional<{
      [K in keyof UpdateRouteResponseRequest & keyof Omit<UpdateRouteResponseRequest, "ApiId" | "RouteId">]: (UpdateRouteResponseRequest)[K]
