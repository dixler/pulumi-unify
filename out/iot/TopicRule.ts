...
export default class extends aws.iot.TopicRule {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.iot.TopicRule>) {
        super(...args)
    ...
    invokeUpdateTopicRuleDestination(partialParams: ToOptional<{
      [K in keyof Omit<UpdateTopicRuleDestinationRequest, "arn"> & keyof UpdateTopicRuleDestinationRequest & keyof UpdateTopicRuleDestinationRequest & keyof UpdateTopicRuleDestinationRequest & keyof UpdateTopicRuleDestinationRequest]: (Omit<UpdateTopicRuleDestinationRequest, "arn"> & UpdateTopicRuleDestinationRequest & UpdateTopicRuleDestinationRequest & UpdateTopicRuleDestinationRequest & UpdateTopicRuleDestinationRequest)[K]
