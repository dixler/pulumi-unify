...
export default class extends aws.iot.ThingType {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.iot.ThingType>) {
        super(...args)
    ...
    invokeDeleteTopicRuleDestination(partialParams: ToOptional<{
      [K in keyof Omit<DeleteTopicRuleDestinationRequest, "arn"> & keyof DeleteTopicRuleDestinationRequest]: (Omit<DeleteTopicRuleDestinationRequest, "arn"> & DeleteTopicRuleDestinationRequest)[K]
    ...
    invokeGetTopicRuleDestination(partialParams: ToOptional<{
      [K in keyof Omit<GetTopicRuleDestinationRequest, "arn"> & keyof GetTopicRuleDestinationRequest]: (Omit<GetTopicRuleDestinationRequest, "arn"> & GetTopicRuleDestinationRequest)[K]
    ...
    invokeUpdateDimension(partialParams: ToOptional<{
      [K in keyof UpdateDimensionRequest & keyof Omit<UpdateDimensionRequest, "name">]: (UpdateDimensionRequest & Omit<UpdateDimensionRequest, "name">)[K]
    ...
    invokeUpdateDynamicThingGroup(partialParams: ToOptional<{
      [K in keyof UpdateDynamicThingGroupRequest & keyof UpdateDynamicThingGroupRequest]: (UpdateDynamicThingGroupRequest & UpdateDynamicThingGroupRequest)[K]
    ...
    invokeUpdateThing(partialParams: ToOptional<{
      [K in keyof UpdateThingRequest & keyof UpdateThingRequest]: (UpdateThingRequest & UpdateThingRequest)[K]
    ...
    invokeUpdateThingGroup(partialParams: ToOptional<{
      [K in keyof UpdateThingGroupRequest & keyof UpdateThingGroupRequest]: (UpdateThingGroupRequest & UpdateThingGroupRequest)[K]
    ...
    invokeUpdateTopicRuleDestination(partialParams: ToOptional<{
      [K in keyof Omit<UpdateTopicRuleDestinationRequest, "arn"> & keyof UpdateTopicRuleDestinationRequest]: (Omit<UpdateTopicRuleDestinationRequest, "arn"> & UpdateTopicRuleDestinationRequest)[K]
