...
export default class extends aws.iot.ThingGroup {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.iot.ThingGroup>) {
        super(...args)
    ...
    invokeDeleteTopicRuleDestination(partialParams: ToOptional<{
      [K in keyof Omit<DeleteTopicRuleDestinationRequest, "arn"> & keyof DeleteTopicRuleDestinationRequest & keyof DeleteTopicRuleDestinationRequest]: (Omit<DeleteTopicRuleDestinationRequest, "arn"> & DeleteTopicRuleDestinationRequest & DeleteTopicRuleDestinationRequest)[K]
    ...
    invokeGetTopicRuleDestination(partialParams: ToOptional<{
      [K in keyof Omit<GetTopicRuleDestinationRequest, "arn"> & keyof GetTopicRuleDestinationRequest & keyof GetTopicRuleDestinationRequest]: (Omit<GetTopicRuleDestinationRequest, "arn"> & GetTopicRuleDestinationRequest & GetTopicRuleDestinationRequest)[K]
    ...
    invokeStartThingRegistrationTask(partialParams: ToOptional<{
      [K in keyof StartThingRegistrationTaskRequest & keyof StartThingRegistrationTaskRequest & keyof StartThingRegistrationTaskRequest]: (StartThingRegistrationTaskRequest & StartThingRegistrationTaskRequest & StartThingRegistrationTaskRequest)[K]
    ...
    invokeUpdateDimension(partialParams: ToOptional<{
      [K in keyof UpdateDimensionRequest & keyof Omit<UpdateDimensionRequest, "name"> & keyof UpdateDimensionRequest]: (UpdateDimensionRequest & Omit<UpdateDimensionRequest, "name"> & UpdateDimensionRequest)[K]
    ...
    invokeUpdateTopicRuleDestination(partialParams: ToOptional<{
      [K in keyof Omit<UpdateTopicRuleDestinationRequest, "arn"> & keyof UpdateTopicRuleDestinationRequest & keyof UpdateTopicRuleDestinationRequest]: (Omit<UpdateTopicRuleDestinationRequest, "arn"> & UpdateTopicRuleDestinationRequest & UpdateTopicRuleDestinationRequest)[K]
