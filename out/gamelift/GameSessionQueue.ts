...
export default class extends aws.gamelift.GameSessionQueue {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.gamelift.GameSessionQueue>) {
        super(...args)
    ...
    invokeAcceptMatch(partialParams: ToOptional<{
      [K in keyof AcceptMatchInput & keyof AcceptMatchInput]: (AcceptMatchInput & AcceptMatchInput)[K]
    }>): AcceptMatchOutput {
    ...
    invokeClaimGameServer(partialParams: ToOptional<{
      [K in keyof ClaimGameServerInput & keyof ClaimGameServerInput]: (ClaimGameServerInput & ClaimGameServerInput)[K]
    }>): ClaimGameServerOutput {
    ...
    invokeCreateAlias(partialParams: ToOptional<{
      [K in keyof CreateAliasInput & keyof CreateAliasInput]: (CreateAliasInput & CreateAliasInput)[K]
    }>): CreateAliasOutput {
    ...
    invokeCreateFleet(partialParams: ToOptional<{
      [K in keyof CreateFleetInput & keyof CreateFleetInput]: (CreateFleetInput & CreateFleetInput)[K]
    }>): CreateFleetOutput {
    ...
    invokeCreateFleetLocations(partialParams: ToOptional<{
      [K in keyof CreateFleetLocationsInput & keyof CreateFleetLocationsInput]: (CreateFleetLocationsInput & CreateFleetLocationsInput)[K]
    }>): CreateFleetLocationsOutput {
    ...
    invokeCreateGameServerGroup(partialParams: ToOptional<{
      [K in keyof CreateGameServerGroupInput & keyof CreateGameServerGroupInput]: (CreateGameServerGroupInput & CreateGameServerGroupInput)[K]
    }>): CreateGameServerGroupOutput {
    ...
    invokeCreateGameSession(partialParams: ToOptional<{
      [K in keyof CreateGameSessionInput & keyof CreateGameSessionInput]: (CreateGameSessionInput & CreateGameSessionInput)[K]
    }>): CreateGameSessionOutput {
    ...
    invokeCreateGameSessionQueue(partialParams: ToOptional<{
      [K in keyof CreateGameSessionQueueInput & keyof CreateGameSessionQueueInput]: (CreateGameSessionQueueInput & CreateGameSessionQueueInput)[K]
    }>): CreateGameSessionQueueOutput {
    ...
    invokeCreateMatchmakingConfiguration(partialParams: ToOptional<{
      [K in keyof CreateMatchmakingConfigurationInput & keyof CreateMatchmakingConfigurationInput]: (CreateMatchmakingConfigurationInput & CreateMatchmakingConfigurationInput)[K]
    }>): CreateMatchmakingConfigurationOutput {
    ...
    invokeCreateMatchmakingRuleSet(partialParams: ToOptional<{
      [K in keyof CreateMatchmakingRuleSetInput & keyof CreateMatchmakingRuleSetInput]: (CreateMatchmakingRuleSetInput & CreateMatchmakingRuleSetInput)[K]
    }>): CreateMatchmakingRuleSetOutput {
    ...
    invokeCreatePlayerSession(partialParams: ToOptional<{
      [K in keyof CreatePlayerSessionInput & keyof CreatePlayerSessionInput]: (CreatePlayerSessionInput & CreatePlayerSessionInput)[K]
    }>): CreatePlayerSessionOutput {
    ...
    invokeCreatePlayerSessions(partialParams: ToOptional<{
      [K in keyof CreatePlayerSessionsInput & keyof CreatePlayerSessionsInput]: (CreatePlayerSessionsInput & CreatePlayerSessionsInput)[K]
    }>): CreatePlayerSessionsOutput {
    ...
    invokeCreateVpcPeeringAuthorization(partialParams: ToOptional<{
      [K in keyof CreateVpcPeeringAuthorizationInput & keyof CreateVpcPeeringAuthorizationInput]: (CreateVpcPeeringAuthorizationInput & CreateVpcPeeringAuthorizationInput)[K]
    }>): CreateVpcPeeringAuthorizationOutput {
    ...
    invokeCreateVpcPeeringConnection(partialParams: ToOptional<{
      [K in keyof CreateVpcPeeringConnectionInput & keyof CreateVpcPeeringConnectionInput]: (CreateVpcPeeringConnectionInput & CreateVpcPeeringConnectionInput)[K]
    }>): CreateVpcPeeringConnectionOutput {
    ...
    invokeDeleteAlias(partialParams: ToOptional<{
      [K in keyof DeleteAliasInput & keyof DeleteAliasInput]: (DeleteAliasInput & DeleteAliasInput)[K]
    }>): void {
    ...
    invokeDeleteBuild(partialParams: ToOptional<{
      [K in keyof DeleteBuildInput & keyof DeleteBuildInput]: (DeleteBuildInput & DeleteBuildInput)[K]
    }>): void {
    ...
    invokeDeleteFleet(partialParams: ToOptional<{
      [K in keyof DeleteFleetInput & keyof DeleteFleetInput]: (DeleteFleetInput & DeleteFleetInput)[K]
    }>): void {
    ...
    invokeDeleteFleetLocations(partialParams: ToOptional<{
      [K in keyof DeleteFleetLocationsInput & keyof DeleteFleetLocationsInput]: (DeleteFleetLocationsInput & DeleteFleetLocationsInput)[K]
    }>): DeleteFleetLocationsOutput {
    ...
    invokeDeleteGameServerGroup(partialParams: ToOptional<{
      [K in keyof DeleteGameServerGroupInput & keyof DeleteGameServerGroupInput]: (DeleteGameServerGroupInput & DeleteGameServerGroupInput)[K]
    }>): DeleteGameServerGroupOutput {
    ...
    invokeDeleteGameSessionQueue(partialParams: ToOptional<{
      [K in keyof DeleteGameSessionQueueInput & keyof DeleteGameSessionQueueInput]: (DeleteGameSessionQueueInput & DeleteGameSessionQueueInput)[K]
    }>): DeleteGameSessionQueueOutput {
    ...
    invokeDeleteMatchmakingConfiguration(partialParams: ToOptional<{
      [K in keyof DeleteMatchmakingConfigurationInput & keyof DeleteMatchmakingConfigurationInput]: (DeleteMatchmakingConfigurationInput & DeleteMatchmakingConfigurationInput)[K]
    }>): DeleteMatchmakingConfigurationOutput {
    ...
    invokeDeleteMatchmakingRuleSet(partialParams: ToOptional<{
      [K in keyof DeleteMatchmakingRuleSetInput & keyof DeleteMatchmakingRuleSetInput]: (DeleteMatchmakingRuleSetInput & DeleteMatchmakingRuleSetInput)[K]
    }>): DeleteMatchmakingRuleSetOutput {
    ...
    invokeDeleteScalingPolicy(partialParams: ToOptional<{
      [K in keyof DeleteScalingPolicyInput & keyof DeleteScalingPolicyInput]: (DeleteScalingPolicyInput & DeleteScalingPolicyInput)[K]
    }>): void {
    ...
    invokeDeleteScript(partialParams: ToOptional<{
      [K in keyof DeleteScriptInput & keyof DeleteScriptInput]: (DeleteScriptInput & DeleteScriptInput)[K]
    }>): void {
    ...
    invokeDeleteVpcPeeringAuthorization(partialParams: ToOptional<{
      [K in keyof DeleteVpcPeeringAuthorizationInput & keyof DeleteVpcPeeringAuthorizationInput]: (DeleteVpcPeeringAuthorizationInput & DeleteVpcPeeringAuthorizationInput)[K]
    }>): DeleteVpcPeeringAuthorizationOutput {
    ...
    invokeDeleteVpcPeeringConnection(partialParams: ToOptional<{
      [K in keyof DeleteVpcPeeringConnectionInput & keyof DeleteVpcPeeringConnectionInput]: (DeleteVpcPeeringConnectionInput & DeleteVpcPeeringConnectionInput)[K]
    }>): DeleteVpcPeeringConnectionOutput {
    ...
    invokeDeregisterGameServer(partialParams: ToOptional<{
      [K in keyof DeregisterGameServerInput & keyof DeregisterGameServerInput]: (DeregisterGameServerInput & DeregisterGameServerInput)[K]
    }>): void {
    ...
    invokeDescribeAlias(partialParams: ToOptional<{
      [K in keyof DescribeAliasInput & keyof DescribeAliasInput]: (DescribeAliasInput & DescribeAliasInput)[K]
    }>): DescribeAliasOutput {
    ...
    invokeDescribeBuild(partialParams: ToOptional<{
      [K in keyof DescribeBuildInput & keyof DescribeBuildInput]: (DescribeBuildInput & DescribeBuildInput)[K]
    }>): DescribeBuildOutput {
    ...
    invokeDescribeFleetEvents(partialParams: ToOptional<{
      [K in keyof DescribeFleetEventsInput & keyof DescribeFleetEventsInput]: (DescribeFleetEventsInput & DescribeFleetEventsInput)[K]
    }>): DescribeFleetEventsOutput {
    ...
    invokeDescribeFleetLocationAttributes(partialParams: ToOptional<{
      [K in keyof DescribeFleetLocationAttributesInput & keyof DescribeFleetLocationAttributesInput]: (DescribeFleetLocationAttributesInput & DescribeFleetLocationAttributesInput)[K]
    }>): DescribeFleetLocationAttributesOutput {
    ...
    invokeDescribeFleetLocationCapacity(partialParams: ToOptional<{
      [K in keyof DescribeFleetLocationCapacityInput & keyof DescribeFleetLocationCapacityInput]: (DescribeFleetLocationCapacityInput & DescribeFleetLocationCapacityInput)[K]
    }>): DescribeFleetLocationCapacityOutput {
    ...
    invokeDescribeFleetLocationUtilization(partialParams: ToOptional<{
      [K in keyof DescribeFleetLocationUtilizationInput & keyof DescribeFleetLocationUtilizationInput]: (DescribeFleetLocationUtilizationInput & DescribeFleetLocationUtilizationInput)[K]
    }>): DescribeFleetLocationUtilizationOutput {
    ...
    invokeDescribeFleetPortSettings(partialParams: ToOptional<{
      [K in keyof DescribeFleetPortSettingsInput & keyof DescribeFleetPortSettingsInput]: (DescribeFleetPortSettingsInput & DescribeFleetPortSettingsInput)[K]
    }>): DescribeFleetPortSettingsOutput {
    ...
    invokeDescribeGameServer(partialParams: ToOptional<{
      [K in keyof DescribeGameServerInput & keyof DescribeGameServerInput]: (DescribeGameServerInput & DescribeGameServerInput)[K]
    }>): DescribeGameServerOutput {
    ...
    invokeDescribeGameServerGroup(partialParams: ToOptional<{
      [K in keyof DescribeGameServerGroupInput & keyof DescribeGameServerGroupInput]: (DescribeGameServerGroupInput & DescribeGameServerGroupInput)[K]
    }>): DescribeGameServerGroupOutput {
    ...
    invokeDescribeGameServerInstances(partialParams: ToOptional<{
      [K in keyof DescribeGameServerInstancesInput & keyof DescribeGameServerInstancesInput]: (DescribeGameServerInstancesInput & DescribeGameServerInstancesInput)[K]
    }>): DescribeGameServerInstancesOutput {
    ...
    invokeDescribeGameSessionPlacement(partialParams: ToOptional<{
      [K in keyof DescribeGameSessionPlacementInput & keyof DescribeGameSessionPlacementInput]: (DescribeGameSessionPlacementInput & DescribeGameSessionPlacementInput)[K]
    }>): DescribeGameSessionPlacementOutput {
    ...
    invokeDescribeInstances(partialParams: ToOptional<{
      [K in keyof DescribeInstancesInput & keyof DescribeInstancesInput]: (DescribeInstancesInput & DescribeInstancesInput)[K]
    }>): DescribeInstancesOutput {
    ...
    invokeDescribeMatchmaking(partialParams: ToOptional<{
      [K in keyof DescribeMatchmakingInput & keyof DescribeMatchmakingInput]: (DescribeMatchmakingInput & DescribeMatchmakingInput)[K]
    }>): DescribeMatchmakingOutput {
    ...
    invokeDescribeRuntimeConfiguration(partialParams: ToOptional<{
      [K in keyof DescribeRuntimeConfigurationInput & keyof DescribeRuntimeConfigurationInput]: (DescribeRuntimeConfigurationInput & DescribeRuntimeConfigurationInput)[K]
    }>): DescribeRuntimeConfigurationOutput {
    ...
    invokeDescribeScalingPolicies(partialParams: ToOptional<{
      [K in keyof DescribeScalingPoliciesInput & keyof DescribeScalingPoliciesInput]: (DescribeScalingPoliciesInput & DescribeScalingPoliciesInput)[K]
    }>): DescribeScalingPoliciesOutput {
    ...
    invokeDescribeScript(partialParams: ToOptional<{
      [K in keyof DescribeScriptInput & keyof DescribeScriptInput]: (DescribeScriptInput & DescribeScriptInput)[K]
    }>): DescribeScriptOutput {
    ...
    invokeGetGameSessionLogUrl(partialParams: ToOptional<{
      [K in keyof GetGameSessionLogUrlInput & keyof GetGameSessionLogUrlInput]: (GetGameSessionLogUrlInput & GetGameSessionLogUrlInput)[K]
    }>): GetGameSessionLogUrlOutput {
    ...
    invokeGetInstanceAccess(partialParams: ToOptional<{
      [K in keyof GetInstanceAccessInput & keyof GetInstanceAccessInput]: (GetInstanceAccessInput & GetInstanceAccessInput)[K]
    }>): GetInstanceAccessOutput {
    ...
    invokeListGameServers(partialParams: ToOptional<{
      [K in keyof ListGameServersInput & keyof ListGameServersInput]: (ListGameServersInput & ListGameServersInput)[K]
    }>): ListGameServersOutput {
    ...
    invokePutScalingPolicy(partialParams: ToOptional<{
      [K in keyof PutScalingPolicyInput & keyof Omit<PutScalingPolicyInput, "Name">]: (PutScalingPolicyInput & Omit<PutScalingPolicyInput, "Name">)[K]
    }>): PutScalingPolicyOutput {
    ...
    invokeRegisterGameServer(partialParams: ToOptional<{
      [K in keyof RegisterGameServerInput & keyof RegisterGameServerInput]: (RegisterGameServerInput & RegisterGameServerInput)[K]
    }>): RegisterGameServerOutput {
    ...
    invokeRequestUploadCredentials(partialParams: ToOptional<{
      [K in keyof RequestUploadCredentialsInput & keyof RequestUploadCredentialsInput]: (RequestUploadCredentialsInput & RequestUploadCredentialsInput)[K]
    }>): RequestUploadCredentialsOutput {
    ...
    invokeResolveAlias(partialParams: ToOptional<{
      [K in keyof ResolveAliasInput & keyof ResolveAliasInput]: (ResolveAliasInput & ResolveAliasInput)[K]
    }>): ResolveAliasOutput {
    ...
    invokeResumeGameServerGroup(partialParams: ToOptional<{
      [K in keyof ResumeGameServerGroupInput & keyof ResumeGameServerGroupInput]: (ResumeGameServerGroupInput & ResumeGameServerGroupInput)[K]
    }>): ResumeGameServerGroupOutput {
    ...
    invokeStartFleetActions(partialParams: ToOptional<{
      [K in keyof StartFleetActionsInput & keyof StartFleetActionsInput]: (StartFleetActionsInput & StartFleetActionsInput)[K]
    }>): StartFleetActionsOutput {
    ...
    invokeStartGameSessionPlacement(partialParams: ToOptional<{
      [K in keyof StartGameSessionPlacementInput & keyof StartGameSessionPlacementInput]: (StartGameSessionPlacementInput & StartGameSessionPlacementInput)[K]
    }>): StartGameSessionPlacementOutput {
    ...
    invokeStartMatchBackfill(partialParams: ToOptional<{
      [K in keyof StartMatchBackfillInput & keyof StartMatchBackfillInput]: (StartMatchBackfillInput & StartMatchBackfillInput)[K]
    }>): StartMatchBackfillOutput {
    ...
    invokeStartMatchmaking(partialParams: ToOptional<{
      [K in keyof StartMatchmakingInput & keyof StartMatchmakingInput]: (StartMatchmakingInput & StartMatchmakingInput)[K]
    }>): StartMatchmakingOutput {
    ...
    invokeStopFleetActions(partialParams: ToOptional<{
      [K in keyof StopFleetActionsInput & keyof StopFleetActionsInput]: (StopFleetActionsInput & StopFleetActionsInput)[K]
    }>): StopFleetActionsOutput {
    ...
    invokeStopGameSessionPlacement(partialParams: ToOptional<{
      [K in keyof StopGameSessionPlacementInput & keyof StopGameSessionPlacementInput]: (StopGameSessionPlacementInput & StopGameSessionPlacementInput)[K]
    }>): StopGameSessionPlacementOutput {
    ...
    invokeStopMatchmaking(partialParams: ToOptional<{
      [K in keyof StopMatchmakingInput & keyof StopMatchmakingInput]: (StopMatchmakingInput & StopMatchmakingInput)[K]
    }>): StopMatchmakingOutput {
    ...
    invokeSuspendGameServerGroup(partialParams: ToOptional<{
      [K in keyof SuspendGameServerGroupInput & keyof SuspendGameServerGroupInput]: (SuspendGameServerGroupInput & SuspendGameServerGroupInput)[K]
    }>): SuspendGameServerGroupOutput {
    ...
    invokeUpdateAlias(partialParams: ToOptional<{
      [K in keyof UpdateAliasInput & keyof UpdateAliasInput]: (UpdateAliasInput & UpdateAliasInput)[K]
    }>): UpdateAliasOutput {
    ...
    invokeUpdateBuild(partialParams: ToOptional<{
      [K in keyof UpdateBuildInput & keyof UpdateBuildInput]: (UpdateBuildInput & UpdateBuildInput)[K]
    }>): UpdateBuildOutput {
    ...
    invokeUpdateFleetAttributes(partialParams: ToOptional<{
      [K in keyof UpdateFleetAttributesInput & keyof UpdateFleetAttributesInput]: (UpdateFleetAttributesInput & UpdateFleetAttributesInput)[K]
    }>): UpdateFleetAttributesOutput {
    ...
    invokeUpdateFleetCapacity(partialParams: ToOptional<{
      [K in keyof UpdateFleetCapacityInput & keyof UpdateFleetCapacityInput]: (UpdateFleetCapacityInput & UpdateFleetCapacityInput)[K]
    }>): UpdateFleetCapacityOutput {
    ...
    invokeUpdateFleetPortSettings(partialParams: ToOptional<{
      [K in keyof UpdateFleetPortSettingsInput & keyof UpdateFleetPortSettingsInput]: (UpdateFleetPortSettingsInput & UpdateFleetPortSettingsInput)[K]
    }>): UpdateFleetPortSettingsOutput {
    ...
    invokeUpdateGameServer(partialParams: ToOptional<{
      [K in keyof UpdateGameServerInput & keyof UpdateGameServerInput]: (UpdateGameServerInput & UpdateGameServerInput)[K]
    }>): UpdateGameServerOutput {
    ...
    invokeUpdateGameServerGroup(partialParams: ToOptional<{
      [K in keyof UpdateGameServerGroupInput & keyof UpdateGameServerGroupInput]: (UpdateGameServerGroupInput & UpdateGameServerGroupInput)[K]
    }>): UpdateGameServerGroupOutput {
    ...
    invokeUpdateGameSession(partialParams: ToOptional<{
      [K in keyof UpdateGameSessionInput & keyof UpdateGameSessionInput]: (UpdateGameSessionInput & UpdateGameSessionInput)[K]
    }>): UpdateGameSessionOutput {
    ...
    invokeUpdateGameSessionQueue(partialParams: ToOptional<{
      [K in keyof UpdateGameSessionQueueInput & keyof Omit<UpdateGameSessionQueueInput, "Name">]: (UpdateGameSessionQueueInput & Omit<UpdateGameSessionQueueInput, "Name">)[K]
    }>): UpdateGameSessionQueueOutput {
    ...
    invokeUpdateMatchmakingConfiguration(partialParams: ToOptional<{
      [K in keyof UpdateMatchmakingConfigurationInput & keyof Omit<UpdateMatchmakingConfigurationInput, "Name">]: (UpdateMatchmakingConfigurationInput & Omit<UpdateMatchmakingConfigurationInput, "Name">)[K]
    }>): UpdateMatchmakingConfigurationOutput {
    ...
    invokeUpdateRuntimeConfiguration(partialParams: ToOptional<{
      [K in keyof UpdateRuntimeConfigurationInput & keyof UpdateRuntimeConfigurationInput]: (UpdateRuntimeConfigurationInput & UpdateRuntimeConfigurationInput)[K]
    }>): UpdateRuntimeConfigurationOutput {
    ...
    invokeUpdateScript(partialParams: ToOptional<{
      [K in keyof UpdateScriptInput & keyof UpdateScriptInput]: (UpdateScriptInput & UpdateScriptInput)[K]
    }>): UpdateScriptOutput {
    ...
    invokeValidateMatchmakingRuleSet(partialParams: ToOptional<{
      [K in keyof ValidateMatchmakingRuleSetInput & keyof ValidateMatchmakingRuleSetInput]: (ValidateMatchmakingRuleSetInput & ValidateMatchmakingRuleSetInput)[K]
    }>): ValidateMatchmakingRuleSetOutput {
