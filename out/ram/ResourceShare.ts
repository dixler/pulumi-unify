...
export default class extends aws.ram.ResourceShare {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.ram.ResourceShare>) {
        super(...args)
    ...
    invokeUpdateResourceShare(partialParams: ToOptional<{
      [K in keyof UpdateResourceShareRequest & keyof UpdateResourceShareRequest]: (UpdateResourceShareRequest & UpdateResourceShareRequest)[K]
