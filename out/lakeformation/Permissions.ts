...
export default class extends aws.lakeformation.Permissions {
    ...
    invokeGrantPermissions(partialParams: ToOptional<{
      [K in keyof GrantPermissionsRequest & keyof Omit<GrantPermissionsRequest, "Principal">]: (GrantPermissionsRequest)[K]
    ...
    invokeRevokePermissions(partialParams: ToOptional<{
      [K in keyof RevokePermissionsRequest & keyof Omit<RevokePermissionsRequest, "Principal">]: (RevokePermissionsRequest)[K]
