...
export default class extends aws.lakeformation.Resource {
    ...
    invokeDeregisterResource(partialParams: ToOptional<{
      [K in keyof DeregisterResourceRequest & keyof Omit<DeregisterResourceRequest, "ResourceArn">]: (DeregisterResourceRequest)[K]
    ...
    invokeDescribeResource(partialParams: ToOptional<{
      [K in keyof DescribeResourceRequest & keyof Omit<DescribeResourceRequest, "ResourceArn">]: (DescribeResourceRequest)[K]
    ...
    invokeGetEffectivePermissionsForPath(partialParams: ToOptional<{
      [K in keyof GetEffectivePermissionsForPathRequest & keyof Omit<GetEffectivePermissionsForPathRequest, "ResourceArn">]: (GetEffectivePermissionsForPathRequest)[K]
    ...
    invokeRegisterResource(partialParams: ToOptional<{
      [K in keyof RegisterResourceRequest & keyof Omit<RegisterResourceRequest, "ResourceArn">]: (RegisterResourceRequest)[K]
    ...
    invokeUpdateResource(partialParams: ToOptional<{
      [K in keyof UpdateResourceRequest & keyof Omit<UpdateResourceRequest, "RoleArn" | "ResourceArn">]: (UpdateResourceRequest)[K]
