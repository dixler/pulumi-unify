...
export default class extends aws.apprunner.CustomDomainAssociation {
    ...
    invokeAssociateCustomDomain(partialParams: ToOptional<{
      [K in keyof AssociateCustomDomainRequest & keyof Omit<AssociateCustomDomainRequest, "ServiceArn" | "DomainName">]: (AssociateCustomDomainRequest)[K]
    ...
    invokeDisassociateCustomDomain(partialParams: ToOptional<{
      [K in keyof DisassociateCustomDomainRequest & keyof Omit<DisassociateCustomDomainRequest, "ServiceArn" | "DomainName">]: (DisassociateCustomDomainRequest)[K]
