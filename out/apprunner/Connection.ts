...
export default class extends aws.apprunner.Connection {
    ...
    invokeCreateConnection(partialParams: ToOptional<{
      [K in keyof CreateConnectionRequest & keyof Omit<CreateConnectionRequest, "ConnectionName" | "ProviderType">]: (CreateConnectionRequest)[K]
    ...
    invokeDeleteConnection(partialParams: ToOptional<{
      [K in keyof DeleteConnectionRequest & keyof Omit<DeleteConnectionRequest, "ConnectionArn">]: (DeleteConnectionRequest)[K]
