...
export default class extends aws.kinesis.StreamConsumer {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.kinesis.StreamConsumer>) {
        super(...args)
    ...
    invokeStartStreamEncryption(partialParams: ToOptional<{
      [K in keyof StartStreamEncryptionInput & keyof StartStreamEncryptionInput & keyof StartStreamEncryptionInput & keyof StartStreamEncryptionInput]: (StartStreamEncryptionInput & StartStreamEncryptionInput & StartStreamEncryptionInput & StartStreamEncryptionInput)[K]
    }>): void {
    ...
    invokeStopStreamEncryption(partialParams: ToOptional<{
      [K in keyof StopStreamEncryptionInput & keyof StopStreamEncryptionInput & keyof StopStreamEncryptionInput & keyof StopStreamEncryptionInput]: (StopStreamEncryptionInput & StopStreamEncryptionInput & StopStreamEncryptionInput & StopStreamEncryptionInput)[K]
    }>): void {
    ...
    invokeUpdateStreamMode(partialParams: ToOptional<{
      [K in keyof UpdateStreamModeInput & keyof UpdateStreamModeInput & keyof UpdateStreamModeInput & keyof Omit<UpdateStreamModeInput, "StreamARN">]: (UpdateStreamModeInput & UpdateStreamModeInput & UpdateStreamModeInput & Omit<UpdateStreamModeInput, "StreamARN">)[K]
    }>): void {
