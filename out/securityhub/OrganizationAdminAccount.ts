...
export default class extends aws.securityhub.OrganizationAdminAccount {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.securityhub.OrganizationAdminAccount>) {
        super(...args)
        this.booted = false;
