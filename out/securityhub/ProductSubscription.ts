...
export default class extends aws.securityhub.ProductSubscription {
    ...
    invokeDisableImportFindingsForProduct(partialParams: ToOptional<{
      [K in keyof DisableImportFindingsForProductRequest & keyof Omit<DisableImportFindingsForProductRequest, "ProductSubscriptionArn">]: (DisableImportFindingsForProductRequest)[K]
    ...
    invokeEnableImportFindingsForProduct(partialParams: ToOptional<{
      [K in keyof EnableImportFindingsForProductRequest & keyof Omit<EnableImportFindingsForProductRequest, "ProductArn">]: (EnableImportFindingsForProductRequest)[K]
