...
export default class extends aws.servicediscovery.Service {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.servicediscovery.Service>) {
        super(...args)
        this.booted = false;
    ...
    invokeDiscoverInstances(partialParams: ToOptional<{
      [K in keyof DiscoverInstancesRequest & keyof Omit<DiscoverInstancesRequest, "ServiceName">]: (DiscoverInstancesRequest)[K]
