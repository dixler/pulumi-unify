...
export default class extends aws.codecommit.ApprovalRuleTemplateAssociation {
    ...
    invokeAssociateApprovalRuleTemplateWithRepository(partialParams: ToOptional<{
      [K in keyof Omit<AssociateApprovalRuleTemplateWithRepositoryInput, "approvalRuleTemplateName"> & keyof AssociateApprovalRuleTemplateWithRepositoryInput]: (Omit<AssociateApprovalRuleTemplateWithRepositoryInput, "approvalRuleTemplateName"> & AssociateApprovalRuleTemplateWithRepositoryInput)[K]
    ...
    invokeBatchAssociateApprovalRuleTemplateWithRepositories(partialParams: ToOptional<{
      [K in keyof Omit<BatchAssociateApprovalRuleTemplateWithRepositoriesInput, "approvalRuleTemplateName"> & keyof BatchAssociateApprovalRuleTemplateWithRepositoriesInput]: (Omit<BatchAssociateApprovalRuleTemplateWithRepositoriesInput, "approvalRuleTemplateName"> & BatchAssociateApprovalRuleTemplateWithRepositoriesInput)[K]
    ...
    invokeBatchDisassociateApprovalRuleTemplateFromRepositories(partialParams: ToOptional<{
      [K in keyof Omit<BatchDisassociateApprovalRuleTemplateFromRepositoriesInput, "approvalRuleTemplateName"> & keyof BatchDisassociateApprovalRuleTemplateFromRepositoriesInput]: (Omit<BatchDisassociateApprovalRuleTemplateFromRepositoriesInput, "approvalRuleTemplateName"> & BatchDisassociateApprovalRuleTemplateFromRepositoriesInput)[K]
    ...
    invokeCreateApprovalRuleTemplate(partialParams: ToOptional<{
      [K in keyof Omit<CreateApprovalRuleTemplateInput, "approvalRuleTemplateName"> & keyof CreateApprovalRuleTemplateInput]: (Omit<CreateApprovalRuleTemplateInput, "approvalRuleTemplateName"> & CreateApprovalRuleTemplateInput)[K]
    ...
    invokeDeleteApprovalRuleTemplate(partialParams: ToOptional<{
      [K in keyof Omit<DeleteApprovalRuleTemplateInput, "approvalRuleTemplateName"> & keyof DeleteApprovalRuleTemplateInput]: (Omit<DeleteApprovalRuleTemplateInput, "approvalRuleTemplateName"> & DeleteApprovalRuleTemplateInput)[K]
    ...
    invokeDisassociateApprovalRuleTemplateFromRepository(partialParams: ToOptional<{
      [K in keyof Omit<DisassociateApprovalRuleTemplateFromRepositoryInput, "approvalRuleTemplateName"> & keyof DisassociateApprovalRuleTemplateFromRepositoryInput]: (Omit<DisassociateApprovalRuleTemplateFromRepositoryInput, "approvalRuleTemplateName"> & DisassociateApprovalRuleTemplateFromRepositoryInput)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeGetApprovalRuleTemplate(partialParams: ToOptional<{
      [K in keyof Omit<GetApprovalRuleTemplateInput, "approvalRuleTemplateName"> & keyof GetApprovalRuleTemplateInput]: (Omit<GetApprovalRuleTemplateInput, "approvalRuleTemplateName"> & GetApprovalRuleTemplateInput)[K]
    ...
    invokeListRepositoriesForApprovalRuleTemplate(partialParams: ToOptional<{
      [K in keyof Omit<ListRepositoriesForApprovalRuleTemplateInput, "approvalRuleTemplateName"> & keyof ListRepositoriesForApprovalRuleTemplateInput]: (Omit<ListRepositoriesForApprovalRuleTemplateInput, "approvalRuleTemplateName"> & ListRepositoriesForApprovalRuleTemplateInput)[K]
    ...
    invokeUpdateApprovalRuleTemplateContent(partialParams: ToOptional<{
      [K in keyof Omit<UpdateApprovalRuleTemplateContentInput, "approvalRuleTemplateName"> & keyof UpdateApprovalRuleTemplateContentInput]: (Omit<UpdateApprovalRuleTemplateContentInput, "approvalRuleTemplateName"> & UpdateApprovalRuleTemplateContentInput)[K]
    ...
    invokeUpdateApprovalRuleTemplateDescription(partialParams: ToOptional<{
      [K in keyof Omit<UpdateApprovalRuleTemplateDescriptionInput, "approvalRuleTemplateName"> & keyof UpdateApprovalRuleTemplateDescriptionInput]: (Omit<UpdateApprovalRuleTemplateDescriptionInput, "approvalRuleTemplateName"> & UpdateApprovalRuleTemplateDescriptionInput)[K]
    ...
    invokeUpdateApprovalRuleTemplateName(partialParams: ToOptional<{
      [K in keyof Omit<UpdateApprovalRuleTemplateNameInput, "oldApprovalRuleTemplateName"|"newApprovalRuleTemplateName"> & keyof UpdateApprovalRuleTemplateNameInput]: (Omit<UpdateApprovalRuleTemplateNameInput, "oldApprovalRuleTemplateName"|"newApprovalRuleTemplateName"> & UpdateApprovalRuleTemplateNameInput)[K]
