...
export default class extends aws.apigateway.RequestValidator {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.apigateway.RequestValidator>) {
        super(...args)
    ...
    invokeTestInvokeMethod(partialParams: ToOptional<{
      [K in keyof TestInvokeMethodRequest & keyof TestInvokeMethodRequest]: (TestInvokeMethodRequest & TestInvokeMethodRequest)[K]
    ...
    invokeUpdateDeployment(partialParams: ToOptional<{
      [K in keyof UpdateDeploymentRequest & keyof UpdateDeploymentRequest]: (UpdateDeploymentRequest & UpdateDeploymentRequest)[K]
    }>): Request<Deployment, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateDocumentationPart(partialParams: ToOptional<{
      [K in keyof UpdateDocumentationPartRequest & keyof UpdateDocumentationPartRequest]: (UpdateDocumentationPartRequest & UpdateDocumentationPartRequest)[K]
    }>): Request<DocumentationPart, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateDocumentationVersion(partialParams: ToOptional<{
      [K in keyof UpdateDocumentationVersionRequest & keyof UpdateDocumentationVersionRequest]: (UpdateDocumentationVersionRequest & UpdateDocumentationVersionRequest)[K]
    }>): Request<DocumentationVersion, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateGatewayResponse(partialParams: ToOptional<{
      [K in keyof UpdateGatewayResponseRequest & keyof UpdateGatewayResponseRequest]: (UpdateGatewayResponseRequest & UpdateGatewayResponseRequest)[K]
    }>): Request<GatewayResponse, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateIntegration(partialParams: ToOptional<{
      [K in keyof UpdateIntegrationRequest & keyof UpdateIntegrationRequest]: (UpdateIntegrationRequest & UpdateIntegrationRequest)[K]
    }>): Request<Integration, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateIntegrationResponse(partialParams: ToOptional<{
      [K in keyof UpdateIntegrationResponseRequest & keyof UpdateIntegrationResponseRequest]: (UpdateIntegrationResponseRequest & UpdateIntegrationResponseRequest)[K]
    }>): Request<IntegrationResponse, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateMethod(partialParams: ToOptional<{
      [K in keyof UpdateMethodRequest & keyof UpdateMethodRequest]: (UpdateMethodRequest & UpdateMethodRequest)[K]
    }>): Request<Method, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateMethodResponse(partialParams: ToOptional<{
      [K in keyof UpdateMethodResponseRequest & keyof UpdateMethodResponseRequest]: (UpdateMethodResponseRequest & UpdateMethodResponseRequest)[K]
    }>): Request<MethodResponse, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateModel(partialParams: ToOptional<{
      [K in keyof UpdateModelRequest & keyof UpdateModelRequest]: (UpdateModelRequest & UpdateModelRequest)[K]
    }>): Request<Model, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateRequestValidator(partialParams: ToOptional<{
      [K in keyof UpdateRequestValidatorRequest & keyof UpdateRequestValidatorRequest]: (UpdateRequestValidatorRequest & UpdateRequestValidatorRequest)[K]
    }>): Request<RequestValidator, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateRestApi(partialParams: ToOptional<{
      [K in keyof UpdateRestApiRequest & keyof UpdateRestApiRequest]: (UpdateRestApiRequest & UpdateRestApiRequest)[K]
    }>): Request<RestApi, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateStage(partialParams: ToOptional<{
      [K in keyof UpdateStageRequest & keyof UpdateStageRequest]: (UpdateStageRequest & UpdateStageRequest)[K]
    }>): Request<Stage, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
