...
export default class extends aws.apigateway.MethodSettings {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.apigateway.MethodSettings>) {
        super(...args)
    ...
    invokeTestInvokeMethod(partialParams: ToOptional<{
      [K in keyof TestInvokeMethodRequest & keyof TestInvokeMethodRequest & keyof TestInvokeMethodRequest]: (TestInvokeMethodRequest & TestInvokeMethodRequest & TestInvokeMethodRequest)[K]
    }>): TestInvokeMethodResponse {
    ...
    invokeUpdateDocumentationPart(partialParams: ToOptional<{
      [K in keyof UpdateDocumentationPartRequest & keyof UpdateDocumentationPartRequest & keyof UpdateDocumentationPartRequest]: (UpdateDocumentationPartRequest & UpdateDocumentationPartRequest & UpdateDocumentationPartRequest)[K]
    }>): DocumentationPart {
    ...
    invokeUpdateDocumentationVersion(partialParams: ToOptional<{
      [K in keyof UpdateDocumentationVersionRequest & keyof UpdateDocumentationVersionRequest & keyof UpdateDocumentationVersionRequest]: (UpdateDocumentationVersionRequest & UpdateDocumentationVersionRequest & UpdateDocumentationVersionRequest)[K]
    }>): DocumentationVersion {
    ...
    invokeUpdateGatewayResponse(partialParams: ToOptional<{
      [K in keyof UpdateGatewayResponseRequest & keyof UpdateGatewayResponseRequest & keyof UpdateGatewayResponseRequest]: (UpdateGatewayResponseRequest & UpdateGatewayResponseRequest & UpdateGatewayResponseRequest)[K]
    }>): GatewayResponse {
    ...
    invokeUpdateMethod(partialParams: ToOptional<{
      [K in keyof UpdateMethodRequest & keyof UpdateMethodRequest & keyof UpdateMethodRequest]: (UpdateMethodRequest & UpdateMethodRequest & UpdateMethodRequest)[K]
    }>): Method {
    ...
    invokeUpdateMethodResponse(partialParams: ToOptional<{
      [K in keyof UpdateMethodResponseRequest & keyof UpdateMethodResponseRequest & keyof UpdateMethodResponseRequest]: (UpdateMethodResponseRequest & UpdateMethodResponseRequest & UpdateMethodResponseRequest)[K]
    }>): MethodResponse {
    ...
    invokeUpdateRequestValidator(partialParams: ToOptional<{
      [K in keyof UpdateRequestValidatorRequest & keyof UpdateRequestValidatorRequest & keyof UpdateRequestValidatorRequest]: (UpdateRequestValidatorRequest & UpdateRequestValidatorRequest & UpdateRequestValidatorRequest)[K]
    }>): RequestValidator {
    ...
    invokeUpdateResource(partialParams: ToOptional<{
      [K in keyof UpdateResourceRequest & keyof UpdateResourceRequest & keyof UpdateResourceRequest]: (UpdateResourceRequest & UpdateResourceRequest & UpdateResourceRequest)[K]
    }>): Resource {
    ...
    invokeUpdateRestApi(partialParams: ToOptional<{
      [K in keyof UpdateRestApiRequest & keyof UpdateRestApiRequest & keyof UpdateRestApiRequest]: (UpdateRestApiRequest & UpdateRestApiRequest & UpdateRestApiRequest)[K]
    }>): RestApi {
    ...
    invokeUpdateStage(partialParams: ToOptional<{
      [K in keyof UpdateStageRequest & keyof UpdateStageRequest & keyof Omit<UpdateStageRequest, "stageName">]: (UpdateStageRequest & UpdateStageRequest & Omit<UpdateStageRequest, "stageName">)[K]
    }>): Stage {
