...
export default class extends aws.apigateway.Response {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.apigateway.Response>) {
        super(...args)
    ...
    invokeGetGatewayResponse(partialParams: ToOptional<{
      [K in keyof Omit<GetGatewayResponseRequest, "responseType"> & keyof GetGatewayResponseRequest & keyof GetGatewayResponseRequest]: (Omit<GetGatewayResponseRequest, "responseType"> & GetGatewayResponseRequest & GetGatewayResponseRequest)[K]
    }>): GatewayResponse {
    ...
    invokePutGatewayResponse(partialParams: ToOptional<{
      [K in keyof Omit<PutGatewayResponseRequest, "responseType"> & keyof PutGatewayResponseRequest & keyof PutGatewayResponseRequest]: (Omit<PutGatewayResponseRequest, "responseType"> & PutGatewayResponseRequest & PutGatewayResponseRequest)[K]
    }>): GatewayResponse {
    ...
    invokeUpdateGatewayResponse(partialParams: ToOptional<{
      [K in keyof Omit<UpdateGatewayResponseRequest, "responseType"> & keyof Omit<UpdateGatewayResponseRequest, "restApiId"> & keyof UpdateGatewayResponseRequest]: (Omit<UpdateGatewayResponseRequest, "responseType"> & Omit<UpdateGatewayResponseRequest, "restApiId"> & UpdateGatewayResponseRequest)[K]
    }>): GatewayResponse {
    ...
    invokeUpdateIntegrationResponse(partialParams: ToOptional<{
      [K in keyof UpdateIntegrationResponseRequest & keyof Omit<UpdateIntegrationResponseRequest, "restApiId"> & keyof Omit<UpdateIntegrationResponseRequest, "statusCode">]: (UpdateIntegrationResponseRequest & Omit<UpdateIntegrationResponseRequest, "restApiId"> & Omit<UpdateIntegrationResponseRequest, "statusCode">)[K]
    }>): IntegrationResponse {
    ...
    invokeUpdateMethodResponse(partialParams: ToOptional<{
      [K in keyof UpdateMethodResponseRequest & keyof Omit<UpdateMethodResponseRequest, "restApiId"> & keyof Omit<UpdateMethodResponseRequest, "statusCode">]: (UpdateMethodResponseRequest & Omit<UpdateMethodResponseRequest, "restApiId"> & Omit<UpdateMethodResponseRequest, "statusCode">)[K]
    }>): MethodResponse {
