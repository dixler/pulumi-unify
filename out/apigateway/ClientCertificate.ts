...
export default class extends aws.apigateway.ClientCertificate {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.apigateway.ClientCertificate>) {
        super(...args)
    ...
    invokeUpdateUsage(partialParams: ToOptional<{
      [K in keyof UpdateUsageRequest & keyof UpdateUsageRequest & keyof UpdateUsageRequest & keyof UpdateUsageRequest & keyof UpdateUsageRequest]: (UpdateUsageRequest & UpdateUsageRequest & UpdateUsageRequest & UpdateUsageRequest & UpdateUsageRequest)[K]
    }>): Request<Usage, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateUsagePlan(partialParams: ToOptional<{
      [K in keyof UpdateUsagePlanRequest & keyof UpdateUsagePlanRequest & keyof UpdateUsagePlanRequest & keyof UpdateUsagePlanRequest & keyof UpdateUsagePlanRequest]: (UpdateUsagePlanRequest & UpdateUsagePlanRequest & UpdateUsagePlanRequest & UpdateUsagePlanRequest & UpdateUsagePlanRequest)[K]
    }>): Request<UsagePlan, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
