...
export default class extends aws.connect.Queue {
    ...
    invokeCreateContactFlow(partialParams: ToOptional<{
      [K in keyof CreateContactFlowRequest & keyof Omit<CreateContactFlowRequest, "InstanceId" | "Name">]: (CreateContactFlowRequest)[K]
    ...
    invokeCreateContactFlowModule(partialParams: ToOptional<{
      [K in keyof CreateContactFlowModuleRequest & keyof Omit<CreateContactFlowModuleRequest, "InstanceId" | "Name">]: (CreateContactFlowModuleRequest)[K]
    ...
    invokeCreateQueue(partialParams: ToOptional<{
      [K in keyof CreateQueueRequest & keyof Omit<CreateQueueRequest, "InstanceId" | "Name" | "HoursOfOperationId">]: (CreateQueueRequest)[K]
    ...
    invokeDescribeHoursOfOperation(partialParams: ToOptional<{
      [K in keyof DescribeHoursOfOperationRequest & keyof Omit<DescribeHoursOfOperationRequest, "InstanceId" | "HoursOfOperationId">]: (DescribeHoursOfOperationRequest)[K]
    ...
    invokeDescribeQueue(partialParams: ToOptional<{
      [K in keyof DescribeQueueRequest & keyof Omit<DescribeQueueRequest, "InstanceId" | "QueueId">]: (DescribeQueueRequest)[K]
    ...
    invokeListQueueQuickConnects(partialParams: ToOptional<{
      [K in keyof ListQueueQuickConnectsRequest & keyof Omit<ListQueueQuickConnectsRequest, "InstanceId" | "QueueId">]: (ListQueueQuickConnectsRequest)[K]
