...
export default class extends aws.connect.Instance {
    ...
    invokeCreateInstance(partialParams: ToOptional<{
      [K in keyof CreateInstanceRequest & keyof Omit<CreateInstanceRequest, "IdentityManagementType">]: (CreateInstanceRequest)[K]
    ...
    invokeListAgentStatuses(partialParams: ToOptional<{
      [K in keyof ListAgentStatusRequest]: (ListAgentStatusRequest)[K]
    ...
    invokeListApprovedOrigins(partialParams: ToOptional<{
      [K in keyof ListApprovedOriginsRequest]: (ListApprovedOriginsRequest)[K]
    ...
    invokeListContactFlowModules(partialParams: ToOptional<{
      [K in keyof ListContactFlowModulesRequest]: (ListContactFlowModulesRequest)[K]
    ...
    invokeListContactFlows(partialParams: ToOptional<{
      [K in keyof ListContactFlowsRequest]: (ListContactFlowsRequest)[K]
    ...
    invokeListContactReferences(partialParams: ToOptional<{
      [K in keyof ListContactReferencesRequest]: (ListContactReferencesRequest)[K]
    ...
    invokeListDefaultVocabularies(partialParams: ToOptional<{
      [K in keyof ListDefaultVocabulariesRequest]: (ListDefaultVocabulariesRequest)[K]
    ...
    invokeListHoursOfOperations(partialParams: ToOptional<{
      [K in keyof ListHoursOfOperationsRequest]: (ListHoursOfOperationsRequest)[K]
    ...
    invokeListInstanceAttributes(partialParams: ToOptional<{
      [K in keyof ListInstanceAttributesRequest]: (ListInstanceAttributesRequest)[K]
    ...
    invokeListInstanceStorageConfigs(partialParams: ToOptional<{
      [K in keyof ListInstanceStorageConfigsRequest]: (ListInstanceStorageConfigsRequest)[K]
    ...
    invokeListIntegrationAssociations(partialParams: ToOptional<{
      [K in keyof ListIntegrationAssociationsRequest]: (ListIntegrationAssociationsRequest)[K]
    ...
    invokeListLambdaFunctions(partialParams: ToOptional<{
      [K in keyof ListLambdaFunctionsRequest]: (ListLambdaFunctionsRequest)[K]
    ...
    invokeListLexBots(partialParams: ToOptional<{
      [K in keyof ListLexBotsRequest]: (ListLexBotsRequest)[K]
    ...
    invokeListPrompts(partialParams: ToOptional<{
      [K in keyof ListPromptsRequest]: (ListPromptsRequest)[K]
    ...
    invokeListQueueQuickConnects(partialParams: ToOptional<{
      [K in keyof ListQueueQuickConnectsRequest]: (ListQueueQuickConnectsRequest)[K]
    ...
    invokeListQuickConnects(partialParams: ToOptional<{
      [K in keyof ListQuickConnectsRequest]: (ListQuickConnectsRequest)[K]
    ...
    invokeListRoutingProfileQueues(partialParams: ToOptional<{
      [K in keyof ListRoutingProfileQueuesRequest]: (ListRoutingProfileQueuesRequest)[K]
    ...
    invokeListRoutingProfiles(partialParams: ToOptional<{
      [K in keyof ListRoutingProfilesRequest]: (ListRoutingProfilesRequest)[K]
    ...
    invokeListSecurityKeys(partialParams: ToOptional<{
      [K in keyof ListSecurityKeysRequest]: (ListSecurityKeysRequest)[K]
    ...
    invokeListSecurityProfilePermissions(partialParams: ToOptional<{
      [K in keyof ListSecurityProfilePermissionsRequest]: (ListSecurityProfilePermissionsRequest)[K]
    ...
    invokeListUseCases(partialParams: ToOptional<{
      [K in keyof ListUseCasesRequest]: (ListUseCasesRequest)[K]
    ...
    invokeListUserHierarchyGroups(partialParams: ToOptional<{
      [K in keyof ListUserHierarchyGroupsRequest]: (ListUserHierarchyGroupsRequest)[K]
    ...
    invokeResumeContactRecording(partialParams: ToOptional<{
      [K in keyof ResumeContactRecordingRequest]: (ResumeContactRecordingRequest)[K]
    ...
    invokeSearchVocabularies(partialParams: ToOptional<{
      [K in keyof SearchVocabulariesRequest]: (SearchVocabulariesRequest)[K]
    ...
    invokeStartChatContact(partialParams: ToOptional<{
      [K in keyof StartChatContactRequest]: (StartChatContactRequest)[K]
    ...
    invokeStartContactRecording(partialParams: ToOptional<{
      [K in keyof StartContactRecordingRequest]: (StartContactRecordingRequest)[K]
    ...
    invokeStartContactStreaming(partialParams: ToOptional<{
      [K in keyof StartContactStreamingRequest]: (StartContactStreamingRequest)[K]
    ...
    invokeStartOutboundVoiceContact(partialParams: ToOptional<{
      [K in keyof StartOutboundVoiceContactRequest]: (StartOutboundVoiceContactRequest)[K]
    ...
    invokeStartTaskContact(partialParams: ToOptional<{
      [K in keyof StartTaskContactRequest]: (StartTaskContactRequest)[K]
    ...
    invokeStopContact(partialParams: ToOptional<{
      [K in keyof StopContactRequest]: (StopContactRequest)[K]
    ...
    invokeStopContactRecording(partialParams: ToOptional<{
      [K in keyof StopContactRecordingRequest]: (StopContactRecordingRequest)[K]
    ...
    invokeStopContactStreaming(partialParams: ToOptional<{
      [K in keyof StopContactStreamingRequest]: (StopContactStreamingRequest)[K]
    ...
    invokeSuspendContactRecording(partialParams: ToOptional<{
      [K in keyof SuspendContactRecordingRequest]: (SuspendContactRecordingRequest)[K]
    ...
    invokeUpdateContact(partialParams: ToOptional<{
      [K in keyof UpdateContactRequest]: (UpdateContactRequest)[K]
    ...
    invokeUpdateContactAttributes(partialParams: ToOptional<{
      [K in keyof UpdateContactAttributesRequest]: (UpdateContactAttributesRequest)[K]
    ...
    invokeUpdateContactFlowModuleContent(partialParams: ToOptional<{
      [K in keyof UpdateContactFlowModuleContentRequest]: (UpdateContactFlowModuleContentRequest)[K]
    ...
    invokeUpdateContactFlowModuleMetadata(partialParams: ToOptional<{
      [K in keyof UpdateContactFlowModuleMetadataRequest]: (UpdateContactFlowModuleMetadataRequest)[K]
    ...
    invokeUpdateContactSchedule(partialParams: ToOptional<{
      [K in keyof UpdateContactScheduleRequest]: (UpdateContactScheduleRequest)[K]
