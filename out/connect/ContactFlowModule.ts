...
export default class extends aws.connect.ContactFlowModule {
    ...
    invokeCreateContactFlow(partialParams: ToOptional<{
      [K in keyof CreateContactFlowRequest & keyof Omit<CreateContactFlowRequest, "InstanceId" | "Name" | "Content">]: (CreateContactFlowRequest)[K]
    ...
    invokeDeleteContactFlowModule(partialParams: ToOptional<{
      [K in keyof DeleteContactFlowModuleRequest & keyof Omit<DeleteContactFlowModuleRequest, "InstanceId" | "ContactFlowModuleId">]: (DeleteContactFlowModuleRequest)[K]
    ...
    invokeDescribeContactFlowModule(partialParams: ToOptional<{
      [K in keyof DescribeContactFlowModuleRequest & keyof Omit<DescribeContactFlowModuleRequest, "InstanceId" | "ContactFlowModuleId">]: (DescribeContactFlowModuleRequest)[K]
    ...
    invokeStartTaskContact(partialParams: ToOptional<{
      [K in keyof StartTaskContactRequest & keyof Omit<StartTaskContactRequest, "InstanceId" | "Name">]: (StartTaskContactRequest)[K]
    ...
    invokeUpdateContactFlowModuleContent(partialParams: ToOptional<{
      [K in keyof UpdateContactFlowModuleContentRequest & keyof Omit<UpdateContactFlowModuleContentRequest, "InstanceId" | "ContactFlowModuleId" | "Content">]: (UpdateContactFlowModuleContentRequest)[K]
    ...
    invokeUpdateContactFlowModuleMetadata(partialParams: ToOptional<{
      [K in keyof UpdateContactFlowModuleMetadataRequest & keyof Omit<UpdateContactFlowModuleMetadataRequest, "InstanceId" | "ContactFlowModuleId">]: (UpdateContactFlowModuleMetadataRequest)[K]
