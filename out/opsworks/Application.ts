...
export default class extends aws.opsworks.Application {
    ...
    invokeCreateApp(partialParams: ToOptional<{
      [K in keyof CreateAppRequest & keyof Omit<CreateAppRequest, "StackId" | "Name" | "Type">]: (CreateAppRequest)[K]
    ...
    invokeCreateLayer(partialParams: ToOptional<{
      [K in keyof CreateLayerRequest & keyof Omit<CreateLayerRequest, "StackId" | "Type" | "Name">]: (CreateLayerRequest)[K]
