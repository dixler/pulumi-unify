...
export default class extends aws.opsworks.UserProfile {
    ...
    invokeCreateLayer(partialParams: ToOptional<{
      [K in keyof CreateLayerRequest]: (CreateLayerRequest)[K]
    ...
    invokeDescribeRdsDbInstances(partialParams: ToOptional<{
      [K in keyof DescribeRdsDbInstancesRequest]: (DescribeRdsDbInstancesRequest)[K]
    ...
    invokeDescribeStackProvisioningParameters(partialParams: ToOptional<{
      [K in keyof DescribeStackProvisioningParametersRequest]: (DescribeStackProvisioningParametersRequest)[K]
    ...
    invokeDescribeStackSummary(partialParams: ToOptional<{
      [K in keyof DescribeStackSummaryRequest]: (DescribeStackSummaryRequest)[K]
    ...
    invokeRegisterEcsCluster(partialParams: ToOptional<{
      [K in keyof RegisterEcsClusterRequest]: (RegisterEcsClusterRequest)[K]
    ...
    invokeRegisterElasticIp(partialParams: ToOptional<{
      [K in keyof RegisterElasticIpRequest]: (RegisterElasticIpRequest)[K]
    ...
    invokeRegisterVolume(partialParams: ToOptional<{
      [K in keyof RegisterVolumeRequest]: (RegisterVolumeRequest)[K]
