...
export default class extends aws.opsworks.Instance {
    ...
    invokeCreateApp(partialParams: ToOptional<{
      [K in keyof CreateAppRequest & keyof Omit<CreateAppRequest, "StackId">]: (CreateAppRequest)[K]
    ...
    invokeCreateInstance(partialParams: ToOptional<{
      [K in keyof CreateInstanceRequest & keyof Omit<CreateInstanceRequest, "StackId" | "InstanceType">]: (CreateInstanceRequest)[K]
    ...
    invokeCreateLayer(partialParams: ToOptional<{
      [K in keyof CreateLayerRequest & keyof Omit<CreateLayerRequest, "StackId">]: (CreateLayerRequest)[K]
    ...
    invokeRegisterEcsCluster(partialParams: ToOptional<{
      [K in keyof RegisterEcsClusterRequest & keyof Omit<RegisterEcsClusterRequest, "EcsClusterArn" | "StackId">]: (RegisterEcsClusterRequest)[K]
    ...
    invokeRegisterElasticIp(partialParams: ToOptional<{
      [K in keyof RegisterElasticIpRequest & keyof Omit<RegisterElasticIpRequest, "ElasticIp" | "StackId">]: (RegisterElasticIpRequest)[K]
