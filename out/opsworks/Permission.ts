...
export default class extends aws.opsworks.Permission {
    ...
    invokeUpdateStack(partialParams: ToOptional<{
      [K in keyof UpdateStackRequest & keyof Omit<UpdateStackRequest, "StackId"> & keyof UpdateStackRequest]: (UpdateStackRequest & Omit<UpdateStackRequest, "StackId"> & UpdateStackRequest)[K]
    }>): void {
