...
export default class extends aws.opsworks.JavaAppLayer {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.opsworks.JavaAppLayer>) {
        super(...args)
    ...
    invokeUpdateStack(partialParams: ToOptional<{
      [K in keyof UpdateStackRequest & keyof UpdateStackRequest & keyof UpdateStackRequest & keyof UpdateStackRequest & keyof UpdateStackRequest & keyof UpdateStackRequest & keyof UpdateStackRequest & keyof UpdateStackRequest & keyof UpdateStackRequest & keyof UpdateStackRequest & keyof Omit<UpdateStackRequest, "StackId">]: (UpdateStackRequest & UpdateStackRequest & UpdateStackRequest & UpdateStackRequest & UpdateStackRequest & UpdateStackRequest & UpdateStackRequest & UpdateStackRequest & UpdateStackRequest & UpdateStackRequest & Omit<UpdateStackRequest, "StackId">)[K]
    }>): void {
