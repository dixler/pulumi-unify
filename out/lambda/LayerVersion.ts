...
export default class extends aws.lambda.LayerVersion {
    ...
    invokeAddLayerVersionPermission(partialParams: ToOptional<{
      [K in keyof AddLayerVersionPermissionRequest & keyof Omit<AddLayerVersionPermissionRequest, "LayerName">]: (AddLayerVersionPermissionRequest)[K]
    ...
    invokeAddPermission(partialParams: ToOptional<{
      [K in keyof AddPermissionRequest]: (AddPermissionRequest)[K]
    ...
    invokeGetProvisionedConcurrencyConfig(partialParams: ToOptional<{
      [K in keyof GetProvisionedConcurrencyConfigRequest]: (GetProvisionedConcurrencyConfigRequest)[K]
    ...
    invokePutProvisionedConcurrencyConfig(partialParams: ToOptional<{
      [K in keyof PutProvisionedConcurrencyConfigRequest]: (PutProvisionedConcurrencyConfigRequest)[K]
