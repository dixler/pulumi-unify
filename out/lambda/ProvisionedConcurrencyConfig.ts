...
export default class extends aws.lambda.ProvisionedConcurrencyConfig {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.lambda.ProvisionedConcurrencyConfig>) {
        super(...args)
