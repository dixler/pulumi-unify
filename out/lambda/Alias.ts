...
export default class extends aws.lambda.Alias {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.lambda.Alias>) {
        super(...args)
    ...
    invokeAddLayerVersionPermission(partialParams: ToOptional<{
      [K in keyof AddLayerVersionPermissionRequest & keyof AddLayerVersionPermissionRequest & keyof AddLayerVersionPermissionRequest & keyof AddLayerVersionPermissionRequest & keyof AddLayerVersionPermissionRequest & keyof AddLayerVersionPermissionRequest]: (AddLayerVersionPermissionRequest & AddLayerVersionPermissionRequest & AddLayerVersionPermissionRequest & AddLayerVersionPermissionRequest & AddLayerVersionPermissionRequest & AddLayerVersionPermissionRequest)[K]
    ...
    invokeAddPermission(partialParams: ToOptional<{
      [K in keyof AddPermissionRequest & keyof AddPermissionRequest & keyof AddPermissionRequest & keyof AddPermissionRequest & keyof AddPermissionRequest & keyof AddPermissionRequest]: (AddPermissionRequest & AddPermissionRequest & AddPermissionRequest & AddPermissionRequest & AddPermissionRequest & AddPermissionRequest)[K]
    ...
    invokeCreateAlias(partialParams: ToOptional<{
      [K in keyof CreateAliasRequest & keyof CreateAliasRequest & keyof CreateAliasRequest & keyof CreateAliasRequest & keyof CreateAliasRequest & keyof Omit<CreateAliasRequest, "Name">]: (CreateAliasRequest & CreateAliasRequest & CreateAliasRequest & CreateAliasRequest & CreateAliasRequest & Omit<CreateAliasRequest, "Name">)[K]
    ...
    invokeCreateCodeSigningConfig(partialParams: ToOptional<{
      [K in keyof CreateCodeSigningConfigRequest & keyof CreateCodeSigningConfigRequest & keyof CreateCodeSigningConfigRequest & keyof CreateCodeSigningConfigRequest & keyof CreateCodeSigningConfigRequest & keyof CreateCodeSigningConfigRequest]: (CreateCodeSigningConfigRequest & CreateCodeSigningConfigRequest & CreateCodeSigningConfigRequest & CreateCodeSigningConfigRequest & CreateCodeSigningConfigRequest & CreateCodeSigningConfigRequest)[K]
    ...
    invokeCreateEventSourceMapping(partialParams: ToOptional<{
      [K in keyof CreateEventSourceMappingRequest & keyof CreateEventSourceMappingRequest & keyof CreateEventSourceMappingRequest & keyof CreateEventSourceMappingRequest & keyof CreateEventSourceMappingRequest & keyof CreateEventSourceMappingRequest]: (CreateEventSourceMappingRequest & CreateEventSourceMappingRequest & CreateEventSourceMappingRequest & CreateEventSourceMappingRequest & CreateEventSourceMappingRequest & CreateEventSourceMappingRequest)[K]
    ...
    invokeDeleteAlias(partialParams: ToOptional<{
      [K in keyof DeleteAliasRequest & keyof DeleteAliasRequest & keyof DeleteAliasRequest & keyof DeleteAliasRequest & keyof DeleteAliasRequest & keyof Omit<DeleteAliasRequest, "Name">]: (DeleteAliasRequest & DeleteAliasRequest & DeleteAliasRequest & DeleteAliasRequest & DeleteAliasRequest & Omit<DeleteAliasRequest, "Name">)[K]
    ...
    invokeDeleteCodeSigningConfig(partialParams: ToOptional<{
      [K in keyof DeleteCodeSigningConfigRequest & keyof DeleteCodeSigningConfigRequest & keyof DeleteCodeSigningConfigRequest & keyof DeleteCodeSigningConfigRequest & keyof DeleteCodeSigningConfigRequest & keyof DeleteCodeSigningConfigRequest]: (DeleteCodeSigningConfigRequest & DeleteCodeSigningConfigRequest & DeleteCodeSigningConfigRequest & DeleteCodeSigningConfigRequest & DeleteCodeSigningConfigRequest & DeleteCodeSigningConfigRequest)[K]
    ...
    invokeDeleteEventSourceMapping(partialParams: ToOptional<{
      [K in keyof DeleteEventSourceMappingRequest & keyof DeleteEventSourceMappingRequest & keyof DeleteEventSourceMappingRequest & keyof DeleteEventSourceMappingRequest & keyof DeleteEventSourceMappingRequest & keyof DeleteEventSourceMappingRequest]: (DeleteEventSourceMappingRequest & DeleteEventSourceMappingRequest & DeleteEventSourceMappingRequest & DeleteEventSourceMappingRequest & DeleteEventSourceMappingRequest & DeleteEventSourceMappingRequest)[K]
    }>): Request<EventSourceMappingConfiguration, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeDeleteFunctionCodeSigningConfig(partialParams: ToOptional<{
      [K in keyof DeleteFunctionCodeSigningConfigRequest & keyof DeleteFunctionCodeSigningConfigRequest & keyof DeleteFunctionCodeSigningConfigRequest & keyof DeleteFunctionCodeSigningConfigRequest & keyof DeleteFunctionCodeSigningConfigRequest & keyof DeleteFunctionCodeSigningConfigRequest]: (DeleteFunctionCodeSigningConfigRequest & DeleteFunctionCodeSigningConfigRequest & DeleteFunctionCodeSigningConfigRequest & DeleteFunctionCodeSigningConfigRequest & DeleteFunctionCodeSigningConfigRequest & DeleteFunctionCodeSigningConfigRequest)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeDeleteFunctionEventInvokeConfig(partialParams: ToOptional<{
      [K in keyof DeleteFunctionEventInvokeConfigRequest & keyof DeleteFunctionEventInvokeConfigRequest & keyof DeleteFunctionEventInvokeConfigRequest & keyof DeleteFunctionEventInvokeConfigRequest & keyof DeleteFunctionEventInvokeConfigRequest & keyof DeleteFunctionEventInvokeConfigRequest]: (DeleteFunctionEventInvokeConfigRequest & DeleteFunctionEventInvokeConfigRequest & DeleteFunctionEventInvokeConfigRequest & DeleteFunctionEventInvokeConfigRequest & DeleteFunctionEventInvokeConfigRequest & DeleteFunctionEventInvokeConfigRequest)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeDeleteLayerVersion(partialParams: ToOptional<{
      [K in keyof DeleteLayerVersionRequest & keyof DeleteLayerVersionRequest & keyof DeleteLayerVersionRequest & keyof DeleteLayerVersionRequest & keyof DeleteLayerVersionRequest & keyof DeleteLayerVersionRequest]: (DeleteLayerVersionRequest & DeleteLayerVersionRequest & DeleteLayerVersionRequest & DeleteLayerVersionRequest & DeleteLayerVersionRequest & DeleteLayerVersionRequest)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeDeleteProvisionedConcurrencyConfig(partialParams: ToOptional<{
      [K in keyof DeleteProvisionedConcurrencyConfigRequest & keyof DeleteProvisionedConcurrencyConfigRequest & keyof DeleteProvisionedConcurrencyConfigRequest & keyof DeleteProvisionedConcurrencyConfigRequest & keyof DeleteProvisionedConcurrencyConfigRequest & keyof DeleteProvisionedConcurrencyConfigRequest]: (DeleteProvisionedConcurrencyConfigRequest & DeleteProvisionedConcurrencyConfigRequest & DeleteProvisionedConcurrencyConfigRequest & DeleteProvisionedConcurrencyConfigRequest & DeleteProvisionedConcurrencyConfigRequest & DeleteProvisionedConcurrencyConfigRequest)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeGetAlias(partialParams: ToOptional<{
      [K in keyof GetAliasRequest & keyof GetAliasRequest & keyof Omit<GetAliasRequest, "FunctionName"> & keyof GetAliasRequest & keyof GetAliasRequest & keyof Omit<GetAliasRequest, "Name">]: (GetAliasRequest & GetAliasRequest & Omit<GetAliasRequest, "FunctionName"> & GetAliasRequest & GetAliasRequest & Omit<GetAliasRequest, "Name">)[K]
    }>): Request<AliasConfiguration, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeGetCodeSigningConfig(partialParams: ToOptional<{
      [K in keyof GetCodeSigningConfigRequest & keyof GetCodeSigningConfigRequest & keyof GetCodeSigningConfigRequest & keyof GetCodeSigningConfigRequest & keyof GetCodeSigningConfigRequest & keyof GetCodeSigningConfigRequest]: (GetCodeSigningConfigRequest & GetCodeSigningConfigRequest & GetCodeSigningConfigRequest & GetCodeSigningConfigRequest & GetCodeSigningConfigRequest & GetCodeSigningConfigRequest)[K]
    ...
    invokeGetEventSourceMapping(partialParams: ToOptional<{
      [K in keyof GetEventSourceMappingRequest & keyof GetEventSourceMappingRequest & keyof GetEventSourceMappingRequest & keyof GetEventSourceMappingRequest & keyof GetEventSourceMappingRequest & keyof GetEventSourceMappingRequest]: (GetEventSourceMappingRequest & GetEventSourceMappingRequest & GetEventSourceMappingRequest & GetEventSourceMappingRequest & GetEventSourceMappingRequest & GetEventSourceMappingRequest)[K]
    }>): Request<EventSourceMappingConfiguration, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeGetFunctionConcurrency(partialParams: ToOptional<{
      [K in keyof GetFunctionConcurrencyRequest & keyof GetFunctionConcurrencyRequest & keyof Omit<GetFunctionConcurrencyRequest, "FunctionName"> & keyof GetFunctionConcurrencyRequest & keyof GetFunctionConcurrencyRequest & keyof GetFunctionConcurrencyRequest]: (GetFunctionConcurrencyRequest & GetFunctionConcurrencyRequest & Omit<GetFunctionConcurrencyRequest, "FunctionName"> & GetFunctionConcurrencyRequest & GetFunctionConcurrencyRequest & GetFunctionConcurrencyRequest)[K]
    ...
    invokeGetFunctionEventInvokeConfig(partialParams: ToOptional<{
      [K in keyof GetFunctionEventInvokeConfigRequest & keyof GetFunctionEventInvokeConfigRequest & keyof Omit<GetFunctionEventInvokeConfigRequest, "FunctionName"> & keyof GetFunctionEventInvokeConfigRequest & keyof GetFunctionEventInvokeConfigRequest & keyof GetFunctionEventInvokeConfigRequest]: (GetFunctionEventInvokeConfigRequest & GetFunctionEventInvokeConfigRequest & Omit<GetFunctionEventInvokeConfigRequest, "FunctionName"> & GetFunctionEventInvokeConfigRequest & GetFunctionEventInvokeConfigRequest & GetFunctionEventInvokeConfigRequest)[K]
    ...
    invokeGetLayerVersion(partialParams: ToOptional<{
      [K in keyof GetLayerVersionRequest & keyof GetLayerVersionRequest & keyof GetLayerVersionRequest & keyof GetLayerVersionRequest & keyof GetLayerVersionRequest & keyof GetLayerVersionRequest]: (GetLayerVersionRequest & GetLayerVersionRequest & GetLayerVersionRequest & GetLayerVersionRequest & GetLayerVersionRequest & GetLayerVersionRequest)[K]
    ...
    invokeGetLayerVersionByArn(partialParams: ToOptional<{
      [K in keyof GetLayerVersionByArnRequest & keyof GetLayerVersionByArnRequest & keyof GetLayerVersionByArnRequest & keyof GetLayerVersionByArnRequest & keyof GetLayerVersionByArnRequest & keyof GetLayerVersionByArnRequest]: (GetLayerVersionByArnRequest & GetLayerVersionByArnRequest & GetLayerVersionByArnRequest & GetLayerVersionByArnRequest & GetLayerVersionByArnRequest & GetLayerVersionByArnRequest)[K]
    }>): Request<GetLayerVersionResponse, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeGetLayerVersionPolicy(partialParams: ToOptional<{
      [K in keyof GetLayerVersionPolicyRequest & keyof GetLayerVersionPolicyRequest & keyof GetLayerVersionPolicyRequest & keyof GetLayerVersionPolicyRequest & keyof GetLayerVersionPolicyRequest & keyof GetLayerVersionPolicyRequest]: (GetLayerVersionPolicyRequest & GetLayerVersionPolicyRequest & GetLayerVersionPolicyRequest & GetLayerVersionPolicyRequest & GetLayerVersionPolicyRequest & GetLayerVersionPolicyRequest)[K]
    ...
    invokeGetProvisionedConcurrencyConfig(partialParams: ToOptional<{
      [K in keyof GetProvisionedConcurrencyConfigRequest & keyof GetProvisionedConcurrencyConfigRequest & keyof Omit<GetProvisionedConcurrencyConfigRequest, "FunctionName"> & keyof GetProvisionedConcurrencyConfigRequest & keyof GetProvisionedConcurrencyConfigRequest & keyof GetProvisionedConcurrencyConfigRequest]: (GetProvisionedConcurrencyConfigRequest & GetProvisionedConcurrencyConfigRequest & Omit<GetProvisionedConcurrencyConfigRequest, "FunctionName"> & GetProvisionedConcurrencyConfigRequest & GetProvisionedConcurrencyConfigRequest & GetProvisionedConcurrencyConfigRequest)[K]
    ...
    invokeInvoke(partialParams: ToOptional<{
      [K in keyof InvocationRequest & keyof InvocationRequest & keyof InvocationRequest & keyof InvocationRequest & keyof InvocationRequest & keyof InvocationRequest]: (InvocationRequest & InvocationRequest & InvocationRequest & InvocationRequest & InvocationRequest & InvocationRequest)[K]
    ...
    invokeInvokeAsync(partialParams: ToOptional<{
      [K in keyof InvokeAsyncRequest & keyof InvokeAsyncRequest & keyof InvokeAsyncRequest & keyof InvokeAsyncRequest & keyof InvokeAsyncRequest & keyof InvokeAsyncRequest]: (InvokeAsyncRequest & InvokeAsyncRequest & InvokeAsyncRequest & InvokeAsyncRequest & InvokeAsyncRequest & InvokeAsyncRequest)[K]
    ...
    invokeListAliases(partialParams: ToOptional<{
      [K in keyof ListAliasesRequest & keyof ListAliasesRequest & keyof Omit<ListAliasesRequest, "FunctionName"> & keyof ListAliasesRequest & keyof ListAliasesRequest & keyof ListAliasesRequest]: (ListAliasesRequest & ListAliasesRequest & Omit<ListAliasesRequest, "FunctionName"> & ListAliasesRequest & ListAliasesRequest & ListAliasesRequest)[K]
    ...
    invokeListFunctionEventInvokeConfigs(partialParams: ToOptional<{
      [K in keyof ListFunctionEventInvokeConfigsRequest & keyof ListFunctionEventInvokeConfigsRequest & keyof Omit<ListFunctionEventInvokeConfigsRequest, "FunctionName"> & keyof ListFunctionEventInvokeConfigsRequest & keyof ListFunctionEventInvokeConfigsRequest & keyof ListFunctionEventInvokeConfigsRequest]: (ListFunctionEventInvokeConfigsRequest & ListFunctionEventInvokeConfigsRequest & Omit<ListFunctionEventInvokeConfigsRequest, "FunctionName"> & ListFunctionEventInvokeConfigsRequest & ListFunctionEventInvokeConfigsRequest & ListFunctionEventInvokeConfigsRequest)[K]
    ...
    invokeListFunctionsByCodeSigningConfig(partialParams: ToOptional<{
      [K in keyof ListFunctionsByCodeSigningConfigRequest & keyof ListFunctionsByCodeSigningConfigRequest & keyof ListFunctionsByCodeSigningConfigRequest & keyof ListFunctionsByCodeSigningConfigRequest & keyof ListFunctionsByCodeSigningConfigRequest & keyof ListFunctionsByCodeSigningConfigRequest]: (ListFunctionsByCodeSigningConfigRequest & ListFunctionsByCodeSigningConfigRequest & ListFunctionsByCodeSigningConfigRequest & ListFunctionsByCodeSigningConfigRequest & ListFunctionsByCodeSigningConfigRequest & ListFunctionsByCodeSigningConfigRequest)[K]
    ...
    invokeListLayerVersions(partialParams: ToOptional<{
      [K in keyof ListLayerVersionsRequest & keyof ListLayerVersionsRequest & keyof ListLayerVersionsRequest & keyof ListLayerVersionsRequest & keyof ListLayerVersionsRequest & keyof ListLayerVersionsRequest]: (ListLayerVersionsRequest & ListLayerVersionsRequest & ListLayerVersionsRequest & ListLayerVersionsRequest & ListLayerVersionsRequest & ListLayerVersionsRequest)[K]
    ...
    invokeListVersionsByFunction(partialParams: ToOptional<{
      [K in keyof ListVersionsByFunctionRequest & keyof ListVersionsByFunctionRequest & keyof ListVersionsByFunctionRequest & keyof ListVersionsByFunctionRequest & keyof ListVersionsByFunctionRequest & keyof ListVersionsByFunctionRequest]: (ListVersionsByFunctionRequest & ListVersionsByFunctionRequest & ListVersionsByFunctionRequest & ListVersionsByFunctionRequest & ListVersionsByFunctionRequest & ListVersionsByFunctionRequest)[K]
    ...
    invokePublishLayerVersion(partialParams: ToOptional<{
      [K in keyof PublishLayerVersionRequest & keyof PublishLayerVersionRequest & keyof PublishLayerVersionRequest & keyof PublishLayerVersionRequest & keyof PublishLayerVersionRequest & keyof PublishLayerVersionRequest]: (PublishLayerVersionRequest & PublishLayerVersionRequest & PublishLayerVersionRequest & PublishLayerVersionRequest & PublishLayerVersionRequest & PublishLayerVersionRequest)[K]
    ...
    invokePublishVersion(partialParams: ToOptional<{
      [K in keyof PublishVersionRequest & keyof PublishVersionRequest & keyof Omit<PublishVersionRequest, "FunctionName"> & keyof PublishVersionRequest & keyof PublishVersionRequest & keyof PublishVersionRequest]: (PublishVersionRequest & PublishVersionRequest & Omit<PublishVersionRequest, "FunctionName"> & PublishVersionRequest & PublishVersionRequest & PublishVersionRequest)[K]
    }>): Request<FunctionConfiguration, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokePutFunctionConcurrency(partialParams: ToOptional<{
      [K in keyof PutFunctionConcurrencyRequest & keyof PutFunctionConcurrencyRequest & keyof Omit<PutFunctionConcurrencyRequest, "FunctionName"> & keyof PutFunctionConcurrencyRequest & keyof PutFunctionConcurrencyRequest & keyof PutFunctionConcurrencyRequest]: (PutFunctionConcurrencyRequest & PutFunctionConcurrencyRequest & Omit<PutFunctionConcurrencyRequest, "FunctionName"> & PutFunctionConcurrencyRequest & PutFunctionConcurrencyRequest & PutFunctionConcurrencyRequest)[K]
    ...
    invokePutFunctionEventInvokeConfig(partialParams: ToOptional<{
      [K in keyof PutFunctionEventInvokeConfigRequest & keyof PutFunctionEventInvokeConfigRequest & keyof Omit<PutFunctionEventInvokeConfigRequest, "FunctionName"> & keyof PutFunctionEventInvokeConfigRequest & keyof PutFunctionEventInvokeConfigRequest & keyof PutFunctionEventInvokeConfigRequest]: (PutFunctionEventInvokeConfigRequest & PutFunctionEventInvokeConfigRequest & Omit<PutFunctionEventInvokeConfigRequest, "FunctionName"> & PutFunctionEventInvokeConfigRequest & PutFunctionEventInvokeConfigRequest & PutFunctionEventInvokeConfigRequest)[K]
    }>): Request<FunctionEventInvokeConfig, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeRemoveLayerVersionPermission(partialParams: ToOptional<{
      [K in keyof RemoveLayerVersionPermissionRequest & keyof RemoveLayerVersionPermissionRequest & keyof RemoveLayerVersionPermissionRequest & keyof RemoveLayerVersionPermissionRequest & keyof RemoveLayerVersionPermissionRequest & keyof RemoveLayerVersionPermissionRequest]: (RemoveLayerVersionPermissionRequest & RemoveLayerVersionPermissionRequest & RemoveLayerVersionPermissionRequest & RemoveLayerVersionPermissionRequest & RemoveLayerVersionPermissionRequest & RemoveLayerVersionPermissionRequest)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeRemovePermission(partialParams: ToOptional<{
      [K in keyof RemovePermissionRequest & keyof RemovePermissionRequest & keyof Omit<RemovePermissionRequest, "FunctionName"> & keyof RemovePermissionRequest & keyof RemovePermissionRequest & keyof RemovePermissionRequest]: (RemovePermissionRequest & RemovePermissionRequest & Omit<RemovePermissionRequest, "FunctionName"> & RemovePermissionRequest & RemovePermissionRequest & RemovePermissionRequest)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateAlias(partialParams: ToOptional<{
      [K in keyof UpdateAliasRequest & keyof UpdateAliasRequest & keyof Omit<UpdateAliasRequest, "FunctionName"> & keyof UpdateAliasRequest & keyof UpdateAliasRequest & keyof Omit<UpdateAliasRequest, "Name">]: (UpdateAliasRequest & UpdateAliasRequest & Omit<UpdateAliasRequest, "FunctionName"> & UpdateAliasRequest & UpdateAliasRequest & Omit<UpdateAliasRequest, "Name">)[K]
    }>): Request<AliasConfiguration, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateCodeSigningConfig(partialParams: ToOptional<{
      [K in keyof UpdateCodeSigningConfigRequest & keyof UpdateCodeSigningConfigRequest & keyof UpdateCodeSigningConfigRequest & keyof UpdateCodeSigningConfigRequest & keyof UpdateCodeSigningConfigRequest & keyof UpdateCodeSigningConfigRequest]: (UpdateCodeSigningConfigRequest & UpdateCodeSigningConfigRequest & UpdateCodeSigningConfigRequest & UpdateCodeSigningConfigRequest & UpdateCodeSigningConfigRequest & UpdateCodeSigningConfigRequest)[K]
    ...
    invokeUpdateEventSourceMapping(partialParams: ToOptional<{
      [K in keyof UpdateEventSourceMappingRequest & keyof UpdateEventSourceMappingRequest & keyof UpdateEventSourceMappingRequest & keyof UpdateEventSourceMappingRequest & keyof UpdateEventSourceMappingRequest & keyof UpdateEventSourceMappingRequest]: (UpdateEventSourceMappingRequest & UpdateEventSourceMappingRequest & UpdateEventSourceMappingRequest & UpdateEventSourceMappingRequest & UpdateEventSourceMappingRequest & UpdateEventSourceMappingRequest)[K]
    }>): Request<EventSourceMappingConfiguration, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateFunctionCode(partialParams: ToOptional<{
      [K in keyof UpdateFunctionCodeRequest & keyof UpdateFunctionCodeRequest & keyof Omit<UpdateFunctionCodeRequest, "FunctionName"> & keyof UpdateFunctionCodeRequest & keyof UpdateFunctionCodeRequest & keyof UpdateFunctionCodeRequest]: (UpdateFunctionCodeRequest & UpdateFunctionCodeRequest & Omit<UpdateFunctionCodeRequest, "FunctionName"> & UpdateFunctionCodeRequest & UpdateFunctionCodeRequest & UpdateFunctionCodeRequest)[K]
    }>): Request<FunctionConfiguration, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateFunctionConfiguration(partialParams: ToOptional<{
      [K in keyof UpdateFunctionConfigurationRequest & keyof UpdateFunctionConfigurationRequest & keyof Omit<UpdateFunctionConfigurationRequest, "FunctionName"> & keyof UpdateFunctionConfigurationRequest & keyof UpdateFunctionConfigurationRequest & keyof UpdateFunctionConfigurationRequest]: (UpdateFunctionConfigurationRequest & UpdateFunctionConfigurationRequest & Omit<UpdateFunctionConfigurationRequest, "FunctionName"> & UpdateFunctionConfigurationRequest & UpdateFunctionConfigurationRequest & UpdateFunctionConfigurationRequest)[K]
    }>): Request<FunctionConfiguration, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
