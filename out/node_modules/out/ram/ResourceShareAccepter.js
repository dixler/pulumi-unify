...
class Resource extends aws.ram.ResourceShareAccepter {
    constructor(...args) {
        super(...args);
    ...
    rejectResourceShareInvitation(partialParams) {
    ...
    updateResourceShare(partialParams) {
