...
class Resource extends aws.memorydb.ParameterGroup {
    constructor(...args) {
        super(...args);
    ...
    batchUpdateCluster(partialParams) {
    ...
    createParameterGroup(partialParams) {
    ...
    createSubnetGroup(partialParams) {
    ...
    deleteParameterGroup(partialParams) {
    ...
    deleteSubnetGroup(partialParams) {
    ...
    resetParameterGroup(partialParams) {
