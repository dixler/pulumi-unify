...
class Resource extends aws.quicksight.DataSource {
    constructor(...args) {
        super(...args);
    ...
    updateAccountCustomization(partialParams) {
