...
class Resource extends aws.codepipeline.Pipeline {
    constructor(...args) {
        super(...args);
    ...
    deleteCustomActionType(partialParams) {
    ...
    updateActionType(partialParams) {
