...
export default class Resource extends aws.mediaconvert.Queue {
    private ops: any
    private client: any
    ...
    associateCertificate(partialParams: ToOptional<{
    ...
    disassociateCertificate(partialParams: ToOptional<{
    ...
    getJobTemplate(partialParams: ToOptional<{
    ...
    getPreset(partialParams: ToOptional<{
    ...
    getQueue(partialParams: ToOptional<{
    ...
    putPolicy(partialParams: ToOptional<{
    ...
    updateJobTemplate(partialParams: ToOptional<{
    ...
    updatePreset(partialParams: ToOptional<{
    ...
    updateQueue(partialParams: ToOptional<{
