...
export default class Resource extends aws.dlm.LifecyclePolicy {
    private ops: any
    private client: any
    ...
    createLifecyclePolicy(partialParams: ToOptional<{
    ...
    updateLifecyclePolicy(partialParams: ToOptional<{
