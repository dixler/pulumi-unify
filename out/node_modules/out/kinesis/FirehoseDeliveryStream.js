...
class Resource extends aws.kinesis.FirehoseDeliveryStream {
    constructor(...args) {
        super(...args);
    ...
    decreaseStreamRetentionPeriod(partialParams) {
