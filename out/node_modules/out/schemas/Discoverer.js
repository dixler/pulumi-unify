...
class Resource extends aws.schemas.Discoverer {
    constructor(...args) {
        super(...args);
    ...
    createDiscoverer(partialParams) {
    ...
    deleteDiscoverer(partialParams) {
    ...
    updateDiscoverer(partialParams) {
