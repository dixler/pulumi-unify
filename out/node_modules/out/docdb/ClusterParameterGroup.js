...
class Resource extends aws.docdb.ClusterParameterGroup {
    constructor(...args) {
        super(...args);
    ...
    createGlobalCluster(partialParams) {
    ...
    modifyGlobalCluster(partialParams) {
    ...
    removeFromGlobalCluster(partialParams) {
