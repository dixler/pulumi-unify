...
class Resource extends aws.shield.ProtectionGroup {
    constructor(...args) {
        super(...args);
    ...
    listResourcesInProtectionGroup(partialParams) {
    ...
    updateApplicationLayerAutomaticResponse(partialParams) {
    ...
    updateProtectionGroup(partialParams) {
