...
export default class Resource extends aws.mq.Broker {
    private ops: any
    private client: any
    ...
    createBroker(partialParams: ToOptional<{
    ...
    createConfiguration(partialParams: ToOptional<{
    ...
    deleteBroker(partialParams: ToOptional<{
    ...
    describeBroker(partialParams: ToOptional<{
    ...
    describeConfiguration(partialParams: ToOptional<{
    ...
    describeConfigurationRevision(partialParams: ToOptional<{
    ...
    listConfigurationRevisions(partialParams: ToOptional<{
    ...
    rebootBroker(partialParams: ToOptional<{
    ...
    updateBroker(partialParams: ToOptional<{
    ...
    updateConfiguration(partialParams: ToOptional<{
