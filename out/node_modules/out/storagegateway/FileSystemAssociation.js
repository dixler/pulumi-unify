...
class Resource extends aws.storagegateway.FileSystemAssociation {
    constructor(...args) {
        super(...args);
    ...
    createSnapshotFromVolumeRecoveryPoint(partialParams) {
