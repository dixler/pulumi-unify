...
class Resource extends aws.securityhub.OrganizationAdminAccount {
    constructor(...args) {
        super(...args);
    ...
    acceptAdministratorInvitation(partialParams) {
    ...
    enableImportFindingsForProduct(partialParams) {
    ...
    updateStandardsControl(partialParams) {
