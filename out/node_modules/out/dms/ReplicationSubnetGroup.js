...
class Resource extends aws.dms.ReplicationSubnetGroup {
    constructor(...args) {
        super(...args);
    ...
    cancelReplicationTaskAssessmentRun(partialParams) {
