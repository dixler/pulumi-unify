...
class Resource extends aws.guardduty.OrganizationConfiguration {
    constructor(...args) {
        super(...args);
    ...
    unarchiveFindings(partialParams) {
