...
class Resource extends aws.elasticbeanstalk.ConfigurationTemplate {
    constructor(...args) {
        super(...args);
    ...
    createPlatformVersion(partialParams) {
