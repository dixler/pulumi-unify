...
} from "aws-sdk/clients/data pipeline";
...
export default class Resource extends aws.datapipeline.Pipeline {
    private ops: any
    private client: any
    ...
    activatePipeline(partialParams: ToOptional<{
    ...
    deactivatePipeline(partialParams: ToOptional<{
    ...
    describeObjects(partialParams: ToOptional<{
    ...
    describePipelines(partialParams: ToOptional<{
    ...
    evaluateExpression(partialParams: ToOptional<{
    ...
    getPipelineDefinition(partialParams: ToOptional<{
    ...
    pollForTask(partialParams: ToOptional<{
    ...
    putPipelineDefinition(partialParams: ToOptional<{
    ...
    queryObjects(partialParams: ToOptional<{
    ...
    reportTaskProgress(partialParams: ToOptional<{
    ...
    reportTaskRunnerHeartbeat(partialParams: ToOptional<{
    ...
    setStatus(partialParams: ToOptional<{
    ...
    setTaskStatus(partialParams: ToOptional<{
    ...
    validatePipelineDefinition(partialParams: ToOptional<{
