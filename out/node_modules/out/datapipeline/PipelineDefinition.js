...
class Resource extends aws.datapipeline.PipelineDefinition {
    constructor(...args) {
        super(...args);
    ...
    activatePipeline(partialParams) {
    ...
    deactivatePipeline(partialParams) {
