...
class Resource extends aws.sagemaker.NotebookInstanceLifecycleConfiguration {
    constructor(...args) {
        super(...args);
    ...
    deleteStudioLifecycleConfig(partialParams) {
    ...
    describePipeline(partialParams) {
        return this.client.describePipeline(this.ops["DescribePipeline"].apply(partialParams));
    }
    describePipelineDefinitionForExecution(partialParams) {
