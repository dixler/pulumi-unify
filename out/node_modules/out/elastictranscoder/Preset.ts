...
} from "aws-sdk/clients/elastic transcoder";
...
export default class Resource extends aws.elastictranscoder.Preset {
    private ops: any
    private client: any
    ...
    createPreset(partialParams: ToOptional<{
    ...
    deletePreset(partialParams: ToOptional<{
    ...
    listJobsByPipeline(partialParams: ToOptional<{
    ...
    listJobsByStatus(partialParams: ToOptional<{
    ...
    readJob(partialParams: ToOptional<{
    ...
    readPipeline(partialParams: ToOptional<{
    ...
    readPreset(partialParams: ToOptional<{
    ...
    testRole(partialParams: ToOptional<{
    ...
    updatePipelineNotifications(partialParams: ToOptional<{
    ...
    updatePipelineStatus(partialParams: ToOptional<{
