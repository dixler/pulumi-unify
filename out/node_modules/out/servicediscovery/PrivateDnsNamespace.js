...
class Resource extends aws.servicediscovery.PrivateDnsNamespace {
    constructor(...args) {
        super(...args);
    ...
    discoverInstances(partialParams) {
