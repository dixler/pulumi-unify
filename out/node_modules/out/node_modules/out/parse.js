...
class ClassFactory {
    ...
    render() {
        ...
        const serviceId = client.api.serviceId;
...
export default class Resource extends ${classRef} {
    private ops: any
    private client: any
...
function main() {
    ...
    for (const key of Object.keys(pulumiSchema['resources'])) {
        ...
        try {
            ...
            fs.writeFileSync(`out/${service}/${resource}.ts`, (new ClassFactory([`${cloud}.${service}.${resource}`, schemaToResourceKeys(key)], [`awssdk.${awsServiceName}`, new awsSDK[awsServiceName]()], schema).render()));
        }
        catch (e) {
