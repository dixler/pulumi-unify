...
export default class Resource extends aws.detective.InvitationAccepter {
    private ops: any
    private client: any
    ...
    deleteGraph(partialParams: ToOptional<{
    ...
    disassociateMembership(partialParams: ToOptional<{
    ...
    rejectInvitation(partialParams: ToOptional<{
    ...
    startMonitoringMember(partialParams: ToOptional<{
