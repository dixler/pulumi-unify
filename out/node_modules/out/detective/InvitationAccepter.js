...
class Resource extends aws.detective.InvitationAccepter {
    constructor(...args) {
        super(...args);
    ...
    disassociateMembership(partialParams) {
