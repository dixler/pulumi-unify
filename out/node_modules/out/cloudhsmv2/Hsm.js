...
class Resource extends aws.cloudhsmv2.Hsm {
    constructor(...args) {
        super(...args);
    ...
    copyBackupToRegion(partialParams) {
    ...
    modifyBackupAttributes(partialParams) {
