...
} from "aws-sdk/clients/cloudhsm v2";
...
export default class Resource extends aws.cloudhsmv2.Cluster {
    private ops: any
    private client: any
    ...
    copyBackupToRegion(partialParams: ToOptional<{
    ...
    createHsm(partialParams: ToOptional<{
    ...
    deleteHsm(partialParams: ToOptional<{
    ...
    initializeCluster(partialParams: ToOptional<{
    ...
    modifyBackupAttributes(partialParams: ToOptional<{
    ...
    restoreBackup(partialParams: ToOptional<{
