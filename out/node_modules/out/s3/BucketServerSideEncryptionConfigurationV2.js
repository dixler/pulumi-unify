...
class Resource extends aws.s3.BucketServerSideEncryptionConfigurationV2 {
    constructor(...args) {
        super(...args);
    ...
    createMultipartUpload(partialParams) {
