...
export default class Resource extends aws.s3.BucketAccelerateConfigurationV2 {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.s3.BucketAccelerateConfigurationV2>) {
        super(...args)
