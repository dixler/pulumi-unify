...
export default class Resource extends aws.s3.BucketLifecycleConfigurationV2 {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.s3.BucketLifecycleConfigurationV2>) {
        super(...args)
