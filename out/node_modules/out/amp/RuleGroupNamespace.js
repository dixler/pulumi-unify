...
class Resource extends aws.amp.RuleGroupNamespace {
    constructor(...args) {
        super(...args);
    ...
    listRuleGroupsNamespaces(partialParams) {
    ...
    updateWorkspaceAlias(partialParams) {
