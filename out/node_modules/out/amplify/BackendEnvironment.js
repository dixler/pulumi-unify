...
class Resource extends aws.amplify.BackendEnvironment {
    constructor(...args) {
        super(...args);
    ...
    createBackendEnvironment(partialParams) {
    ...
    createDomainAssociation(partialParams) {
    ...
    deleteBackendEnvironment(partialParams) {
    ...
    deleteDomainAssociation(partialParams) {
    ...
    generateAccessLogs(partialParams) {
    ...
    listBackendEnvironments(partialParams) {
    ...
    listDomainAssociations(partialParams) {
