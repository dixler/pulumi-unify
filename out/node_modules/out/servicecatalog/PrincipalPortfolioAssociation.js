...
class Resource extends aws.servicecatalog.PrincipalPortfolioAssociation {
    constructor(...args) {
        super(...args);
    ...
    associateTagOptionWithResource(partialParams) {
        return this.client.associateTagOptionWithResource(this.ops["AssociateTagOptionWithResource"].apply(partialParams));
    }
    batchAssociateServiceActionWithProvisioningArtifact(partialParams) {
    ...
    batchDisassociateServiceActionFromProvisioningArtifact(partialParams) {
    ...
    listStackInstancesForProvisionedProduct(partialParams) {
