...
export default class Resource extends aws.apprunner.VpcConnector {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.apprunner.VpcConnector>) {
        super(...args)
    ...
    associateCustomDomain(partialParams: ToOptional<{
    ...
    createAutoScalingConfiguration(partialParams: ToOptional<{
      [K in keyof CreateAutoScalingConfigurationRequest & keyof CreateAutoScalingConfigurationRequest & keyof CreateAutoScalingConfigurationRequest]: (CreateAutoScalingConfigurationRequest & CreateAutoScalingConfigurationRequest & CreateAutoScalingConfigurationRequest)[K]
    }>): CreateAutoScalingConfigurationResponse {
    ...
    createVpcConnector(partialParams: ToOptional<{
    ...
    deleteAutoScalingConfiguration(partialParams: ToOptional<{
    ...
    deleteVpcConnector(partialParams: ToOptional<{
    ...
    describeAutoScalingConfiguration(partialParams: ToOptional<{
    ...
    describeCustomDomains(partialParams: ToOptional<{
    ...
    describeService(partialParams: ToOptional<{
    ...
    describeVpcConnector(partialParams: ToOptional<{
    ...
    disassociateCustomDomain(partialParams: ToOptional<{
    ...
    listOperations(partialParams: ToOptional<{
    ...
    pauseService(partialParams: ToOptional<{
    ...
    resumeService(partialParams: ToOptional<{
