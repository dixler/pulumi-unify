...
class Resource extends aws.globalaccelerator.EndpointGroup {
    constructor(...args) {
        super(...args);
    ...
    addCustomRoutingEndpoints(partialParams) {
    ...
    removeCustomRoutingEndpoints(partialParams) {
