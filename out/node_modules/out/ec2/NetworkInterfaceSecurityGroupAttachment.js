...
class Resource extends aws.ec2.NetworkInterfaceSecurityGroupAttachment {
    constructor(...args) {
        super(...args);
    ...
    acceptReservedInstancesExchangeQuote(partialParams) {
    ...
    acceptTransitGatewayPeeringAttachment(partialParams) {
    ...
    createTransitGatewayPrefixListReference(partialParams) {
    ...
    deleteTransitGatewayPrefixListReference(partialParams) {
    ...
    deleteVpcEndpointServiceConfigurations(partialParams) {
    ...
    getNetworkInsightsAccessScopeContent(partialParams) {
    ...
    getTransitGatewayPrefixListReferences(partialParams) {
    ...
    getTransitGatewayRouteTableAssociations(partialParams) {
    ...
    getTransitGatewayRouteTablePropagations(partialParams) {
    ...
    getVpnConnectionDeviceSampleConfiguration(partialParams) {
    ...
    importClientVpnClientCertificateRevocationList(partialParams) {
    ...
    modifyVpcEndpointServiceConfiguration(partialParams) {
    ...
    modifyVpcEndpointServicePayerResponsibility(partialParams) {
