...
class Resource extends aws.cloudfront.FieldLevelEncryptionProfile {
    constructor(...args) {
        super(...args);
    ...
    listDistributionsByResponseHeadersPolicyId(partialParams) {
