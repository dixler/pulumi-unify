...
export default class Resource extends aws.cloudcontrol.Resource {
    private ops: any
    private client: any
    ...
    cancelResourceRequest(partialParams: ToOptional<{
    ...
    getResourceRequestStatus(partialParams: ToOptional<{
