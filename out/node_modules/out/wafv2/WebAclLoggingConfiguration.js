...
class Resource extends aws.wafv2.WebAclLoggingConfiguration {
    constructor(...args) {
        super(...args);
    ...
    deleteFirewallManagerRuleGroups(partialParams) {
    ...
    getRateBasedStatementManagedKeys(partialParams) {
    ...
    listAvailableManagedRuleGroups(partialParams) {
    ...
    putManagedRuleSetVersions(partialParams) {
    ...
    updateManagedRuleSetVersionExpiryDate(partialParams) {
