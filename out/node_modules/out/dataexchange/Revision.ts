...
export default class Resource extends aws.dataexchange.Revision {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.dataexchange.Revision>) {
        super(...args)
    ...
    createDataSet(partialParams: ToOptional<{
      [K in keyof CreateDataSetRequest & keyof CreateDataSetRequest & keyof CreateDataSetRequest & keyof CreateDataSetRequest]: (CreateDataSetRequest & CreateDataSetRequest & CreateDataSetRequest & CreateDataSetRequest)[K]
    }>): CreateDataSetResponse {
    ...
    createEventAction(partialParams: ToOptional<{
    ...
    createRevision(partialParams: ToOptional<{
    ...
    deleteAsset(partialParams: ToOptional<{
    ...
    deleteEventAction(partialParams: ToOptional<{
    ...
    deleteRevision(partialParams: ToOptional<{
    ...
    getAsset(partialParams: ToOptional<{
    ...
    getDataSet(partialParams: ToOptional<{
    ...
    getEventAction(partialParams: ToOptional<{
    ...
    getRevision(partialParams: ToOptional<{
    ...
    listDataSetRevisions(partialParams: ToOptional<{
    ...
    listRevisionAssets(partialParams: ToOptional<{
    ...
    sendApiAsset(partialParams: ToOptional<{
    ...
    updateAsset(partialParams: ToOptional<{
      [K in keyof UpdateAssetRequest & keyof UpdateAssetRequest & keyof UpdateAssetRequest & keyof UpdateAssetRequest]: (UpdateAssetRequest & UpdateAssetRequest & UpdateAssetRequest & UpdateAssetRequest)[K]
    }>): UpdateAssetResponse {
    ...
    updateEventAction(partialParams: ToOptional<{
    ...
    updateRevision(partialParams: ToOptional<{
