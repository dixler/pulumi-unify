...
class Resource extends aws.codeartifact.RepositoryPermissionsPolicy {
    constructor(...args) {
        super(...args);
    ...
    deleteRepositoryPermissionsPolicy(partialParams) {
