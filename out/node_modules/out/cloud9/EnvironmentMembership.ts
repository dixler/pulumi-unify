...
export default class Resource extends aws.cloud9.EnvironmentMembership {
    private ops: any
    private client: any
    ...
    createEnvironmentEC2(partialParams: ToOptional<{
    ...
    createEnvironmentMembership(partialParams: ToOptional<{
    ...
    deleteEnvironmentMembership(partialParams: ToOptional<{
    ...
    describeEnvironmentStatus(partialParams: ToOptional<{
    ...
    describeEnvironments(partialParams: ToOptional<{
    ...
    updateEnvironmentMembership(partialParams: ToOptional<{
