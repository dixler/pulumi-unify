...
class Resource extends aws.cloud9.EnvironmentMembership {
    constructor(...args) {
        super(...args);
    ...
    updateEnvironmentMembership(partialParams) {
