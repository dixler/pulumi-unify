...
class Resource extends aws.kinesisanalyticsv2.ApplicationSnapshot {
    constructor(...args) {
        super(...args);
    ...
    addApplicationCloudWatchLoggingOption(partialParams) {
    ...
    addApplicationInput(partialParams) {
        return this.client.addApplicationInput(this.ops["AddApplicationInput"].apply(partialParams));
    }
    addApplicationInputProcessingConfiguration(partialParams) {
    ...
    deleteApplicationCloudWatchLoggingOption(partialParams) {
    ...
    deleteApplicationInputProcessingConfiguration(partialParams) {
    ...
    updateApplicationMaintenanceConfiguration(partialParams) {
