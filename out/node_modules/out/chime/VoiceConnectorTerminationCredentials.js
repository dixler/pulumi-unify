...
class Resource extends aws.chime.VoiceConnectorTerminationCredentials {
    constructor(...args) {
        super(...args);
    ...
    associatePhoneNumbersWithVoiceConnectorGroup(partialParams) {
    ...
    associateSigninDelegateGroupsWithAccount(partialParams) {
    ...
    describeChannelModeratedByAppInstanceUser(partialParams) {
    ...
    disassociatePhoneNumbersFromVoiceConnectorGroup(partialParams) {
    ...
    disassociateSigninDelegateGroupsFromAccount(partialParams) {
    ...
    listUsers(partialParams) {
        return this.client.listUsers(this.ops["ListUsers"].apply(partialParams));
    }
    listVoiceConnectorTerminationCredentials(partialParams) {
    ...
    putVoiceConnectorEmergencyCallingConfiguration(partialParams) {
    ...
    putVoiceConnectorLoggingConfiguration(partialParams) {
