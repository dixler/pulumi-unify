...
class Resource extends aws.apigateway.DocumentationVersion {
    constructor(...args) {
        super(...args);
    ...
    testInvokeMethod(partialParams) {
