...
class Resource extends aws.macie2.OrganizationAdminAccount {
    constructor(...args) {
        super(...args);
    ...
    disassociateMember(partialParams) {
    ...
    testCustomDataIdentifier(partialParams) {
