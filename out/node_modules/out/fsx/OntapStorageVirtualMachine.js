...
class Resource extends aws.fsx.OntapStorageVirtualMachine {
    constructor(...args) {
        super(...args);
    ...
    createStorageVirtualMachine(partialParams) {
    ...
    createVolumeFromBackup(partialParams) {
    ...
    deleteStorageVirtualMachine(partialParams) {
