...
} from "aws-sdk/clients/cost and usage report service";
...
export default class Resource extends aws.cur.ReportDefinition {
    private ops: any
    private client: any
    ...
    modifyReportDefinition(partialParams: ToOptional<{
    ...
    putReportDefinition(partialParams: ToOptional<{
