...
export default class Resource extends aws.connect.UserHierarchyStructure {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.connect.UserHierarchyStructure>) {
        super(...args)
