...
class Resource extends aws.directconnect.HostedPrivateVirtualInterfaceAccepter {
    constructor(...args) {
        super(...args);
    ...
    acceptDirectConnectGatewayAssociationProposal(partialParams) {
    ...
    createDirectConnectGatewayAssociationProposal(partialParams) {
