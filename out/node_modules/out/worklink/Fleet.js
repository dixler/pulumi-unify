...
class Resource extends aws.worklink.Fleet {
    constructor(...args) {
        super(...args);
    ...
    associateDomain(partialParams) {
        return this.client.associateDomain(this.ops["AssociateDomain"].apply(partialParams));
    }
    associateWebsiteAuthorizationProvider(partialParams) {
    ...
    associateWebsiteCertificateAuthority(partialParams) {
    ...
    describeDevicePolicyConfiguration(partialParams) {
    ...
    disassociateWebsiteCertificateAuthority(partialParams) {
