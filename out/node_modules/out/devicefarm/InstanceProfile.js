...
class Resource extends aws.devicefarm.InstanceProfile {
    constructor(...args) {
        super(...args);
    ...
    createDevicePool(partialParams) {
    ...
    createNetworkProfile(partialParams) {
    ...
    deleteNetworkProfile(partialParams) {
