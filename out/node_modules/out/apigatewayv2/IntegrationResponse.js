...
class Resource extends aws.apigatewayv2.IntegrationResponse {
    constructor(...args) {
        super(...args);
    ...
    createRouteResponse(partialParams) {
    ...
    deleteCorsConfiguration(partialParams) {
