...
class Resource extends aws.ssm.MaintenanceWindowTask {
    constructor(...args) {
        super(...args);
    ...
    deregisterTargetFromMaintenanceWindow(partialParams) {
    ...
    describeEffectivePatchesForPatchBaseline(partialParams) {
    ...
    describeInstancePatches(partialParams) {
        return this.client.describeInstancePatches(this.ops["DescribeInstancePatches"].apply(partialParams));
    }
    describeMaintenanceWindowExecutionTaskInvocations(partialParams) {
    ...
    describeMaintenanceWindowExecutionTasks(partialParams) {
