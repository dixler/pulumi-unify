...
} from "aws-sdk/clients/secrets manager";
...
export default class Resource extends aws.secretsmanager.SecretRotation {
    private ops: any
    private client: any
    ...
    cancelRotateSecret(partialParams: ToOptional<{
    ...
    createSecret(partialParams: ToOptional<{
    ...
    deleteSecret(partialParams: ToOptional<{
    ...
    describeSecret(partialParams: ToOptional<{
    ...
    getSecretValue(partialParams: ToOptional<{
    ...
    listSecretVersionIds(partialParams: ToOptional<{
    ...
    putSecretValue(partialParams: ToOptional<{
    ...
    removeRegionsFromReplication(partialParams: ToOptional<{
    ...
    replicateSecretToRegions(partialParams: ToOptional<{
    ...
    restoreSecret(partialParams: ToOptional<{
    ...
    rotateSecret(partialParams: ToOptional<{
    ...
    stopReplicationToReplica(partialParams: ToOptional<{
    ...
    updateSecret(partialParams: ToOptional<{
    ...
    updateSecretVersionStage(partialParams: ToOptional<{
    ...
    validateResourcePolicy(partialParams: ToOptional<{
