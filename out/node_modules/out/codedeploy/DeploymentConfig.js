...
class Resource extends aws.codedeploy.DeploymentConfig {
    constructor(...args) {
        super(...args);
    ...
    updateDeploymentGroup(partialParams) {
