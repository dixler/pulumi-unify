...
export default class Resource extends aws.networkmanager.TransitGatewayRegistration {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.networkmanager.TransitGatewayRegistration>) {
        super(...args)
    ...
    registerTransitGateway(partialParams: ToOptional<{
      [K in keyof Omit<RegisterTransitGatewayRequest, "GlobalNetworkId"> & keyof RegisterTransitGatewayRequest]: (Omit<RegisterTransitGatewayRequest, "GlobalNetworkId"> & RegisterTransitGatewayRequest)[K]
    }>): RegisterTransitGatewayResponse {
    ...
    startRouteAnalysis(partialParams: ToOptional<{
      [K in keyof Omit<StartRouteAnalysisRequest, "GlobalNetworkId"> & keyof StartRouteAnalysisRequest]: (Omit<StartRouteAnalysisRequest, "GlobalNetworkId"> & StartRouteAnalysisRequest)[K]
    }>): StartRouteAnalysisResponse {
    ...
    updateConnection(partialParams: ToOptional<{
      [K in keyof Omit<UpdateConnectionRequest, "GlobalNetworkId"> & keyof UpdateConnectionRequest]: (Omit<UpdateConnectionRequest, "GlobalNetworkId"> & UpdateConnectionRequest)[K]
    }>): UpdateConnectionResponse {
    ...
    updateDevice(partialParams: ToOptional<{
      [K in keyof Omit<UpdateDeviceRequest, "GlobalNetworkId"> & keyof UpdateDeviceRequest]: (Omit<UpdateDeviceRequest, "GlobalNetworkId"> & UpdateDeviceRequest)[K]
    }>): UpdateDeviceResponse {
    ...
    updateGlobalNetwork(partialParams: ToOptional<{
      [K in keyof Omit<UpdateGlobalNetworkRequest, "GlobalNetworkId"> & keyof UpdateGlobalNetworkRequest]: (Omit<UpdateGlobalNetworkRequest, "GlobalNetworkId"> & UpdateGlobalNetworkRequest)[K]
    }>): UpdateGlobalNetworkResponse {
    ...
    updateLink(partialParams: ToOptional<{
      [K in keyof Omit<UpdateLinkRequest, "GlobalNetworkId"> & keyof UpdateLinkRequest]: (Omit<UpdateLinkRequest, "GlobalNetworkId"> & UpdateLinkRequest)[K]
    }>): UpdateLinkResponse {
    ...
    updateNetworkResourceMetadata(partialParams: ToOptional<{
      [K in keyof Omit<UpdateNetworkResourceMetadataRequest, "GlobalNetworkId"> & keyof UpdateNetworkResourceMetadataRequest]: (Omit<UpdateNetworkResourceMetadataRequest, "GlobalNetworkId"> & UpdateNetworkResourceMetadataRequest)[K]
    }>): UpdateNetworkResourceMetadataResponse {
    ...
    updateSite(partialParams: ToOptional<{
      [K in keyof Omit<UpdateSiteRequest, "GlobalNetworkId"> & keyof UpdateSiteRequest]: (Omit<UpdateSiteRequest, "GlobalNetworkId"> & UpdateSiteRequest)[K]
    }>): UpdateSiteResponse {
