...
class Resource extends aws.elasticache.ReplicationGroup {
    constructor(...args) {
        super(...args);
    ...
    createUserGroup(partialParams) {
        return this.client.createUserGroup(this.ops["CreateUserGroup"].apply(partialParams));
    }
    decreaseNodeGroupsInGlobalReplicationGroup(partialParams) {
    ...
    increaseReplicaCount(partialParams) {
    ...
    rebootCacheCluster(partialParams) {
