...
export default class extends aws.codeartifact.Repository {
    ...
    invokeGetAuthorizationToken(partialParams: ToOptional<{
      [K in keyof GetAuthorizationTokenRequest & keyof GetAuthorizationTokenRequest & keyof GetAuthorizationTokenRequest & keyof Omit<GetAuthorizationTokenRequest, "domain"> & keyof GetAuthorizationTokenRequest & keyof GetAuthorizationTokenRequest]: (GetAuthorizationTokenRequest & GetAuthorizationTokenRequest & GetAuthorizationTokenRequest & Omit<GetAuthorizationTokenRequest, "domain"> & GetAuthorizationTokenRequest & GetAuthorizationTokenRequest)[K]
    ...
    invokeGetDomainPermissionsPolicy(partialParams: ToOptional<{
      [K in keyof GetDomainPermissionsPolicyRequest & keyof GetDomainPermissionsPolicyRequest & keyof GetDomainPermissionsPolicyRequest & keyof Omit<GetDomainPermissionsPolicyRequest, "domain"> & keyof GetDomainPermissionsPolicyRequest & keyof GetDomainPermissionsPolicyRequest]: (GetDomainPermissionsPolicyRequest & GetDomainPermissionsPolicyRequest & GetDomainPermissionsPolicyRequest & Omit<GetDomainPermissionsPolicyRequest, "domain"> & GetDomainPermissionsPolicyRequest & GetDomainPermissionsPolicyRequest)[K]
    ...
    invokeGetPackageVersionAsset(partialParams: ToOptional<{
      [K in keyof GetPackageVersionAssetRequest & keyof GetPackageVersionAssetRequest & keyof GetPackageVersionAssetRequest & keyof Omit<GetPackageVersionAssetRequest, "domain"> & keyof GetPackageVersionAssetRequest & keyof GetPackageVersionAssetRequest]: (GetPackageVersionAssetRequest & GetPackageVersionAssetRequest & GetPackageVersionAssetRequest & Omit<GetPackageVersionAssetRequest, "domain"> & GetPackageVersionAssetRequest & GetPackageVersionAssetRequest)[K]
    ...
    invokeGetPackageVersionReadme(partialParams: ToOptional<{
      [K in keyof GetPackageVersionReadmeRequest & keyof GetPackageVersionReadmeRequest & keyof GetPackageVersionReadmeRequest & keyof Omit<GetPackageVersionReadmeRequest, "domain"> & keyof GetPackageVersionReadmeRequest & keyof GetPackageVersionReadmeRequest]: (GetPackageVersionReadmeRequest & GetPackageVersionReadmeRequest & GetPackageVersionReadmeRequest & Omit<GetPackageVersionReadmeRequest, "domain"> & GetPackageVersionReadmeRequest & GetPackageVersionReadmeRequest)[K]
    ...
    invokeGetRepositoryEndpoint(partialParams: ToOptional<{
      [K in keyof GetRepositoryEndpointRequest & keyof GetRepositoryEndpointRequest & keyof GetRepositoryEndpointRequest & keyof Omit<GetRepositoryEndpointRequest, "domain"> & keyof GetRepositoryEndpointRequest & keyof GetRepositoryEndpointRequest]: (GetRepositoryEndpointRequest & GetRepositoryEndpointRequest & GetRepositoryEndpointRequest & Omit<GetRepositoryEndpointRequest, "domain"> & GetRepositoryEndpointRequest & GetRepositoryEndpointRequest)[K]
    ...
    invokeGetRepositoryPermissionsPolicy(partialParams: ToOptional<{
      [K in keyof GetRepositoryPermissionsPolicyRequest & keyof GetRepositoryPermissionsPolicyRequest & keyof GetRepositoryPermissionsPolicyRequest & keyof Omit<GetRepositoryPermissionsPolicyRequest, "domain"> & keyof GetRepositoryPermissionsPolicyRequest & keyof GetRepositoryPermissionsPolicyRequest]: (GetRepositoryPermissionsPolicyRequest & GetRepositoryPermissionsPolicyRequest & GetRepositoryPermissionsPolicyRequest & Omit<GetRepositoryPermissionsPolicyRequest, "domain"> & GetRepositoryPermissionsPolicyRequest & GetRepositoryPermissionsPolicyRequest)[K]
    ...
    invokeListPackageVersionAssets(partialParams: ToOptional<{
      [K in keyof ListPackageVersionAssetsRequest & keyof ListPackageVersionAssetsRequest & keyof ListPackageVersionAssetsRequest & keyof Omit<ListPackageVersionAssetsRequest, "domain"> & keyof ListPackageVersionAssetsRequest & keyof ListPackageVersionAssetsRequest]: (ListPackageVersionAssetsRequest & ListPackageVersionAssetsRequest & ListPackageVersionAssetsRequest & Omit<ListPackageVersionAssetsRequest, "domain"> & ListPackageVersionAssetsRequest & ListPackageVersionAssetsRequest)[K]
    ...
    invokeListPackageVersions(partialParams: ToOptional<{
      [K in keyof ListPackageVersionsRequest & keyof ListPackageVersionsRequest & keyof ListPackageVersionsRequest & keyof Omit<ListPackageVersionsRequest, "domain"> & keyof ListPackageVersionsRequest & keyof ListPackageVersionsRequest]: (ListPackageVersionsRequest & ListPackageVersionsRequest & ListPackageVersionsRequest & Omit<ListPackageVersionsRequest, "domain"> & ListPackageVersionsRequest & ListPackageVersionsRequest)[K]
    ...
    invokeListPackages(partialParams: ToOptional<{
      [K in keyof ListPackagesRequest & keyof ListPackagesRequest & keyof ListPackagesRequest & keyof Omit<ListPackagesRequest, "domain"> & keyof ListPackagesRequest & keyof ListPackagesRequest]: (ListPackagesRequest & ListPackagesRequest & ListPackagesRequest & Omit<ListPackagesRequest, "domain"> & ListPackagesRequest & ListPackagesRequest)[K]
    ...
    invokeListRepositoriesInDomain(partialParams: ToOptional<{
      [K in keyof ListRepositoriesInDomainRequest & keyof ListRepositoriesInDomainRequest & keyof ListRepositoriesInDomainRequest & keyof Omit<ListRepositoriesInDomainRequest, "domain"> & keyof ListRepositoriesInDomainRequest & keyof ListRepositoriesInDomainRequest]: (ListRepositoriesInDomainRequest & ListRepositoriesInDomainRequest & ListRepositoriesInDomainRequest & Omit<ListRepositoriesInDomainRequest, "domain"> & ListRepositoriesInDomainRequest & ListRepositoriesInDomainRequest)[K]
    ...
    invokePutDomainPermissionsPolicy(partialParams: ToOptional<{
      [K in keyof PutDomainPermissionsPolicyRequest & keyof PutDomainPermissionsPolicyRequest & keyof PutDomainPermissionsPolicyRequest & keyof Omit<PutDomainPermissionsPolicyRequest, "domain"> & keyof PutDomainPermissionsPolicyRequest & keyof PutDomainPermissionsPolicyRequest]: (PutDomainPermissionsPolicyRequest & PutDomainPermissionsPolicyRequest & PutDomainPermissionsPolicyRequest & Omit<PutDomainPermissionsPolicyRequest, "domain"> & PutDomainPermissionsPolicyRequest & PutDomainPermissionsPolicyRequest)[K]
    ...
    invokePutRepositoryPermissionsPolicy(partialParams: ToOptional<{
      [K in keyof PutRepositoryPermissionsPolicyRequest & keyof PutRepositoryPermissionsPolicyRequest & keyof PutRepositoryPermissionsPolicyRequest & keyof Omit<PutRepositoryPermissionsPolicyRequest, "domain"> & keyof PutRepositoryPermissionsPolicyRequest & keyof PutRepositoryPermissionsPolicyRequest]: (PutRepositoryPermissionsPolicyRequest & PutRepositoryPermissionsPolicyRequest & PutRepositoryPermissionsPolicyRequest & Omit<PutRepositoryPermissionsPolicyRequest, "domain"> & PutRepositoryPermissionsPolicyRequest & PutRepositoryPermissionsPolicyRequest)[K]
    ...
    invokeUpdatePackageVersionsStatus(partialParams: ToOptional<{
      [K in keyof UpdatePackageVersionsStatusRequest & keyof UpdatePackageVersionsStatusRequest & keyof UpdatePackageVersionsStatusRequest & keyof Omit<UpdatePackageVersionsStatusRequest, "domain"> & keyof UpdatePackageVersionsStatusRequest & keyof Omit<UpdatePackageVersionsStatusRequest, "repository">]: (UpdatePackageVersionsStatusRequest & UpdatePackageVersionsStatusRequest & UpdatePackageVersionsStatusRequest & Omit<UpdatePackageVersionsStatusRequest, "domain"> & UpdatePackageVersionsStatusRequest & Omit<UpdatePackageVersionsStatusRequest, "repository">)[K]
    ...
    invokeUpdateRepository(partialParams: ToOptional<{
      [K in keyof UpdateRepositoryRequest & keyof UpdateRepositoryRequest & keyof UpdateRepositoryRequest & keyof Omit<UpdateRepositoryRequest, "domain"> & keyof UpdateRepositoryRequest & keyof Omit<UpdateRepositoryRequest, "repository">]: (UpdateRepositoryRequest & UpdateRepositoryRequest & UpdateRepositoryRequest & Omit<UpdateRepositoryRequest, "domain"> & UpdateRepositoryRequest & Omit<UpdateRepositoryRequest, "repository">)[K]
