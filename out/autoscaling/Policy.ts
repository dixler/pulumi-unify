...
export default class extends aws.autoscaling.Policy {
    ...
    invokeGetPredictiveScalingForecast(partialParams: ToOptional<{
      [K in keyof GetPredictiveScalingForecastType & keyof Omit<GetPredictiveScalingForecastType, "PolicyName">]: (GetPredictiveScalingForecastType)[K]
    ...
    invokePutScalingPolicy(partialParams: ToOptional<{
      [K in keyof PutScalingPolicyType & keyof Omit<PutScalingPolicyType, "PolicyName">]: (PutScalingPolicyType)[K]
