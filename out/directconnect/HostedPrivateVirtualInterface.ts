...
export default class extends aws.directconnect.HostedPrivateVirtualInterface {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.directconnect.HostedPrivateVirtualInterface>) {
        super(...args)
        this.booted = false;
