...
export default class extends aws.directconnect.HostedPublicVirtualInterfaceAccepter {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.directconnect.HostedPublicVirtualInterfaceAccepter>) {
        super(...args)
    ...
    invokeCreatePrivateVirtualInterface(partialParams: ToOptional<{
      [K in keyof CreatePrivateVirtualInterfaceRequest & keyof CreatePrivateVirtualInterfaceRequest]: (CreatePrivateVirtualInterfaceRequest & CreatePrivateVirtualInterfaceRequest)[K]
    }>): VirtualInterface {
    ...
    invokeCreatePublicVirtualInterface(partialParams: ToOptional<{
      [K in keyof CreatePublicVirtualInterfaceRequest & keyof CreatePublicVirtualInterfaceRequest]: (CreatePublicVirtualInterfaceRequest & CreatePublicVirtualInterfaceRequest)[K]
    }>): VirtualInterface {
    ...
    invokeCreateTransitVirtualInterface(partialParams: ToOptional<{
      [K in keyof CreateTransitVirtualInterfaceRequest & keyof CreateTransitVirtualInterfaceRequest]: (CreateTransitVirtualInterfaceRequest & CreateTransitVirtualInterfaceRequest)[K]
    }>): CreateTransitVirtualInterfaceResult {
    ...
    invokeDescribeConnectionLoa(partialParams: ToOptional<{
      [K in keyof DescribeConnectionLoaRequest & keyof DescribeConnectionLoaRequest]: (DescribeConnectionLoaRequest & DescribeConnectionLoaRequest)[K]
    }>): DescribeConnectionLoaResponse {
    ...
    invokeDescribeHostedConnections(partialParams: ToOptional<{
      [K in keyof DescribeHostedConnectionsRequest & keyof DescribeHostedConnectionsRequest]: (DescribeHostedConnectionsRequest & DescribeHostedConnectionsRequest)[K]
    }>): Connections {
    ...
    invokeDescribeLoa(partialParams: ToOptional<{
      [K in keyof DescribeLoaRequest & keyof DescribeLoaRequest]: (DescribeLoaRequest & DescribeLoaRequest)[K]
    }>): Loa {
    ...
    invokeDisassociateConnectionFromLag(partialParams: ToOptional<{
      [K in keyof DisassociateConnectionFromLagRequest & keyof DisassociateConnectionFromLagRequest]: (DisassociateConnectionFromLagRequest & DisassociateConnectionFromLagRequest)[K]
    }>): Connection {
    ...
    invokeDisassociateMacSecKey(partialParams: ToOptional<{
      [K in keyof DisassociateMacSecKeyRequest & keyof DisassociateMacSecKeyRequest]: (DisassociateMacSecKeyRequest & DisassociateMacSecKeyRequest)[K]
    }>): DisassociateMacSecKeyResponse {
    ...
    invokeUpdateLag(partialParams: ToOptional<{
      [K in keyof UpdateLagRequest & keyof UpdateLagRequest]: (UpdateLagRequest & UpdateLagRequest)[K]
    }>): Lag {
