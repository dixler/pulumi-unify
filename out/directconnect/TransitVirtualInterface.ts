...
export default class extends aws.directconnect.TransitVirtualInterface {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.directconnect.TransitVirtualInterface>) {
        super(...args)
        this.booted = false;
