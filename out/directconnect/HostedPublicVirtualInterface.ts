...
export default class extends aws.directconnect.HostedPublicVirtualInterface {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.directconnect.HostedPublicVirtualInterface>) {
        super(...args)
