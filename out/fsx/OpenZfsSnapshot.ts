...
export default class extends aws.fsx.OpenZfsSnapshot {
    ...
    invokeCreateSnapshot(partialParams: ToOptional<{
      [K in keyof CreateSnapshotRequest & keyof Omit<CreateSnapshotRequest, "Name" | "VolumeId">]: (CreateSnapshotRequest)[K]
    ...
    invokeCreateVolume(partialParams: ToOptional<{
      [K in keyof CreateVolumeRequest & keyof Omit<CreateVolumeRequest, "Name">]: (CreateVolumeRequest)[K]
