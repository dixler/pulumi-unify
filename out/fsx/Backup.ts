...
export default class extends aws.fsx.Backup {
    ...
    invokeCopyBackup(partialParams: ToOptional<{
      [K in keyof CopyBackupRequest & keyof CopyBackupRequest & keyof CopyBackupRequest & keyof CopyBackupRequest & keyof CopyBackupRequest & keyof CopyBackupRequest]: (CopyBackupRequest & CopyBackupRequest & CopyBackupRequest & CopyBackupRequest & CopyBackupRequest & CopyBackupRequest)[K]
    ...
    invokeCreateDataRepositoryAssociation(partialParams: ToOptional<{
      [K in keyof CreateDataRepositoryAssociationRequest & keyof CreateDataRepositoryAssociationRequest & keyof CreateDataRepositoryAssociationRequest & keyof CreateDataRepositoryAssociationRequest & keyof CreateDataRepositoryAssociationRequest & keyof CreateDataRepositoryAssociationRequest]: (CreateDataRepositoryAssociationRequest & CreateDataRepositoryAssociationRequest & CreateDataRepositoryAssociationRequest & CreateDataRepositoryAssociationRequest & CreateDataRepositoryAssociationRequest & CreateDataRepositoryAssociationRequest)[K]
    ...
    invokeCreateDataRepositoryTask(partialParams: ToOptional<{
      [K in keyof CreateDataRepositoryTaskRequest & keyof CreateDataRepositoryTaskRequest & keyof CreateDataRepositoryTaskRequest & keyof CreateDataRepositoryTaskRequest & keyof CreateDataRepositoryTaskRequest & keyof CreateDataRepositoryTaskRequest]: (CreateDataRepositoryTaskRequest & CreateDataRepositoryTaskRequest & CreateDataRepositoryTaskRequest & CreateDataRepositoryTaskRequest & CreateDataRepositoryTaskRequest & CreateDataRepositoryTaskRequest)[K]
    ...
    invokeCreateFileSystem(partialParams: ToOptional<{
      [K in keyof CreateFileSystemRequest & keyof CreateFileSystemRequest & keyof CreateFileSystemRequest & keyof CreateFileSystemRequest & keyof CreateFileSystemRequest & keyof CreateFileSystemRequest]: (CreateFileSystemRequest & CreateFileSystemRequest & CreateFileSystemRequest & CreateFileSystemRequest & CreateFileSystemRequest & CreateFileSystemRequest)[K]
    ...
    invokeCreateFileSystemFromBackup(partialParams: ToOptional<{
      [K in keyof CreateFileSystemFromBackupRequest & keyof CreateFileSystemFromBackupRequest & keyof CreateFileSystemFromBackupRequest & keyof CreateFileSystemFromBackupRequest & keyof CreateFileSystemFromBackupRequest & keyof CreateFileSystemFromBackupRequest]: (CreateFileSystemFromBackupRequest & CreateFileSystemFromBackupRequest & CreateFileSystemFromBackupRequest & CreateFileSystemFromBackupRequest & CreateFileSystemFromBackupRequest & CreateFileSystemFromBackupRequest)[K]
    ...
    invokeCreateStorageVirtualMachine(partialParams: ToOptional<{
      [K in keyof CreateStorageVirtualMachineRequest & keyof CreateStorageVirtualMachineRequest & keyof CreateStorageVirtualMachineRequest & keyof CreateStorageVirtualMachineRequest & keyof CreateStorageVirtualMachineRequest & keyof CreateStorageVirtualMachineRequest]: (CreateStorageVirtualMachineRequest & CreateStorageVirtualMachineRequest & CreateStorageVirtualMachineRequest & CreateStorageVirtualMachineRequest & CreateStorageVirtualMachineRequest & CreateStorageVirtualMachineRequest)[K]
    ...
    invokeCreateVolumeFromBackup(partialParams: ToOptional<{
      [K in keyof CreateVolumeFromBackupRequest & keyof CreateVolumeFromBackupRequest & keyof CreateVolumeFromBackupRequest & keyof CreateVolumeFromBackupRequest & keyof CreateVolumeFromBackupRequest & keyof CreateVolumeFromBackupRequest]: (CreateVolumeFromBackupRequest & CreateVolumeFromBackupRequest & CreateVolumeFromBackupRequest & CreateVolumeFromBackupRequest & CreateVolumeFromBackupRequest & CreateVolumeFromBackupRequest)[K]
    ...
    invokeDeleteDataRepositoryAssociation(partialParams: ToOptional<{
      [K in keyof DeleteDataRepositoryAssociationRequest & keyof DeleteDataRepositoryAssociationRequest & keyof DeleteDataRepositoryAssociationRequest & keyof DeleteDataRepositoryAssociationRequest & keyof DeleteDataRepositoryAssociationRequest & keyof DeleteDataRepositoryAssociationRequest]: (DeleteDataRepositoryAssociationRequest & DeleteDataRepositoryAssociationRequest & DeleteDataRepositoryAssociationRequest & DeleteDataRepositoryAssociationRequest & DeleteDataRepositoryAssociationRequest & DeleteDataRepositoryAssociationRequest)[K]
    ...
    invokeDeleteStorageVirtualMachine(partialParams: ToOptional<{
      [K in keyof DeleteStorageVirtualMachineRequest & keyof DeleteStorageVirtualMachineRequest & keyof DeleteStorageVirtualMachineRequest & keyof DeleteStorageVirtualMachineRequest & keyof DeleteStorageVirtualMachineRequest & keyof DeleteStorageVirtualMachineRequest]: (DeleteStorageVirtualMachineRequest & DeleteStorageVirtualMachineRequest & DeleteStorageVirtualMachineRequest & DeleteStorageVirtualMachineRequest & DeleteStorageVirtualMachineRequest & DeleteStorageVirtualMachineRequest)[K]
    ...
    invokeDescribeFileSystemAliases(partialParams: ToOptional<{
      [K in keyof DescribeFileSystemAliasesRequest & keyof DescribeFileSystemAliasesRequest & keyof DescribeFileSystemAliasesRequest & keyof DescribeFileSystemAliasesRequest & keyof DescribeFileSystemAliasesRequest & keyof DescribeFileSystemAliasesRequest]: (DescribeFileSystemAliasesRequest & DescribeFileSystemAliasesRequest & DescribeFileSystemAliasesRequest & DescribeFileSystemAliasesRequest & DescribeFileSystemAliasesRequest & DescribeFileSystemAliasesRequest)[K]
    ...
    invokeDisassociateFileSystemAliases(partialParams: ToOptional<{
      [K in keyof DisassociateFileSystemAliasesRequest & keyof DisassociateFileSystemAliasesRequest & keyof DisassociateFileSystemAliasesRequest & keyof DisassociateFileSystemAliasesRequest & keyof DisassociateFileSystemAliasesRequest & keyof DisassociateFileSystemAliasesRequest]: (DisassociateFileSystemAliasesRequest & DisassociateFileSystemAliasesRequest & DisassociateFileSystemAliasesRequest & DisassociateFileSystemAliasesRequest & DisassociateFileSystemAliasesRequest & DisassociateFileSystemAliasesRequest)[K]
    ...
    invokeReleaseFileSystemNfsV3Locks(partialParams: ToOptional<{
      [K in keyof ReleaseFileSystemNfsV3LocksRequest & keyof Omit<ReleaseFileSystemNfsV3LocksRequest, "FileSystemId"> & keyof ReleaseFileSystemNfsV3LocksRequest & keyof ReleaseFileSystemNfsV3LocksRequest & keyof ReleaseFileSystemNfsV3LocksRequest & keyof ReleaseFileSystemNfsV3LocksRequest]: (ReleaseFileSystemNfsV3LocksRequest & Omit<ReleaseFileSystemNfsV3LocksRequest, "FileSystemId"> & ReleaseFileSystemNfsV3LocksRequest & ReleaseFileSystemNfsV3LocksRequest & ReleaseFileSystemNfsV3LocksRequest & ReleaseFileSystemNfsV3LocksRequest)[K]
    ...
    invokeRestoreVolumeFromSnapshot(partialParams: ToOptional<{
      [K in keyof RestoreVolumeFromSnapshotRequest & keyof RestoreVolumeFromSnapshotRequest & keyof RestoreVolumeFromSnapshotRequest & keyof RestoreVolumeFromSnapshotRequest & keyof RestoreVolumeFromSnapshotRequest & keyof RestoreVolumeFromSnapshotRequest]: (RestoreVolumeFromSnapshotRequest & RestoreVolumeFromSnapshotRequest & RestoreVolumeFromSnapshotRequest & RestoreVolumeFromSnapshotRequest & RestoreVolumeFromSnapshotRequest & RestoreVolumeFromSnapshotRequest)[K]
    ...
    invokeUpdateDataRepositoryAssociation(partialParams: ToOptional<{
      [K in keyof UpdateDataRepositoryAssociationRequest & keyof UpdateDataRepositoryAssociationRequest & keyof UpdateDataRepositoryAssociationRequest & keyof UpdateDataRepositoryAssociationRequest & keyof UpdateDataRepositoryAssociationRequest & keyof UpdateDataRepositoryAssociationRequest]: (UpdateDataRepositoryAssociationRequest & UpdateDataRepositoryAssociationRequest & UpdateDataRepositoryAssociationRequest & UpdateDataRepositoryAssociationRequest & UpdateDataRepositoryAssociationRequest & UpdateDataRepositoryAssociationRequest)[K]
    ...
    invokeUpdateFileSystem(partialParams: ToOptional<{
      [K in keyof UpdateFileSystemRequest & keyof Omit<UpdateFileSystemRequest, "FileSystemId"> & keyof UpdateFileSystemRequest & keyof UpdateFileSystemRequest & keyof UpdateFileSystemRequest & keyof UpdateFileSystemRequest]: (UpdateFileSystemRequest & Omit<UpdateFileSystemRequest, "FileSystemId"> & UpdateFileSystemRequest & UpdateFileSystemRequest & UpdateFileSystemRequest & UpdateFileSystemRequest)[K]
    ...
    invokeUpdateSnapshot(partialParams: ToOptional<{
      [K in keyof UpdateSnapshotRequest & keyof UpdateSnapshotRequest & keyof UpdateSnapshotRequest & keyof UpdateSnapshotRequest & keyof UpdateSnapshotRequest & keyof UpdateSnapshotRequest]: (UpdateSnapshotRequest & UpdateSnapshotRequest & UpdateSnapshotRequest & UpdateSnapshotRequest & UpdateSnapshotRequest & UpdateSnapshotRequest)[K]
    ...
    invokeUpdateStorageVirtualMachine(partialParams: ToOptional<{
      [K in keyof UpdateStorageVirtualMachineRequest & keyof UpdateStorageVirtualMachineRequest & keyof UpdateStorageVirtualMachineRequest & keyof UpdateStorageVirtualMachineRequest & keyof UpdateStorageVirtualMachineRequest & keyof UpdateStorageVirtualMachineRequest]: (UpdateStorageVirtualMachineRequest & UpdateStorageVirtualMachineRequest & UpdateStorageVirtualMachineRequest & UpdateStorageVirtualMachineRequest & UpdateStorageVirtualMachineRequest & UpdateStorageVirtualMachineRequest)[K]
