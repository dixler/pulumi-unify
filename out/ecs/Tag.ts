...
export default class extends aws.ecs.Tag {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.ecs.Tag>) {
        super(...args)
    ...
    invokeTagResource(partialParams: ToOptional<{
      [K in keyof TagResourceRequest & keyof Omit<TagResourceRequest, "resourceArn"> & keyof TagResourceRequest]: (TagResourceRequest & Omit<TagResourceRequest, "resourceArn"> & TagResourceRequest)[K]
    ...
    invokeUntagResource(partialParams: ToOptional<{
      [K in keyof UntagResourceRequest & keyof Omit<UntagResourceRequest, "resourceArn"> & keyof UntagResourceRequest]: (UntagResourceRequest & Omit<UntagResourceRequest, "resourceArn"> & UntagResourceRequest)[K]
    ...
    invokeUpdateCapacityProvider(partialParams: ToOptional<{
      [K in keyof UpdateCapacityProviderRequest & keyof UpdateCapacityProviderRequest & keyof UpdateCapacityProviderRequest]: (UpdateCapacityProviderRequest & UpdateCapacityProviderRequest & UpdateCapacityProviderRequest)[K]
