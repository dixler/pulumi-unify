...
export default class extends aws.ecs.CapacityProvider {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.ecs.CapacityProvider>) {
        super(...args)
    ...
    invokeCreateCapacityProvider(partialParams: ToOptional<{
      [K in keyof CreateCapacityProviderRequest & keyof CreateCapacityProviderRequest]: (CreateCapacityProviderRequest & CreateCapacityProviderRequest)[K]
    ...
    invokeCreateTaskSet(partialParams: ToOptional<{
      [K in keyof CreateTaskSetRequest & keyof CreateTaskSetRequest]: (CreateTaskSetRequest & CreateTaskSetRequest)[K]
    ...
    invokeDeleteAccountSetting(partialParams: ToOptional<{
      [K in keyof DeleteAccountSettingRequest & keyof DeleteAccountSettingRequest]: (DeleteAccountSettingRequest & DeleteAccountSettingRequest)[K]
    ...
    invokeDeleteAttributes(partialParams: ToOptional<{
      [K in keyof DeleteAttributesRequest & keyof DeleteAttributesRequest]: (DeleteAttributesRequest & DeleteAttributesRequest)[K]
    ...
    invokeDeleteCapacityProvider(partialParams: ToOptional<{
      [K in keyof DeleteCapacityProviderRequest & keyof DeleteCapacityProviderRequest]: (DeleteCapacityProviderRequest & DeleteCapacityProviderRequest)[K]
    ...
    invokeDeleteTaskSet(partialParams: ToOptional<{
      [K in keyof DeleteTaskSetRequest & keyof DeleteTaskSetRequest]: (DeleteTaskSetRequest & DeleteTaskSetRequest)[K]
    ...
    invokeDeregisterContainerInstance(partialParams: ToOptional<{
      [K in keyof DeregisterContainerInstanceRequest & keyof DeregisterContainerInstanceRequest]: (DeregisterContainerInstanceRequest & DeregisterContainerInstanceRequest)[K]
    ...
    invokeDeregisterTaskDefinition(partialParams: ToOptional<{
      [K in keyof DeregisterTaskDefinitionRequest & keyof DeregisterTaskDefinitionRequest]: (DeregisterTaskDefinitionRequest & DeregisterTaskDefinitionRequest)[K]
    ...
    invokeDescribeContainerInstances(partialParams: ToOptional<{
      [K in keyof DescribeContainerInstancesRequest & keyof DescribeContainerInstancesRequest]: (DescribeContainerInstancesRequest & DescribeContainerInstancesRequest)[K]
    ...
    invokeDescribeServices(partialParams: ToOptional<{
      [K in keyof DescribeServicesRequest & keyof DescribeServicesRequest]: (DescribeServicesRequest & DescribeServicesRequest)[K]
    ...
    invokeDescribeTaskDefinition(partialParams: ToOptional<{
      [K in keyof DescribeTaskDefinitionRequest & keyof DescribeTaskDefinitionRequest]: (DescribeTaskDefinitionRequest & DescribeTaskDefinitionRequest)[K]
    ...
    invokeDescribeTaskSets(partialParams: ToOptional<{
      [K in keyof DescribeTaskSetsRequest & keyof DescribeTaskSetsRequest]: (DescribeTaskSetsRequest & DescribeTaskSetsRequest)[K]
    ...
    invokeDescribeTasks(partialParams: ToOptional<{
      [K in keyof DescribeTasksRequest & keyof DescribeTasksRequest]: (DescribeTasksRequest & DescribeTasksRequest)[K]
    ...
    invokeExecuteCommand(partialParams: ToOptional<{
      [K in keyof ExecuteCommandRequest & keyof ExecuteCommandRequest]: (ExecuteCommandRequest & ExecuteCommandRequest)[K]
    ...
    invokeListAttributes(partialParams: ToOptional<{
      [K in keyof ListAttributesRequest & keyof ListAttributesRequest]: (ListAttributesRequest & ListAttributesRequest)[K]
    ...
    invokePutAccountSetting(partialParams: ToOptional<{
      [K in keyof PutAccountSettingRequest & keyof PutAccountSettingRequest]: (PutAccountSettingRequest & PutAccountSettingRequest)[K]
    ...
    invokePutAccountSettingDefault(partialParams: ToOptional<{
      [K in keyof PutAccountSettingDefaultRequest & keyof PutAccountSettingDefaultRequest]: (PutAccountSettingDefaultRequest & PutAccountSettingDefaultRequest)[K]
    ...
    invokePutAttributes(partialParams: ToOptional<{
      [K in keyof PutAttributesRequest & keyof PutAttributesRequest]: (PutAttributesRequest & PutAttributesRequest)[K]
    ...
    invokePutClusterCapacityProviders(partialParams: ToOptional<{
      [K in keyof PutClusterCapacityProvidersRequest & keyof PutClusterCapacityProvidersRequest]: (PutClusterCapacityProvidersRequest & PutClusterCapacityProvidersRequest)[K]
    ...
    invokeRegisterTaskDefinition(partialParams: ToOptional<{
      [K in keyof RegisterTaskDefinitionRequest & keyof RegisterTaskDefinitionRequest]: (RegisterTaskDefinitionRequest & RegisterTaskDefinitionRequest)[K]
    ...
    invokeRunTask(partialParams: ToOptional<{
      [K in keyof RunTaskRequest & keyof RunTaskRequest]: (RunTaskRequest & RunTaskRequest)[K]
    ...
    invokeStartTask(partialParams: ToOptional<{
      [K in keyof StartTaskRequest & keyof StartTaskRequest]: (StartTaskRequest & StartTaskRequest)[K]
    ...
    invokeStopTask(partialParams: ToOptional<{
      [K in keyof StopTaskRequest & keyof StopTaskRequest]: (StopTaskRequest & StopTaskRequest)[K]
    ...
    invokeSubmitAttachmentStateChanges(partialParams: ToOptional<{
      [K in keyof SubmitAttachmentStateChangesRequest & keyof SubmitAttachmentStateChangesRequest]: (SubmitAttachmentStateChangesRequest & SubmitAttachmentStateChangesRequest)[K]
    ...
    invokeUpdateCapacityProvider(partialParams: ToOptional<{
      [K in keyof UpdateCapacityProviderRequest & keyof Omit<UpdateCapacityProviderRequest, "name">]: (UpdateCapacityProviderRequest & Omit<UpdateCapacityProviderRequest, "name">)[K]
    ...
    invokeUpdateClusterSettings(partialParams: ToOptional<{
      [K in keyof UpdateClusterSettingsRequest & keyof UpdateClusterSettingsRequest]: (UpdateClusterSettingsRequest & UpdateClusterSettingsRequest)[K]
    ...
    invokeUpdateContainerAgent(partialParams: ToOptional<{
      [K in keyof UpdateContainerAgentRequest & keyof UpdateContainerAgentRequest]: (UpdateContainerAgentRequest & UpdateContainerAgentRequest)[K]
    ...
    invokeUpdateContainerInstancesState(partialParams: ToOptional<{
      [K in keyof UpdateContainerInstancesStateRequest & keyof UpdateContainerInstancesStateRequest]: (UpdateContainerInstancesStateRequest & UpdateContainerInstancesStateRequest)[K]
    ...
    invokeUpdateServicePrimaryTaskSet(partialParams: ToOptional<{
      [K in keyof UpdateServicePrimaryTaskSetRequest & keyof UpdateServicePrimaryTaskSetRequest]: (UpdateServicePrimaryTaskSetRequest & UpdateServicePrimaryTaskSetRequest)[K]
    ...
    invokeUpdateTaskSet(partialParams: ToOptional<{
      [K in keyof UpdateTaskSetRequest & keyof UpdateTaskSetRequest]: (UpdateTaskSetRequest & UpdateTaskSetRequest)[K]
