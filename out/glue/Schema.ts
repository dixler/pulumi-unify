...
export default class extends aws.glue.Schema {
    ...
    invokeGetUnfilteredPartitionMetadata(partialParams: ToOptional<{
      [K in keyof GetUnfilteredPartitionMetadataRequest & keyof GetUnfilteredPartitionMetadataRequest & keyof GetUnfilteredPartitionMetadataRequest & keyof GetUnfilteredPartitionMetadataRequest & keyof GetUnfilteredPartitionMetadataRequest & keyof GetUnfilteredPartitionMetadataRequest & keyof GetUnfilteredPartitionMetadataRequest & keyof GetUnfilteredPartitionMetadataRequest]: (GetUnfilteredPartitionMetadataRequest & GetUnfilteredPartitionMetadataRequest & GetUnfilteredPartitionMetadataRequest & GetUnfilteredPartitionMetadataRequest & GetUnfilteredPartitionMetadataRequest & GetUnfilteredPartitionMetadataRequest & GetUnfilteredPartitionMetadataRequest & GetUnfilteredPartitionMetadataRequest)[K]
    ...
    invokeGetUnfilteredPartitionsMetadata(partialParams: ToOptional<{
      [K in keyof GetUnfilteredPartitionsMetadataRequest & keyof GetUnfilteredPartitionsMetadataRequest & keyof GetUnfilteredPartitionsMetadataRequest & keyof GetUnfilteredPartitionsMetadataRequest & keyof GetUnfilteredPartitionsMetadataRequest & keyof GetUnfilteredPartitionsMetadataRequest & keyof GetUnfilteredPartitionsMetadataRequest & keyof GetUnfilteredPartitionsMetadataRequest]: (GetUnfilteredPartitionsMetadataRequest & GetUnfilteredPartitionsMetadataRequest & GetUnfilteredPartitionsMetadataRequest & GetUnfilteredPartitionsMetadataRequest & GetUnfilteredPartitionsMetadataRequest & GetUnfilteredPartitionsMetadataRequest & GetUnfilteredPartitionsMetadataRequest & GetUnfilteredPartitionsMetadataRequest)[K]
    ...
    invokeGetUnfilteredTableMetadata(partialParams: ToOptional<{
      [K in keyof GetUnfilteredTableMetadataRequest & keyof GetUnfilteredTableMetadataRequest & keyof GetUnfilteredTableMetadataRequest & keyof GetUnfilteredTableMetadataRequest & keyof GetUnfilteredTableMetadataRequest & keyof GetUnfilteredTableMetadataRequest & keyof GetUnfilteredTableMetadataRequest & keyof GetUnfilteredTableMetadataRequest]: (GetUnfilteredTableMetadataRequest & GetUnfilteredTableMetadataRequest & GetUnfilteredTableMetadataRequest & GetUnfilteredTableMetadataRequest & GetUnfilteredTableMetadataRequest & GetUnfilteredTableMetadataRequest & GetUnfilteredTableMetadataRequest & GetUnfilteredTableMetadataRequest)[K]
    ...
    invokePutWorkflowRunProperties(partialParams: ToOptional<{
      [K in keyof PutWorkflowRunPropertiesRequest & keyof PutWorkflowRunPropertiesRequest & keyof PutWorkflowRunPropertiesRequest & keyof PutWorkflowRunPropertiesRequest & keyof PutWorkflowRunPropertiesRequest & keyof PutWorkflowRunPropertiesRequest & keyof PutWorkflowRunPropertiesRequest & keyof PutWorkflowRunPropertiesRequest]: (PutWorkflowRunPropertiesRequest & PutWorkflowRunPropertiesRequest & PutWorkflowRunPropertiesRequest & PutWorkflowRunPropertiesRequest & PutWorkflowRunPropertiesRequest & PutWorkflowRunPropertiesRequest & PutWorkflowRunPropertiesRequest & PutWorkflowRunPropertiesRequest)[K]
    ...
    invokeResumeWorkflowRun(partialParams: ToOptional<{
      [K in keyof ResumeWorkflowRunRequest & keyof ResumeWorkflowRunRequest & keyof ResumeWorkflowRunRequest & keyof ResumeWorkflowRunRequest & keyof ResumeWorkflowRunRequest & keyof ResumeWorkflowRunRequest & keyof ResumeWorkflowRunRequest & keyof ResumeWorkflowRunRequest]: (ResumeWorkflowRunRequest & ResumeWorkflowRunRequest & ResumeWorkflowRunRequest & ResumeWorkflowRunRequest & ResumeWorkflowRunRequest & ResumeWorkflowRunRequest & ResumeWorkflowRunRequest & ResumeWorkflowRunRequest)[K]
    ...
    invokeStartCrawler(partialParams: ToOptional<{
      [K in keyof StartCrawlerRequest & keyof StartCrawlerRequest & keyof StartCrawlerRequest & keyof StartCrawlerRequest & keyof StartCrawlerRequest & keyof StartCrawlerRequest & keyof StartCrawlerRequest & keyof StartCrawlerRequest]: (StartCrawlerRequest & StartCrawlerRequest & StartCrawlerRequest & StartCrawlerRequest & StartCrawlerRequest & StartCrawlerRequest & StartCrawlerRequest & StartCrawlerRequest)[K]
    ...
    invokeStartTrigger(partialParams: ToOptional<{
      [K in keyof StartTriggerRequest & keyof StartTriggerRequest & keyof StartTriggerRequest & keyof StartTriggerRequest & keyof StartTriggerRequest & keyof StartTriggerRequest & keyof StartTriggerRequest & keyof StartTriggerRequest]: (StartTriggerRequest & StartTriggerRequest & StartTriggerRequest & StartTriggerRequest & StartTriggerRequest & StartTriggerRequest & StartTriggerRequest & StartTriggerRequest)[K]
    ...
    invokeStartWorkflowRun(partialParams: ToOptional<{
      [K in keyof StartWorkflowRunRequest & keyof StartWorkflowRunRequest & keyof StartWorkflowRunRequest & keyof StartWorkflowRunRequest & keyof StartWorkflowRunRequest & keyof StartWorkflowRunRequest & keyof StartWorkflowRunRequest & keyof StartWorkflowRunRequest]: (StartWorkflowRunRequest & StartWorkflowRunRequest & StartWorkflowRunRequest & StartWorkflowRunRequest & StartWorkflowRunRequest & StartWorkflowRunRequest & StartWorkflowRunRequest & StartWorkflowRunRequest)[K]
    ...
    invokeStopCrawler(partialParams: ToOptional<{
      [K in keyof StopCrawlerRequest & keyof StopCrawlerRequest & keyof StopCrawlerRequest & keyof StopCrawlerRequest & keyof StopCrawlerRequest & keyof StopCrawlerRequest & keyof StopCrawlerRequest & keyof StopCrawlerRequest]: (StopCrawlerRequest & StopCrawlerRequest & StopCrawlerRequest & StopCrawlerRequest & StopCrawlerRequest & StopCrawlerRequest & StopCrawlerRequest & StopCrawlerRequest)[K]
    ...
    invokeStopTrigger(partialParams: ToOptional<{
      [K in keyof StopTriggerRequest & keyof StopTriggerRequest & keyof StopTriggerRequest & keyof StopTriggerRequest & keyof StopTriggerRequest & keyof StopTriggerRequest & keyof StopTriggerRequest & keyof StopTriggerRequest]: (StopTriggerRequest & StopTriggerRequest & StopTriggerRequest & StopTriggerRequest & StopTriggerRequest & StopTriggerRequest & StopTriggerRequest & StopTriggerRequest)[K]
    ...
    invokeStopWorkflowRun(partialParams: ToOptional<{
      [K in keyof StopWorkflowRunRequest & keyof StopWorkflowRunRequest & keyof StopWorkflowRunRequest & keyof StopWorkflowRunRequest & keyof StopWorkflowRunRequest & keyof StopWorkflowRunRequest & keyof StopWorkflowRunRequest & keyof StopWorkflowRunRequest]: (StopWorkflowRunRequest & StopWorkflowRunRequest & StopWorkflowRunRequest & StopWorkflowRunRequest & StopWorkflowRunRequest & StopWorkflowRunRequest & StopWorkflowRunRequest & StopWorkflowRunRequest)[K]
    ...
    invokeUpdateBlueprint(partialParams: ToOptional<{
      [K in keyof UpdateBlueprintRequest & keyof UpdateBlueprintRequest & keyof UpdateBlueprintRequest & keyof UpdateBlueprintRequest & keyof UpdateBlueprintRequest & keyof UpdateBlueprintRequest & keyof UpdateBlueprintRequest & keyof UpdateBlueprintRequest]: (UpdateBlueprintRequest & UpdateBlueprintRequest & UpdateBlueprintRequest & UpdateBlueprintRequest & UpdateBlueprintRequest & UpdateBlueprintRequest & UpdateBlueprintRequest & UpdateBlueprintRequest)[K]
    ...
    invokeUpdateColumnStatisticsForPartition(partialParams: ToOptional<{
      [K in keyof UpdateColumnStatisticsForPartitionRequest & keyof UpdateColumnStatisticsForPartitionRequest & keyof UpdateColumnStatisticsForPartitionRequest & keyof UpdateColumnStatisticsForPartitionRequest & keyof UpdateColumnStatisticsForPartitionRequest & keyof UpdateColumnStatisticsForPartitionRequest & keyof UpdateColumnStatisticsForPartitionRequest & keyof UpdateColumnStatisticsForPartitionRequest]: (UpdateColumnStatisticsForPartitionRequest & UpdateColumnStatisticsForPartitionRequest & UpdateColumnStatisticsForPartitionRequest & UpdateColumnStatisticsForPartitionRequest & UpdateColumnStatisticsForPartitionRequest & UpdateColumnStatisticsForPartitionRequest & UpdateColumnStatisticsForPartitionRequest & UpdateColumnStatisticsForPartitionRequest)[K]
    ...
    invokeUpdateColumnStatisticsForTable(partialParams: ToOptional<{
      [K in keyof UpdateColumnStatisticsForTableRequest & keyof UpdateColumnStatisticsForTableRequest & keyof UpdateColumnStatisticsForTableRequest & keyof UpdateColumnStatisticsForTableRequest & keyof UpdateColumnStatisticsForTableRequest & keyof UpdateColumnStatisticsForTableRequest & keyof UpdateColumnStatisticsForTableRequest & keyof UpdateColumnStatisticsForTableRequest]: (UpdateColumnStatisticsForTableRequest & UpdateColumnStatisticsForTableRequest & UpdateColumnStatisticsForTableRequest & UpdateColumnStatisticsForTableRequest & UpdateColumnStatisticsForTableRequest & UpdateColumnStatisticsForTableRequest & UpdateColumnStatisticsForTableRequest & UpdateColumnStatisticsForTableRequest)[K]
    ...
    invokeUpdateCrawler(partialParams: ToOptional<{
      [K in keyof UpdateCrawlerRequest & keyof UpdateCrawlerRequest & keyof UpdateCrawlerRequest & keyof UpdateCrawlerRequest & keyof UpdateCrawlerRequest & keyof UpdateCrawlerRequest & keyof UpdateCrawlerRequest & keyof UpdateCrawlerRequest]: (UpdateCrawlerRequest & UpdateCrawlerRequest & UpdateCrawlerRequest & UpdateCrawlerRequest & UpdateCrawlerRequest & UpdateCrawlerRequest & UpdateCrawlerRequest & UpdateCrawlerRequest)[K]
    ...
    invokeUpdateDatabase(partialParams: ToOptional<{
      [K in keyof UpdateDatabaseRequest & keyof UpdateDatabaseRequest & keyof UpdateDatabaseRequest & keyof UpdateDatabaseRequest & keyof UpdateDatabaseRequest & keyof UpdateDatabaseRequest & keyof UpdateDatabaseRequest & keyof UpdateDatabaseRequest]: (UpdateDatabaseRequest & UpdateDatabaseRequest & UpdateDatabaseRequest & UpdateDatabaseRequest & UpdateDatabaseRequest & UpdateDatabaseRequest & UpdateDatabaseRequest & UpdateDatabaseRequest)[K]
    ...
    invokeUpdatePartition(partialParams: ToOptional<{
      [K in keyof UpdatePartitionRequest & keyof UpdatePartitionRequest & keyof UpdatePartitionRequest & keyof UpdatePartitionRequest & keyof UpdatePartitionRequest & keyof UpdatePartitionRequest & keyof UpdatePartitionRequest & keyof UpdatePartitionRequest]: (UpdatePartitionRequest & UpdatePartitionRequest & UpdatePartitionRequest & UpdatePartitionRequest & UpdatePartitionRequest & UpdatePartitionRequest & UpdatePartitionRequest & UpdatePartitionRequest)[K]
    ...
    invokeUpdateRegistry(partialParams: ToOptional<{
      [K in keyof UpdateRegistryInput & keyof UpdateRegistryInput & keyof UpdateRegistryInput & keyof Omit<UpdateRegistryInput, "Description"> & keyof UpdateRegistryInput & keyof UpdateRegistryInput & keyof UpdateRegistryInput & keyof UpdateRegistryInput]: (UpdateRegistryInput & UpdateRegistryInput & UpdateRegistryInput & Omit<UpdateRegistryInput, "Description"> & UpdateRegistryInput & UpdateRegistryInput & UpdateRegistryInput & UpdateRegistryInput)[K]
    ...
    invokeUpdateTable(partialParams: ToOptional<{
      [K in keyof UpdateTableRequest & keyof UpdateTableRequest & keyof UpdateTableRequest & keyof UpdateTableRequest & keyof UpdateTableRequest & keyof UpdateTableRequest & keyof UpdateTableRequest & keyof UpdateTableRequest]: (UpdateTableRequest & UpdateTableRequest & UpdateTableRequest & UpdateTableRequest & UpdateTableRequest & UpdateTableRequest & UpdateTableRequest & UpdateTableRequest)[K]
    ...
    invokeUpdateTrigger(partialParams: ToOptional<{
      [K in keyof UpdateTriggerRequest & keyof UpdateTriggerRequest & keyof UpdateTriggerRequest & keyof UpdateTriggerRequest & keyof UpdateTriggerRequest & keyof UpdateTriggerRequest & keyof UpdateTriggerRequest & keyof UpdateTriggerRequest]: (UpdateTriggerRequest & UpdateTriggerRequest & UpdateTriggerRequest & UpdateTriggerRequest & UpdateTriggerRequest & UpdateTriggerRequest & UpdateTriggerRequest & UpdateTriggerRequest)[K]
    ...
    invokeUpdateUserDefinedFunction(partialParams: ToOptional<{
      [K in keyof UpdateUserDefinedFunctionRequest & keyof UpdateUserDefinedFunctionRequest & keyof UpdateUserDefinedFunctionRequest & keyof UpdateUserDefinedFunctionRequest & keyof UpdateUserDefinedFunctionRequest & keyof UpdateUserDefinedFunctionRequest & keyof UpdateUserDefinedFunctionRequest & keyof UpdateUserDefinedFunctionRequest]: (UpdateUserDefinedFunctionRequest & UpdateUserDefinedFunctionRequest & UpdateUserDefinedFunctionRequest & UpdateUserDefinedFunctionRequest & UpdateUserDefinedFunctionRequest & UpdateUserDefinedFunctionRequest & UpdateUserDefinedFunctionRequest & UpdateUserDefinedFunctionRequest)[K]
    ...
    invokeUpdateWorkflow(partialParams: ToOptional<{
      [K in keyof UpdateWorkflowRequest & keyof UpdateWorkflowRequest & keyof UpdateWorkflowRequest & keyof UpdateWorkflowRequest & keyof UpdateWorkflowRequest & keyof UpdateWorkflowRequest & keyof UpdateWorkflowRequest & keyof UpdateWorkflowRequest]: (UpdateWorkflowRequest & UpdateWorkflowRequest & UpdateWorkflowRequest & UpdateWorkflowRequest & UpdateWorkflowRequest & UpdateWorkflowRequest & UpdateWorkflowRequest & UpdateWorkflowRequest)[K]
