...
export default class extends aws.glue.DataCatalogEncryptionSettings {
    ...
    invokeGetUnfilteredPartitionMetadata(partialParams: ToOptional<{
      [K in keyof Omit<GetUnfilteredPartitionMetadataRequest, "CatalogId">]: (Omit<GetUnfilteredPartitionMetadataRequest, "CatalogId">)[K]
    }>): GetUnfilteredPartitionMetadataResponse {
    ...
    invokeGetUnfilteredPartitionsMetadata(partialParams: ToOptional<{
      [K in keyof Omit<GetUnfilteredPartitionsMetadataRequest, "CatalogId">]: (Omit<GetUnfilteredPartitionsMetadataRequest, "CatalogId">)[K]
    }>): GetUnfilteredPartitionsMetadataResponse {
    ...
    invokeGetUnfilteredTableMetadata(partialParams: ToOptional<{
      [K in keyof Omit<GetUnfilteredTableMetadataRequest, "CatalogId">]: (Omit<GetUnfilteredTableMetadataRequest, "CatalogId">)[K]
    }>): GetUnfilteredTableMetadataResponse {
    ...
    invokePutWorkflowRunProperties(partialParams: ToOptional<{
      [K in keyof PutWorkflowRunPropertiesRequest]: (PutWorkflowRunPropertiesRequest)[K]
    }>): PutWorkflowRunPropertiesResponse {
    ...
    invokeResumeWorkflowRun(partialParams: ToOptional<{
      [K in keyof ResumeWorkflowRunRequest]: (ResumeWorkflowRunRequest)[K]
    }>): ResumeWorkflowRunResponse {
    ...
    invokeStartCrawler(partialParams: ToOptional<{
      [K in keyof StartCrawlerRequest]: (StartCrawlerRequest)[K]
    }>): StartCrawlerResponse {
    ...
    invokeStartTrigger(partialParams: ToOptional<{
      [K in keyof StartTriggerRequest]: (StartTriggerRequest)[K]
    }>): StartTriggerResponse {
    ...
    invokeStartWorkflowRun(partialParams: ToOptional<{
      [K in keyof StartWorkflowRunRequest]: (StartWorkflowRunRequest)[K]
    }>): StartWorkflowRunResponse {
    ...
    invokeStopCrawler(partialParams: ToOptional<{
      [K in keyof StopCrawlerRequest]: (StopCrawlerRequest)[K]
    }>): StopCrawlerResponse {
    ...
    invokeStopTrigger(partialParams: ToOptional<{
      [K in keyof StopTriggerRequest]: (StopTriggerRequest)[K]
    }>): StopTriggerResponse {
    ...
    invokeStopWorkflowRun(partialParams: ToOptional<{
      [K in keyof StopWorkflowRunRequest]: (StopWorkflowRunRequest)[K]
    }>): StopWorkflowRunResponse {
    ...
    invokeUpdateBlueprint(partialParams: ToOptional<{
      [K in keyof UpdateBlueprintRequest]: (UpdateBlueprintRequest)[K]
    }>): UpdateBlueprintResponse {
    ...
    invokeUpdateCrawler(partialParams: ToOptional<{
      [K in keyof UpdateCrawlerRequest]: (UpdateCrawlerRequest)[K]
    }>): UpdateCrawlerResponse {
    ...
    invokeUpdateDatabase(partialParams: ToOptional<{
      [K in keyof UpdateDatabaseRequest]: (UpdateDatabaseRequest)[K]
    }>): UpdateDatabaseResponse {
    ...
    invokeUpdateTrigger(partialParams: ToOptional<{
      [K in keyof UpdateTriggerRequest]: (UpdateTriggerRequest)[K]
    }>): UpdateTriggerResponse {
    ...
    invokeUpdateWorkflow(partialParams: ToOptional<{
      [K in keyof UpdateWorkflowRequest]: (UpdateWorkflowRequest)[K]
    }>): UpdateWorkflowResponse {
