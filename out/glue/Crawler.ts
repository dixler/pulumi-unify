...
export default class extends aws.glue.Crawler {
    ...
    invokeCreateCrawler(partialParams: ToOptional<{
      [K in keyof CreateCrawlerRequest & keyof Omit<CreateCrawlerRequest, "Name" | "Role">]: (CreateCrawlerRequest)[K]
    ...
    invokeCreateJob(partialParams: ToOptional<{
      [K in keyof CreateJobRequest & keyof Omit<CreateJobRequest, "Name" | "Role">]: (CreateJobRequest)[K]
    ...
    invokeCreateMLTransform(partialParams: ToOptional<{
      [K in keyof CreateMLTransformRequest & keyof Omit<CreateMLTransformRequest, "Name" | "Role">]: (CreateMLTransformRequest)[K]
    ...
    invokeGetUnfilteredPartitionMetadata(partialParams: ToOptional<{
      [K in keyof GetUnfilteredPartitionMetadataRequest & keyof Omit<GetUnfilteredPartitionMetadataRequest, "DatabaseName">]: (GetUnfilteredPartitionMetadataRequest)[K]
    ...
    invokeGetUnfilteredPartitionsMetadata(partialParams: ToOptional<{
      [K in keyof GetUnfilteredPartitionsMetadataRequest & keyof Omit<GetUnfilteredPartitionsMetadataRequest, "DatabaseName">]: (GetUnfilteredPartitionsMetadataRequest)[K]
    ...
    invokeGetUnfilteredTableMetadata(partialParams: ToOptional<{
      [K in keyof GetUnfilteredTableMetadataRequest & keyof Omit<GetUnfilteredTableMetadataRequest, "DatabaseName" | "Name">]: (GetUnfilteredTableMetadataRequest)[K]
    ...
    invokeStartCrawlerSchedule(partialParams: ToOptional<{
      [K in keyof StartCrawlerScheduleRequest & keyof Omit<StartCrawlerScheduleRequest, "CrawlerName">]: (StartCrawlerScheduleRequest)[K]
    ...
    invokeStopCrawlerSchedule(partialParams: ToOptional<{
      [K in keyof StopCrawlerScheduleRequest & keyof Omit<StopCrawlerScheduleRequest, "CrawlerName">]: (StopCrawlerScheduleRequest)[K]
    ...
    invokeUpdateCrawlerSchedule(partialParams: ToOptional<{
      [K in keyof UpdateCrawlerScheduleRequest & keyof Omit<UpdateCrawlerScheduleRequest, "CrawlerName">]: (UpdateCrawlerScheduleRequest)[K]
