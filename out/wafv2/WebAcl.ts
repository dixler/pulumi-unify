...
export default class extends aws.wafv2.WebAcl {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.wafv2.WebAcl>) {
        super(...args)
        this.booted = false;
    ...
    invokeGetSampledRequests(partialParams: ToOptional<{
      [K in keyof GetSampledRequestsRequest & keyof Omit<GetSampledRequestsRequest, "WebAclArn" | "Scope">]: (GetSampledRequestsRequest)[K]
