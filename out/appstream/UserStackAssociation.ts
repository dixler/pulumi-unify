...
export default class extends aws.appstream.UserStackAssociation {
    ...
    invokeAssociateApplicationFleet(partialParams: ToOptional<{
      [K in keyof AssociateApplicationFleetRequest & keyof AssociateApplicationFleetRequest & keyof AssociateApplicationFleetRequest]: (AssociateApplicationFleetRequest & AssociateApplicationFleetRequest & AssociateApplicationFleetRequest)[K]
    }>): AssociateApplicationFleetResult {
    ...
    invokeAssociateApplicationToEntitlement(partialParams: ToOptional<{
      [K in keyof AssociateApplicationToEntitlementRequest & keyof AssociateApplicationToEntitlementRequest & keyof AssociateApplicationToEntitlementRequest]: (AssociateApplicationToEntitlementRequest & AssociateApplicationToEntitlementRequest & AssociateApplicationToEntitlementRequest)[K]
    }>): AssociateApplicationToEntitlementResult {
    ...
    invokeAssociateFleet(partialParams: ToOptional<{
      [K in keyof AssociateFleetRequest & keyof AssociateFleetRequest & keyof AssociateFleetRequest]: (AssociateFleetRequest & AssociateFleetRequest & AssociateFleetRequest)[K]
    }>): AssociateFleetResult {
    ...
    invokeBatchAssociateUserStack(partialParams: ToOptional<{
      [K in keyof BatchAssociateUserStackRequest & keyof BatchAssociateUserStackRequest & keyof BatchAssociateUserStackRequest]: (BatchAssociateUserStackRequest & BatchAssociateUserStackRequest & BatchAssociateUserStackRequest)[K]
    }>): BatchAssociateUserStackResult {
    ...
    invokeBatchDisassociateUserStack(partialParams: ToOptional<{
      [K in keyof BatchDisassociateUserStackRequest & keyof BatchDisassociateUserStackRequest & keyof BatchDisassociateUserStackRequest]: (BatchDisassociateUserStackRequest & BatchDisassociateUserStackRequest & BatchDisassociateUserStackRequest)[K]
    }>): BatchDisassociateUserStackResult {
    ...
    invokeCreateAppBlock(partialParams: ToOptional<{
      [K in keyof CreateAppBlockRequest & keyof CreateAppBlockRequest & keyof CreateAppBlockRequest]: (CreateAppBlockRequest & CreateAppBlockRequest & CreateAppBlockRequest)[K]
    }>): CreateAppBlockResult {
    ...
    invokeCreateDirectoryConfig(partialParams: ToOptional<{
      [K in keyof CreateDirectoryConfigRequest & keyof CreateDirectoryConfigRequest & keyof CreateDirectoryConfigRequest]: (CreateDirectoryConfigRequest & CreateDirectoryConfigRequest & CreateDirectoryConfigRequest)[K]
    }>): CreateDirectoryConfigResult {
    ...
    invokeCreateEntitlement(partialParams: ToOptional<{
      [K in keyof CreateEntitlementRequest & keyof CreateEntitlementRequest & keyof CreateEntitlementRequest]: (CreateEntitlementRequest & CreateEntitlementRequest & CreateEntitlementRequest)[K]
    }>): CreateEntitlementResult {
    ...
    invokeCreateImageBuilder(partialParams: ToOptional<{
      [K in keyof CreateImageBuilderRequest & keyof CreateImageBuilderRequest & keyof CreateImageBuilderRequest]: (CreateImageBuilderRequest & CreateImageBuilderRequest & CreateImageBuilderRequest)[K]
    }>): CreateImageBuilderResult {
    ...
    invokeCreateImageBuilderStreamingURL(partialParams: ToOptional<{
      [K in keyof CreateImageBuilderStreamingURLRequest & keyof CreateImageBuilderStreamingURLRequest & keyof CreateImageBuilderStreamingURLRequest]: (CreateImageBuilderStreamingURLRequest & CreateImageBuilderStreamingURLRequest & CreateImageBuilderStreamingURLRequest)[K]
    }>): CreateImageBuilderStreamingURLResult {
    ...
    invokeCreateStreamingURL(partialParams: ToOptional<{
      [K in keyof CreateStreamingURLRequest & keyof CreateStreamingURLRequest & keyof CreateStreamingURLRequest]: (CreateStreamingURLRequest & CreateStreamingURLRequest & CreateStreamingURLRequest)[K]
    }>): CreateStreamingURLResult {
    ...
    invokeCreateUpdatedImage(partialParams: ToOptional<{
      [K in keyof CreateUpdatedImageRequest & keyof CreateUpdatedImageRequest & keyof CreateUpdatedImageRequest]: (CreateUpdatedImageRequest & CreateUpdatedImageRequest & CreateUpdatedImageRequest)[K]
    }>): CreateUpdatedImageResult {
    ...
    invokeCreateUser(partialParams: ToOptional<{
      [K in keyof Omit<CreateUserRequest, "AuthenticationType"> & keyof CreateUserRequest & keyof CreateUserRequest]: (Omit<CreateUserRequest, "AuthenticationType"> & CreateUserRequest & CreateUserRequest)[K]
    }>): CreateUserResult {
    ...
    invokeDeleteAppBlock(partialParams: ToOptional<{
      [K in keyof DeleteAppBlockRequest & keyof DeleteAppBlockRequest & keyof DeleteAppBlockRequest]: (DeleteAppBlockRequest & DeleteAppBlockRequest & DeleteAppBlockRequest)[K]
    }>): DeleteAppBlockResult {
    ...
    invokeDeleteDirectoryConfig(partialParams: ToOptional<{
      [K in keyof DeleteDirectoryConfigRequest & keyof DeleteDirectoryConfigRequest & keyof DeleteDirectoryConfigRequest]: (DeleteDirectoryConfigRequest & DeleteDirectoryConfigRequest & DeleteDirectoryConfigRequest)[K]
    }>): DeleteDirectoryConfigResult {
    ...
    invokeDeleteEntitlement(partialParams: ToOptional<{
      [K in keyof DeleteEntitlementRequest & keyof DeleteEntitlementRequest & keyof DeleteEntitlementRequest]: (DeleteEntitlementRequest & DeleteEntitlementRequest & DeleteEntitlementRequest)[K]
    }>): DeleteEntitlementResult {
    ...
    invokeDeleteFleet(partialParams: ToOptional<{
      [K in keyof DeleteFleetRequest & keyof DeleteFleetRequest & keyof DeleteFleetRequest]: (DeleteFleetRequest & DeleteFleetRequest & DeleteFleetRequest)[K]
    }>): DeleteFleetResult {
    ...
    invokeDeleteImageBuilder(partialParams: ToOptional<{
      [K in keyof DeleteImageBuilderRequest & keyof DeleteImageBuilderRequest & keyof DeleteImageBuilderRequest]: (DeleteImageBuilderRequest & DeleteImageBuilderRequest & DeleteImageBuilderRequest)[K]
    }>): DeleteImageBuilderResult {
    ...
    invokeDeleteImagePermissions(partialParams: ToOptional<{
      [K in keyof DeleteImagePermissionsRequest & keyof DeleteImagePermissionsRequest & keyof DeleteImagePermissionsRequest]: (DeleteImagePermissionsRequest & DeleteImagePermissionsRequest & DeleteImagePermissionsRequest)[K]
    }>): DeleteImagePermissionsResult {
    ...
    invokeDeleteUser(partialParams: ToOptional<{
      [K in keyof Omit<DeleteUserRequest, "AuthenticationType"> & keyof DeleteUserRequest & keyof DeleteUserRequest]: (Omit<DeleteUserRequest, "AuthenticationType"> & DeleteUserRequest & DeleteUserRequest)[K]
    }>): DeleteUserResult {
    ...
    invokeDescribeEntitlements(partialParams: ToOptional<{
      [K in keyof DescribeEntitlementsRequest & keyof DescribeEntitlementsRequest & keyof DescribeEntitlementsRequest]: (DescribeEntitlementsRequest & DescribeEntitlementsRequest & DescribeEntitlementsRequest)[K]
    }>): DescribeEntitlementsResult {
    ...
    invokeDescribeImagePermissions(partialParams: ToOptional<{
      [K in keyof DescribeImagePermissionsRequest & keyof DescribeImagePermissionsRequest & keyof DescribeImagePermissionsRequest]: (DescribeImagePermissionsRequest & DescribeImagePermissionsRequest & DescribeImagePermissionsRequest)[K]
    }>): DescribeImagePermissionsResult {
    ...
    invokeDescribeSessions(partialParams: ToOptional<{
      [K in keyof DescribeSessionsRequest & keyof DescribeSessionsRequest & keyof DescribeSessionsRequest]: (DescribeSessionsRequest & DescribeSessionsRequest & DescribeSessionsRequest)[K]
    }>): DescribeSessionsResult {
    ...
    invokeDescribeUsers(partialParams: ToOptional<{
      [K in keyof Omit<DescribeUsersRequest, "AuthenticationType"> & keyof DescribeUsersRequest & keyof DescribeUsersRequest]: (Omit<DescribeUsersRequest, "AuthenticationType"> & DescribeUsersRequest & DescribeUsersRequest)[K]
    }>): DescribeUsersResult {
    ...
    invokeDisableUser(partialParams: ToOptional<{
      [K in keyof Omit<DisableUserRequest, "AuthenticationType"> & keyof DisableUserRequest & keyof DisableUserRequest]: (Omit<DisableUserRequest, "AuthenticationType"> & DisableUserRequest & DisableUserRequest)[K]
    }>): DisableUserResult {
    ...
    invokeDisassociateApplicationFleet(partialParams: ToOptional<{
      [K in keyof DisassociateApplicationFleetRequest & keyof DisassociateApplicationFleetRequest & keyof DisassociateApplicationFleetRequest]: (DisassociateApplicationFleetRequest & DisassociateApplicationFleetRequest & DisassociateApplicationFleetRequest)[K]
    }>): DisassociateApplicationFleetResult {
    ...
    invokeDisassociateApplicationFromEntitlement(partialParams: ToOptional<{
      [K in keyof DisassociateApplicationFromEntitlementRequest & keyof DisassociateApplicationFromEntitlementRequest & keyof DisassociateApplicationFromEntitlementRequest]: (DisassociateApplicationFromEntitlementRequest & DisassociateApplicationFromEntitlementRequest & DisassociateApplicationFromEntitlementRequest)[K]
    }>): DisassociateApplicationFromEntitlementResult {
    ...
    invokeDisassociateFleet(partialParams: ToOptional<{
      [K in keyof DisassociateFleetRequest & keyof DisassociateFleetRequest & keyof DisassociateFleetRequest]: (DisassociateFleetRequest & DisassociateFleetRequest & DisassociateFleetRequest)[K]
    }>): DisassociateFleetResult {
    ...
    invokeEnableUser(partialParams: ToOptional<{
      [K in keyof Omit<EnableUserRequest, "AuthenticationType"> & keyof EnableUserRequest & keyof EnableUserRequest]: (Omit<EnableUserRequest, "AuthenticationType"> & EnableUserRequest & EnableUserRequest)[K]
    }>): EnableUserResult {
    ...
    invokeExpireSession(partialParams: ToOptional<{
      [K in keyof ExpireSessionRequest & keyof ExpireSessionRequest & keyof ExpireSessionRequest]: (ExpireSessionRequest & ExpireSessionRequest & ExpireSessionRequest)[K]
    }>): ExpireSessionResult {
    ...
    invokeListAssociatedFleets(partialParams: ToOptional<{
      [K in keyof ListAssociatedFleetsRequest & keyof ListAssociatedFleetsRequest & keyof ListAssociatedFleetsRequest]: (ListAssociatedFleetsRequest & ListAssociatedFleetsRequest & ListAssociatedFleetsRequest)[K]
    }>): ListAssociatedFleetsResult {
    ...
    invokeListAssociatedStacks(partialParams: ToOptional<{
      [K in keyof ListAssociatedStacksRequest & keyof ListAssociatedStacksRequest & keyof ListAssociatedStacksRequest]: (ListAssociatedStacksRequest & ListAssociatedStacksRequest & ListAssociatedStacksRequest)[K]
    }>): ListAssociatedStacksResult {
    ...
    invokeListEntitledApplications(partialParams: ToOptional<{
      [K in keyof ListEntitledApplicationsRequest & keyof ListEntitledApplicationsRequest & keyof ListEntitledApplicationsRequest]: (ListEntitledApplicationsRequest & ListEntitledApplicationsRequest & ListEntitledApplicationsRequest)[K]
    }>): ListEntitledApplicationsResult {
    ...
    invokeStartFleet(partialParams: ToOptional<{
      [K in keyof StartFleetRequest & keyof StartFleetRequest & keyof StartFleetRequest]: (StartFleetRequest & StartFleetRequest & StartFleetRequest)[K]
    }>): StartFleetResult {
    ...
    invokeStartImageBuilder(partialParams: ToOptional<{
      [K in keyof StartImageBuilderRequest & keyof StartImageBuilderRequest & keyof StartImageBuilderRequest]: (StartImageBuilderRequest & StartImageBuilderRequest & StartImageBuilderRequest)[K]
    }>): StartImageBuilderResult {
    ...
    invokeStopFleet(partialParams: ToOptional<{
      [K in keyof StopFleetRequest & keyof StopFleetRequest & keyof StopFleetRequest]: (StopFleetRequest & StopFleetRequest & StopFleetRequest)[K]
    }>): StopFleetResult {
    ...
    invokeStopImageBuilder(partialParams: ToOptional<{
      [K in keyof StopImageBuilderRequest & keyof StopImageBuilderRequest & keyof StopImageBuilderRequest]: (StopImageBuilderRequest & StopImageBuilderRequest & StopImageBuilderRequest)[K]
    }>): StopImageBuilderResult {
    ...
    invokeUpdateDirectoryConfig(partialParams: ToOptional<{
      [K in keyof UpdateDirectoryConfigRequest & keyof UpdateDirectoryConfigRequest & keyof UpdateDirectoryConfigRequest]: (UpdateDirectoryConfigRequest & UpdateDirectoryConfigRequest & UpdateDirectoryConfigRequest)[K]
    }>): UpdateDirectoryConfigResult {
    ...
    invokeUpdateEntitlement(partialParams: ToOptional<{
      [K in keyof UpdateEntitlementRequest & keyof Omit<UpdateEntitlementRequest, "StackName"> & keyof UpdateEntitlementRequest]: (UpdateEntitlementRequest & Omit<UpdateEntitlementRequest, "StackName"> & UpdateEntitlementRequest)[K]
    }>): UpdateEntitlementResult {
    ...
    invokeUpdateImagePermissions(partialParams: ToOptional<{
      [K in keyof UpdateImagePermissionsRequest & keyof UpdateImagePermissionsRequest & keyof UpdateImagePermissionsRequest]: (UpdateImagePermissionsRequest & UpdateImagePermissionsRequest & UpdateImagePermissionsRequest)[K]
    }>): UpdateImagePermissionsResult {
