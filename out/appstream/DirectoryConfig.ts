...
export default class extends aws.appstream.DirectoryConfig {
    ...
    invokeCreateAppBlock(partialParams: ToOptional<{
      [K in keyof CreateAppBlockRequest]: (CreateAppBlockRequest)[K]
    ...
    invokeCreateEntitlement(partialParams: ToOptional<{
      [K in keyof CreateEntitlementRequest]: (CreateEntitlementRequest)[K]
    ...
    invokeCreateImageBuilder(partialParams: ToOptional<{
      [K in keyof CreateImageBuilderRequest]: (CreateImageBuilderRequest)[K]
    ...
    invokeCreateImageBuilderStreamingURL(partialParams: ToOptional<{
      [K in keyof CreateImageBuilderStreamingURLRequest]: (CreateImageBuilderStreamingURLRequest)[K]
    ...
    invokeCreateStack(partialParams: ToOptional<{
      [K in keyof CreateStackRequest]: (CreateStackRequest)[K]
    ...
    invokeDeleteAppBlock(partialParams: ToOptional<{
      [K in keyof DeleteAppBlockRequest]: (DeleteAppBlockRequest)[K]
    ...
    invokeDeleteApplication(partialParams: ToOptional<{
      [K in keyof DeleteApplicationRequest]: (DeleteApplicationRequest)[K]
    ...
    invokeDeleteEntitlement(partialParams: ToOptional<{
      [K in keyof DeleteEntitlementRequest]: (DeleteEntitlementRequest)[K]
    ...
    invokeDeleteFleet(partialParams: ToOptional<{
      [K in keyof DeleteFleetRequest]: (DeleteFleetRequest)[K]
    ...
    invokeDeleteImageBuilder(partialParams: ToOptional<{
      [K in keyof DeleteImageBuilderRequest]: (DeleteImageBuilderRequest)[K]
    ...
    invokeDeleteImagePermissions(partialParams: ToOptional<{
      [K in keyof DeleteImagePermissionsRequest]: (DeleteImagePermissionsRequest)[K]
    ...
    invokeDeleteStack(partialParams: ToOptional<{
      [K in keyof DeleteStackRequest]: (DeleteStackRequest)[K]
    ...
    invokeDescribeImagePermissions(partialParams: ToOptional<{
      [K in keyof DescribeImagePermissionsRequest]: (DescribeImagePermissionsRequest)[K]
    ...
    invokeStartFleet(partialParams: ToOptional<{
      [K in keyof StartFleetRequest]: (StartFleetRequest)[K]
    ...
    invokeStartImageBuilder(partialParams: ToOptional<{
      [K in keyof StartImageBuilderRequest]: (StartImageBuilderRequest)[K]
    ...
    invokeStopFleet(partialParams: ToOptional<{
      [K in keyof StopFleetRequest]: (StopFleetRequest)[K]
    ...
    invokeStopImageBuilder(partialParams: ToOptional<{
      [K in keyof StopImageBuilderRequest]: (StopImageBuilderRequest)[K]
    ...
    invokeUpdateEntitlement(partialParams: ToOptional<{
      [K in keyof UpdateEntitlementRequest]: (UpdateEntitlementRequest)[K]
    ...
    invokeUpdateImagePermissions(partialParams: ToOptional<{
      [K in keyof UpdateImagePermissionsRequest]: (UpdateImagePermissionsRequest)[K]
    ...
    invokeUpdateStack(partialParams: ToOptional<{
      [K in keyof UpdateStackRequest]: (UpdateStackRequest)[K]
