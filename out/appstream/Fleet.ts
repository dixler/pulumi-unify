...
export default class extends aws.appstream.Fleet {
    ...
    invokeAssociateFleet(partialParams: ToOptional<{
      [K in keyof AssociateFleetRequest & keyof Omit<AssociateFleetRequest, "FleetName">]: (AssociateFleetRequest)[K]
    ...
    invokeCreateStreamingURL(partialParams: ToOptional<{
      [K in keyof CreateStreamingURLRequest & keyof Omit<CreateStreamingURLRequest, "FleetName">]: (CreateStreamingURLRequest)[K]
    ...
    invokeDescribeSessions(partialParams: ToOptional<{
      [K in keyof DescribeSessionsRequest & keyof Omit<DescribeSessionsRequest, "FleetName">]: (DescribeSessionsRequest)[K]
    ...
    invokeDisassociateFleet(partialParams: ToOptional<{
      [K in keyof DisassociateFleetRequest & keyof Omit<DisassociateFleetRequest, "FleetName">]: (DisassociateFleetRequest)[K]
