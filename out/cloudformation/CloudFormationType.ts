...
export default class extends aws.cloudformation.CloudFormationType {
    ...
    invokeCreateStackInstances(partialParams: ToOptional<{
      [K in keyof CreateStackInstancesInput]: (CreateStackInstancesInput)[K]
    ...
    invokeCreateStackSet(partialParams: ToOptional<{
      [K in keyof CreateStackSetInput]: (CreateStackSetInput)[K]
    ...
    invokeDeleteStackInstances(partialParams: ToOptional<{
      [K in keyof DeleteStackInstancesInput]: (DeleteStackInstancesInput)[K]
    ...
    invokeDeleteStackSet(partialParams: ToOptional<{
      [K in keyof DeleteStackSetInput]: (DeleteStackSetInput)[K]
    ...
    invokeDescribeStackInstance(partialParams: ToOptional<{
      [K in keyof DescribeStackInstanceInput]: (DescribeStackInstanceInput)[K]
    ...
    invokeDescribeStackSet(partialParams: ToOptional<{
      [K in keyof DescribeStackSetInput]: (DescribeStackSetInput)[K]
    ...
    invokeDescribeStackSetOperation(partialParams: ToOptional<{
      [K in keyof DescribeStackSetOperationInput]: (DescribeStackSetOperationInput)[K]
    ...
    invokeDetectStackSetDrift(partialParams: ToOptional<{
      [K in keyof DetectStackSetDriftInput]: (DetectStackSetDriftInput)[K]
    ...
    invokeImportStacksToStackSet(partialParams: ToOptional<{
      [K in keyof ImportStacksToStackSetInput]: (ImportStacksToStackSetInput)[K]
    ...
    invokeListStackInstances(partialParams: ToOptional<{
      [K in keyof ListStackInstancesInput]: (ListStackInstancesInput)[K]
    ...
    invokeListStackSetOperationResults(partialParams: ToOptional<{
      [K in keyof ListStackSetOperationResultsInput]: (ListStackSetOperationResultsInput)[K]
    ...
    invokeListStackSetOperations(partialParams: ToOptional<{
      [K in keyof ListStackSetOperationsInput]: (ListStackSetOperationsInput)[K]
    ...
    invokeRegisterType(partialParams: ToOptional<{
      [K in keyof RegisterTypeInput & keyof Omit<RegisterTypeInput, "TypeName" | "SchemaHandlerPackage">]: (RegisterTypeInput)[K]
    ...
    invokeStopStackSetOperation(partialParams: ToOptional<{
      [K in keyof StopStackSetOperationInput]: (StopStackSetOperationInput)[K]
    ...
    invokeUpdateStackInstances(partialParams: ToOptional<{
      [K in keyof UpdateStackInstancesInput]: (UpdateStackInstancesInput)[K]
    ...
    invokeUpdateStackSet(partialParams: ToOptional<{
      [K in keyof UpdateStackSetInput]: (UpdateStackSetInput)[K]
