...
export default class extends aws.cloudfront.Function {
    ...
    invokeCreateFunction2020_05_31(partialParams: ToOptional<{
      [K in keyof CreateFunctionRequest & keyof Omit<CreateFunctionRequest, "Name" | "FunctionCode">]: (CreateFunctionRequest)[K]
    ...
    invokeUpdateFunction2020_05_31(partialParams: ToOptional<{
      [K in keyof UpdateFunctionRequest & keyof Omit<UpdateFunctionRequest, "FunctionCode" | "Name">]: (UpdateFunctionRequest)[K]
