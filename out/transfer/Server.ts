...
export default class extends aws.transfer.Server {
    ...
    invokeCreateAccess(partialParams: ToOptional<{
      [K in keyof CreateAccessRequest]: (CreateAccessRequest)[K]
    ...
    invokeDescribeAccess(partialParams: ToOptional<{
      [K in keyof DescribeAccessRequest]: (DescribeAccessRequest)[K]
    ...
    invokeDescribeSecurityPolicy(partialParams: ToOptional<{
      [K in keyof DescribeSecurityPolicyRequest & keyof Omit<DescribeSecurityPolicyRequest, "SecurityPolicyName">]: (DescribeSecurityPolicyRequest)[K]
    ...
    invokeDescribeServer(partialParams: ToOptional<{
      [K in keyof DescribeServerRequest]: (DescribeServerRequest)[K]
    ...
    invokeImportSshPublicKey(partialParams: ToOptional<{
      [K in keyof ImportSshPublicKeyRequest]: (ImportSshPublicKeyRequest)[K]
    ...
    invokeListAccesses(partialParams: ToOptional<{
      [K in keyof ListAccessesRequest]: (ListAccessesRequest)[K]
    ...
    invokeTestIdentityProvider(partialParams: ToOptional<{
      [K in keyof TestIdentityProviderRequest]: (TestIdentityProviderRequest)[K]
    ...
    invokeUpdateAccess(partialParams: ToOptional<{
      [K in keyof UpdateAccessRequest]: (UpdateAccessRequest)[K]
    ...
    invokeUpdateServer(partialParams: ToOptional<{
      [K in keyof UpdateServerRequest]: (UpdateServerRequest)[K]
