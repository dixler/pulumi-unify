...
export default class extends aws.transfer.User {
    ...
    invokeCreateAccess(partialParams: ToOptional<{
      [K in keyof CreateAccessRequest & keyof Omit<CreateAccessRequest, "Role" | "ServerId">]: (CreateAccessRequest)[K]
    ...
    invokeCreateUser(partialParams: ToOptional<{
      [K in keyof CreateUserRequest & keyof Omit<CreateUserRequest, "Role" | "ServerId" | "UserName">]: (CreateUserRequest)[K]
