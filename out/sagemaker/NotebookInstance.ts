...
export default class extends aws.sagemaker.NotebookInstance {
    ...
    invokeCreateNotebookInstance(partialParams: ToOptional<{
      [K in keyof CreateNotebookInstanceInput & keyof Omit<CreateNotebookInstanceInput, "NotebookInstanceName" | "InstanceType" | "RoleArn">]: (CreateNotebookInstanceInput)[K]
    ...
    invokeCreateNotebookInstanceLifecycleConfig(partialParams: ToOptional<{
      [K in keyof CreateNotebookInstanceLifecycleConfigInput & keyof Omit<CreateNotebookInstanceLifecycleConfigInput, "NotebookInstanceLifecycleConfigName">]: (CreateNotebookInstanceLifecycleConfigInput)[K]
    ...
    invokeCreatePresignedNotebookInstanceUrl(partialParams: ToOptional<{
      [K in keyof CreatePresignedNotebookInstanceUrlInput & keyof Omit<CreatePresignedNotebookInstanceUrlInput, "NotebookInstanceName">]: (CreatePresignedNotebookInstanceUrlInput)[K]
    ...
    invokeDescribeNotebookInstance(partialParams: ToOptional<{
      [K in keyof DescribeNotebookInstanceInput & keyof Omit<DescribeNotebookInstanceInput, "NotebookInstanceName">]: (DescribeNotebookInstanceInput)[K]
    ...
    invokeDescribeNotebookInstanceLifecycleConfig(partialParams: ToOptional<{
      [K in keyof DescribeNotebookInstanceLifecycleConfigInput & keyof Omit<DescribeNotebookInstanceLifecycleConfigInput, "NotebookInstanceLifecycleConfigName">]: (DescribeNotebookInstanceLifecycleConfigInput)[K]
    ...
    invokeUpdateNotebookInstance(partialParams: ToOptional<{
      [K in keyof UpdateNotebookInstanceInput & keyof Omit<UpdateNotebookInstanceInput, "NotebookInstanceName">]: (UpdateNotebookInstanceInput)[K]
    ...
    invokeUpdateNotebookInstanceLifecycleConfig(partialParams: ToOptional<{
      [K in keyof UpdateNotebookInstanceLifecycleConfigInput & keyof Omit<UpdateNotebookInstanceLifecycleConfigInput, "NotebookInstanceLifecycleConfigName">]: (UpdateNotebookInstanceLifecycleConfigInput)[K]
