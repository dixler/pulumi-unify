...
export default class extends aws.sagemaker.CodeRepository {
    ...
    invokeUpdateCodeRepository(partialParams: ToOptional<{
      [K in keyof UpdateCodeRepositoryInput & keyof Omit<UpdateCodeRepositoryInput, "CodeRepositoryName">]: (UpdateCodeRepositoryInput & Omit<UpdateCodeRepositoryInput, "CodeRepositoryName">)[K]
    }>): UpdateCodeRepositoryOutput {
