...
export default class extends aws.sagemaker.Model {
    ...
    invokeCreateModel(partialParams: ToOptional<{
      [K in keyof CreateModelInput & keyof Omit<CreateModelInput, "ModelName" | "ExecutionRoleArn">]: (CreateModelInput)[K]
    ...
    invokeCreateTransformJob(partialParams: ToOptional<{
      [K in keyof CreateTransformJobRequest & keyof Omit<CreateTransformJobRequest, "ModelName">]: (CreateTransformJobRequest)[K]
    ...
    invokeDescribeModel(partialParams: ToOptional<{
      [K in keyof DescribeModelInput & keyof Omit<DescribeModelInput, "ModelName">]: (DescribeModelInput)[K]
