...
export default class extends aws.sagemaker.StudioLifecycleConfig {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.sagemaker.StudioLifecycleConfig>) {
        super(...args)
        this.booted = false;
    ...
    invokeCreateStudioLifecycleConfig(partialParams: ToOptional<{
      [K in keyof CreateStudioLifecycleConfigRequest & keyof Omit<CreateStudioLifecycleConfigRequest, "StudioLifecycleConfigName" | "StudioLifecycleConfigContent" | "StudioLifecycleConfigAppType">]: (CreateStudioLifecycleConfigRequest)[K]
    ...
    invokeDescribeStudioLifecycleConfig(partialParams: ToOptional<{
      [K in keyof DescribeStudioLifecycleConfigRequest & keyof Omit<DescribeStudioLifecycleConfigRequest, "StudioLifecycleConfigName">]: (DescribeStudioLifecycleConfigRequest)[K]
