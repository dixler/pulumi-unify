...
export default class extends aws.sagemaker.FlowDefinition {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.sagemaker.FlowDefinition>) {
        super(...args)
        this.booted = false;
    ...
    invokeCreateFlowDefinition(partialParams: ToOptional<{
      [K in keyof CreateFlowDefinitionRequest & keyof Omit<CreateFlowDefinitionRequest, "FlowDefinitionName" | "RoleArn">]: (CreateFlowDefinitionRequest)[K]
    ...
    invokeDeleteFlowDefinition(partialParams: ToOptional<{
      [K in keyof DeleteFlowDefinitionRequest & keyof Omit<DeleteFlowDefinitionRequest, "FlowDefinitionName">]: (DeleteFlowDefinitionRequest)[K]
    ...
    invokeDescribeFlowDefinition(partialParams: ToOptional<{
      [K in keyof DescribeFlowDefinitionRequest & keyof Omit<DescribeFlowDefinitionRequest, "FlowDefinitionName">]: (DescribeFlowDefinitionRequest)[K]
