...
export default class extends aws.sagemaker.Project {
    ...
    invokeUpdateProject(partialParams: ToOptional<{
      [K in keyof UpdateProjectInput & keyof UpdateProjectInput & keyof UpdateProjectInput & keyof Omit<UpdateProjectInput, "ProjectName">]: (UpdateProjectInput & UpdateProjectInput & UpdateProjectInput & Omit<UpdateProjectInput, "ProjectName">)[K]
