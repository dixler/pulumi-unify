...
export default class extends aws.sagemaker.Endpoint {
    ...
    invokeUpdateEndpoint(partialParams: ToOptional<{
      [K in keyof UpdateEndpointInput & keyof Omit<UpdateEndpointInput, "EndpointConfigName"> & keyof UpdateEndpointInput]: (UpdateEndpointInput & Omit<UpdateEndpointInput, "EndpointConfigName"> & UpdateEndpointInput)[K]
    }>): UpdateEndpointOutput {
