...
export default class extends aws.sagemaker.ModelPackageGroup {
    ...
    invokeDeleteModelPackageGroup(partialParams: ToOptional<{
      [K in keyof DeleteModelPackageGroupInput & keyof DeleteModelPackageGroupInput & keyof Omit<DeleteModelPackageGroupInput, "ModelPackageGroupName">]: (DeleteModelPackageGroupInput & DeleteModelPackageGroupInput & Omit<DeleteModelPackageGroupInput, "ModelPackageGroupName">)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeDescribeModelPackageGroup(partialParams: ToOptional<{
      [K in keyof DescribeModelPackageGroupInput & keyof DescribeModelPackageGroupInput & keyof Omit<DescribeModelPackageGroupInput, "ModelPackageGroupName">]: (DescribeModelPackageGroupInput & DescribeModelPackageGroupInput & Omit<DescribeModelPackageGroupInput, "ModelPackageGroupName">)[K]
    ...
    invokeGetModelPackageGroupPolicy(partialParams: ToOptional<{
      [K in keyof GetModelPackageGroupPolicyInput & keyof GetModelPackageGroupPolicyInput & keyof Omit<GetModelPackageGroupPolicyInput, "ModelPackageGroupName">]: (GetModelPackageGroupPolicyInput & GetModelPackageGroupPolicyInput & Omit<GetModelPackageGroupPolicyInput, "ModelPackageGroupName">)[K]
    ...
    invokePutModelPackageGroupPolicy(partialParams: ToOptional<{
      [K in keyof PutModelPackageGroupPolicyInput & keyof PutModelPackageGroupPolicyInput & keyof Omit<PutModelPackageGroupPolicyInput, "ModelPackageGroupName">]: (PutModelPackageGroupPolicyInput & PutModelPackageGroupPolicyInput & Omit<PutModelPackageGroupPolicyInput, "ModelPackageGroupName">)[K]
