...
export default class extends aws.sagemaker.ModelPackageGroup {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.sagemaker.ModelPackageGroup>) {
        super(...args)
        this.booted = false;
    ...
    invokePutModelPackageGroupPolicy(partialParams: ToOptional<{
      [K in keyof PutModelPackageGroupPolicyInput & keyof Omit<PutModelPackageGroupPolicyInput, "ModelPackageGroupName">]: (PutModelPackageGroupPolicyInput)[K]
