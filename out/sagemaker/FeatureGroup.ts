...
export default class extends aws.sagemaker.FeatureGroup {
    ...
    invokeCreateFeatureGroup(partialParams: ToOptional<{
      [K in keyof CreateFeatureGroupRequest & keyof Omit<CreateFeatureGroupRequest, "FeatureGroupName" | "RecordIdentifierFeatureName" | "EventTimeFeatureName">]: (CreateFeatureGroupRequest)[K]
    ...
    invokeDescribeFeatureGroup(partialParams: ToOptional<{
      [K in keyof DescribeFeatureGroupRequest & keyof Omit<DescribeFeatureGroupRequest, "FeatureGroupName">]: (DescribeFeatureGroupRequest)[K]
