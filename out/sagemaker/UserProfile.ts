...
export default class extends aws.sagemaker.UserProfile {
    ...
    invokeCreateApp(partialParams: ToOptional<{
      [K in keyof CreateAppRequest & keyof Omit<CreateAppRequest, "DomainId" | "UserProfileName">]: (CreateAppRequest)[K]
    ...
    invokeDescribeApp(partialParams: ToOptional<{
      [K in keyof DescribeAppRequest & keyof Omit<DescribeAppRequest, "DomainId" | "UserProfileName">]: (DescribeAppRequest)[K]
