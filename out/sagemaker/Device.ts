...
export default class extends aws.sagemaker.Device {
    ...
    invokeGetDeviceFleetReport(partialParams: ToOptional<{
      [K in keyof GetDeviceFleetReportRequest & keyof GetDeviceFleetReportRequest & keyof Omit<GetDeviceFleetReportRequest, "DeviceFleetName">]: (GetDeviceFleetReportRequest & GetDeviceFleetReportRequest & Omit<GetDeviceFleetReportRequest, "DeviceFleetName">)[K]
    ...
    invokeRegisterDevices(partialParams: ToOptional<{
      [K in keyof RegisterDevicesRequest & keyof RegisterDevicesRequest & keyof Omit<RegisterDevicesRequest, "DeviceFleetName">]: (RegisterDevicesRequest & RegisterDevicesRequest & Omit<RegisterDevicesRequest, "DeviceFleetName">)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateDeviceFleet(partialParams: ToOptional<{
      [K in keyof UpdateDeviceFleetRequest & keyof UpdateDeviceFleetRequest & keyof Omit<UpdateDeviceFleetRequest, "DeviceFleetName">]: (UpdateDeviceFleetRequest & UpdateDeviceFleetRequest & Omit<UpdateDeviceFleetRequest, "DeviceFleetName">)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateDevices(partialParams: ToOptional<{
      [K in keyof UpdateDevicesRequest & keyof UpdateDevicesRequest & keyof Omit<UpdateDevicesRequest, "DeviceFleetName">]: (UpdateDevicesRequest & UpdateDevicesRequest & Omit<UpdateDevicesRequest, "DeviceFleetName">)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
