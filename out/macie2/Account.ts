...
export default class extends aws.macie2.Account {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.macie2.Account>) {
        super(...args)
    ...
    invokeCreateClassificationJob(partialParams: ToOptional<{
      [K in keyof CreateClassificationJobRequest & keyof CreateClassificationJobRequest & keyof CreateClassificationJobRequest & keyof CreateClassificationJobRequest & keyof CreateClassificationJobRequest]: (CreateClassificationJobRequest & CreateClassificationJobRequest & CreateClassificationJobRequest & CreateClassificationJobRequest & CreateClassificationJobRequest)[K]
    ...
    invokeCreateCustomDataIdentifier(partialParams: ToOptional<{
      [K in keyof CreateCustomDataIdentifierRequest & keyof CreateCustomDataIdentifierRequest & keyof CreateCustomDataIdentifierRequest & keyof CreateCustomDataIdentifierRequest & keyof CreateCustomDataIdentifierRequest]: (CreateCustomDataIdentifierRequest & CreateCustomDataIdentifierRequest & CreateCustomDataIdentifierRequest & CreateCustomDataIdentifierRequest & CreateCustomDataIdentifierRequest)[K]
    ...
    invokeCreateFindingsFilter(partialParams: ToOptional<{
      [K in keyof CreateFindingsFilterRequest & keyof CreateFindingsFilterRequest & keyof CreateFindingsFilterRequest & keyof CreateFindingsFilterRequest & keyof CreateFindingsFilterRequest]: (CreateFindingsFilterRequest & CreateFindingsFilterRequest & CreateFindingsFilterRequest & CreateFindingsFilterRequest & CreateFindingsFilterRequest)[K]
    ...
    invokeCreateInvitations(partialParams: ToOptional<{
      [K in keyof CreateInvitationsRequest & keyof CreateInvitationsRequest & keyof CreateInvitationsRequest & keyof CreateInvitationsRequest & keyof CreateInvitationsRequest]: (CreateInvitationsRequest & CreateInvitationsRequest & CreateInvitationsRequest & CreateInvitationsRequest & CreateInvitationsRequest)[K]
    ...
    invokeCreateMember(partialParams: ToOptional<{
      [K in keyof CreateMemberRequest & keyof CreateMemberRequest & keyof CreateMemberRequest & keyof CreateMemberRequest & keyof CreateMemberRequest]: (CreateMemberRequest & CreateMemberRequest & CreateMemberRequest & CreateMemberRequest & CreateMemberRequest)[K]
    ...
    invokeDeleteCustomDataIdentifier(partialParams: ToOptional<{
      [K in keyof DeleteCustomDataIdentifierRequest & keyof DeleteCustomDataIdentifierRequest & keyof DeleteCustomDataIdentifierRequest & keyof DeleteCustomDataIdentifierRequest & keyof DeleteCustomDataIdentifierRequest]: (DeleteCustomDataIdentifierRequest & DeleteCustomDataIdentifierRequest & DeleteCustomDataIdentifierRequest & DeleteCustomDataIdentifierRequest & DeleteCustomDataIdentifierRequest)[K]
    ...
    invokeDeleteFindingsFilter(partialParams: ToOptional<{
      [K in keyof DeleteFindingsFilterRequest & keyof DeleteFindingsFilterRequest & keyof DeleteFindingsFilterRequest & keyof DeleteFindingsFilterRequest & keyof DeleteFindingsFilterRequest]: (DeleteFindingsFilterRequest & DeleteFindingsFilterRequest & DeleteFindingsFilterRequest & DeleteFindingsFilterRequest & DeleteFindingsFilterRequest)[K]
    ...
    invokeDeleteMember(partialParams: ToOptional<{
      [K in keyof DeleteMemberRequest & keyof DeleteMemberRequest & keyof DeleteMemberRequest & keyof DeleteMemberRequest & keyof DeleteMemberRequest]: (DeleteMemberRequest & DeleteMemberRequest & DeleteMemberRequest & DeleteMemberRequest & DeleteMemberRequest)[K]
    ...
    invokeDescribeClassificationJob(partialParams: ToOptional<{
      [K in keyof DescribeClassificationJobRequest & keyof DescribeClassificationJobRequest & keyof DescribeClassificationJobRequest & keyof DescribeClassificationJobRequest & keyof DescribeClassificationJobRequest]: (DescribeClassificationJobRequest & DescribeClassificationJobRequest & DescribeClassificationJobRequest & DescribeClassificationJobRequest & DescribeClassificationJobRequest)[K]
    ...
    invokeDisassociateMember(partialParams: ToOptional<{
      [K in keyof DisassociateMemberRequest & keyof DisassociateMemberRequest & keyof DisassociateMemberRequest & keyof DisassociateMemberRequest & keyof DisassociateMemberRequest]: (DisassociateMemberRequest & DisassociateMemberRequest & DisassociateMemberRequest & DisassociateMemberRequest & DisassociateMemberRequest)[K]
    ...
    invokeGetCustomDataIdentifier(partialParams: ToOptional<{
      [K in keyof GetCustomDataIdentifierRequest & keyof GetCustomDataIdentifierRequest & keyof GetCustomDataIdentifierRequest & keyof GetCustomDataIdentifierRequest & keyof GetCustomDataIdentifierRequest]: (GetCustomDataIdentifierRequest & GetCustomDataIdentifierRequest & GetCustomDataIdentifierRequest & GetCustomDataIdentifierRequest & GetCustomDataIdentifierRequest)[K]
    ...
    invokeGetFindingStatistics(partialParams: ToOptional<{
      [K in keyof GetFindingStatisticsRequest & keyof GetFindingStatisticsRequest & keyof GetFindingStatisticsRequest & keyof GetFindingStatisticsRequest & keyof GetFindingStatisticsRequest]: (GetFindingStatisticsRequest & GetFindingStatisticsRequest & GetFindingStatisticsRequest & GetFindingStatisticsRequest & GetFindingStatisticsRequest)[K]
    ...
    invokeGetFindings(partialParams: ToOptional<{
      [K in keyof GetFindingsRequest & keyof GetFindingsRequest & keyof GetFindingsRequest & keyof GetFindingsRequest & keyof GetFindingsRequest]: (GetFindingsRequest & GetFindingsRequest & GetFindingsRequest & GetFindingsRequest & GetFindingsRequest)[K]
    ...
    invokeGetFindingsFilter(partialParams: ToOptional<{
      [K in keyof GetFindingsFilterRequest & keyof GetFindingsFilterRequest & keyof GetFindingsFilterRequest & keyof GetFindingsFilterRequest & keyof GetFindingsFilterRequest]: (GetFindingsFilterRequest & GetFindingsFilterRequest & GetFindingsFilterRequest & GetFindingsFilterRequest & GetFindingsFilterRequest)[K]
    ...
    invokeGetMember(partialParams: ToOptional<{
      [K in keyof GetMemberRequest & keyof GetMemberRequest & keyof GetMemberRequest & keyof GetMemberRequest & keyof GetMemberRequest]: (GetMemberRequest & GetMemberRequest & GetMemberRequest & GetMemberRequest & GetMemberRequest)[K]
    ...
    invokePutClassificationExportConfiguration(partialParams: ToOptional<{
      [K in keyof PutClassificationExportConfigurationRequest & keyof PutClassificationExportConfigurationRequest & keyof PutClassificationExportConfigurationRequest & keyof PutClassificationExportConfigurationRequest & keyof PutClassificationExportConfigurationRequest]: (PutClassificationExportConfigurationRequest & PutClassificationExportConfigurationRequest & PutClassificationExportConfigurationRequest & PutClassificationExportConfigurationRequest & PutClassificationExportConfigurationRequest)[K]
    ...
    invokeTestCustomDataIdentifier(partialParams: ToOptional<{
      [K in keyof TestCustomDataIdentifierRequest & keyof TestCustomDataIdentifierRequest & keyof TestCustomDataIdentifierRequest & keyof TestCustomDataIdentifierRequest & keyof TestCustomDataIdentifierRequest]: (TestCustomDataIdentifierRequest & TestCustomDataIdentifierRequest & TestCustomDataIdentifierRequest & TestCustomDataIdentifierRequest & TestCustomDataIdentifierRequest)[K]
    ...
    invokeUpdateClassificationJob(partialParams: ToOptional<{
      [K in keyof UpdateClassificationJobRequest & keyof UpdateClassificationJobRequest & keyof UpdateClassificationJobRequest & keyof UpdateClassificationJobRequest & keyof UpdateClassificationJobRequest]: (UpdateClassificationJobRequest & UpdateClassificationJobRequest & UpdateClassificationJobRequest & UpdateClassificationJobRequest & UpdateClassificationJobRequest)[K]
    ...
    invokeUpdateFindingsFilter(partialParams: ToOptional<{
      [K in keyof UpdateFindingsFilterRequest & keyof UpdateFindingsFilterRequest & keyof UpdateFindingsFilterRequest & keyof UpdateFindingsFilterRequest & keyof UpdateFindingsFilterRequest]: (UpdateFindingsFilterRequest & UpdateFindingsFilterRequest & UpdateFindingsFilterRequest & UpdateFindingsFilterRequest & UpdateFindingsFilterRequest)[K]
    ...
    invokeUpdateMemberSession(partialParams: ToOptional<{
      [K in keyof UpdateMemberSessionRequest & keyof UpdateMemberSessionRequest & keyof UpdateMemberSessionRequest & keyof Omit<UpdateMemberSessionRequest, "status"> & keyof UpdateMemberSessionRequest]: (UpdateMemberSessionRequest & UpdateMemberSessionRequest & UpdateMemberSessionRequest & Omit<UpdateMemberSessionRequest, "status"> & UpdateMemberSessionRequest)[K]
    ...
    invokeUpdateOrganizationConfiguration(partialParams: ToOptional<{
      [K in keyof UpdateOrganizationConfigurationRequest & keyof UpdateOrganizationConfigurationRequest & keyof UpdateOrganizationConfigurationRequest & keyof UpdateOrganizationConfigurationRequest & keyof UpdateOrganizationConfigurationRequest]: (UpdateOrganizationConfigurationRequest & UpdateOrganizationConfigurationRequest & UpdateOrganizationConfigurationRequest & UpdateOrganizationConfigurationRequest & UpdateOrganizationConfigurationRequest)[K]
