...
export default class extends aws.rds.Instance {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.rds.Instance>) {
        super(...args)
        this.booted = false;
    ...
    invokeCreateOptionGroup(partialParams: ToOptional<{
      [K in keyof CreateOptionGroupMessage & keyof Omit<CreateOptionGroupMessage, "OptionGroupName">]: (CreateOptionGroupMessage)[K]
