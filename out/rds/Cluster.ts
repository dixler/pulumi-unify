...
export default class extends aws.rds.Cluster {
    ...
    invokeFailoverGlobalCluster(partialParams: ToOptional<{
      [K in keyof FailoverGlobalClusterMessage & keyof Omit<FailoverGlobalClusterMessage, "GlobalClusterIdentifier">]: (FailoverGlobalClusterMessage)[K]
    ...
    invokeRestoreDBClusterFromS3(partialParams: ToOptional<{
      [K in keyof RestoreDBClusterFromS3Message & keyof Omit<RestoreDBClusterFromS3Message, "Engine" | "MasterUsername">]: (RestoreDBClusterFromS3Message)[K]
    ...
    invokeRestoreDBClusterFromSnapshot(partialParams: ToOptional<{
      [K in keyof RestoreDBClusterFromSnapshotMessage & keyof Omit<RestoreDBClusterFromSnapshotMessage, "SnapshotIdentifier" | "Engine">]: (RestoreDBClusterFromSnapshotMessage)[K]
