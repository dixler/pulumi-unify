...
export default class extends aws.rds.ProxyTarget {
    ...
    invokeCreateCustomDBEngineVersion(partialParams: ToOptional<{
      [K in keyof CreateCustomDBEngineVersionMessage]: (CreateCustomDBEngineVersionMessage)[K]
    ...
    invokeDeleteCustomDBEngineVersion(partialParams: ToOptional<{
      [K in keyof DeleteCustomDBEngineVersionMessage]: (DeleteCustomDBEngineVersionMessage)[K]
    }>): Request<DBEngineVersion, AWSError> {
        this.boot();
    ...
    invokeImportInstallationMedia(partialParams: ToOptional<{
      [K in keyof ImportInstallationMediaMessage]: (ImportInstallationMediaMessage)[K]
    }>): Request<InstallationMedia, AWSError> {
        this.boot();
    ...
    invokeModifyCustomDBEngineVersion(partialParams: ToOptional<{
      [K in keyof ModifyCustomDBEngineVersionMessage]: (ModifyCustomDBEngineVersionMessage)[K]
    }>): Request<DBEngineVersion, AWSError> {
        this.boot();
    ...
    invokeModifyDBProxyTargetGroup(partialParams: ToOptional<{
      [K in keyof ModifyDBProxyTargetGroupRequest & keyof Omit<ModifyDBProxyTargetGroupRequest, "TargetGroupName">]: (ModifyDBProxyTargetGroupRequest)[K]
    ...
    invokeRestoreDBClusterFromS3(partialParams: ToOptional<{
      [K in keyof RestoreDBClusterFromS3Message]: (RestoreDBClusterFromS3Message)[K]
    ...
    invokeRestoreDBInstanceFromS3(partialParams: ToOptional<{
      [K in keyof RestoreDBInstanceFromS3Message]: (RestoreDBInstanceFromS3Message)[K]
    ...
    invokeStartActivityStream(partialParams: ToOptional<{
      [K in keyof StartActivityStreamRequest]: (StartActivityStreamRequest)[K]
    ...
    invokeStartExportTask(partialParams: ToOptional<{
      [K in keyof StartExportTaskMessage]: (StartExportTaskMessage)[K]
    }>): Request<ExportTask, AWSError> {
        this.boot();
