...
export default class extends aws.rds.ProxyDefaultTargetGroup {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.rds.ProxyDefaultTargetGroup>) {
        super(...args)
    ...
    invokeFailoverGlobalCluster(partialParams: ToOptional<{
      [K in keyof FailoverGlobalClusterMessage & keyof FailoverGlobalClusterMessage & keyof FailoverGlobalClusterMessage]: (FailoverGlobalClusterMessage & FailoverGlobalClusterMessage & FailoverGlobalClusterMessage)[K]
