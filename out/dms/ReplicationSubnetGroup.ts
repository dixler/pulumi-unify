...
export default class extends aws.dms.ReplicationSubnetGroup {
    ...
    invokeCreateReplicationSubnetGroup(partialParams: ToOptional<{
      [K in keyof CreateReplicationSubnetGroupMessage & keyof Omit<CreateReplicationSubnetGroupMessage, "ReplicationSubnetGroupDescription">]: (CreateReplicationSubnetGroupMessage)[K]
    ...
    invokeDeleteCertificate(partialParams: ToOptional<{
      [K in keyof DeleteCertificateMessage]: (DeleteCertificateMessage)[K]
