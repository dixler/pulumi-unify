...
export default class extends aws.redshift.ScheduledAction {
    ...
    invokeCreateScheduledAction(partialParams: ToOptional<{
      [K in keyof CreateScheduledActionMessage & keyof Omit<CreateScheduledActionMessage, "ScheduledActionName" | "Schedule" | "IamRole">]: (CreateScheduledActionMessage)[K]
    ...
    invokeModifyScheduledAction(partialParams: ToOptional<{
      [K in keyof ModifyScheduledActionMessage & keyof Omit<ModifyScheduledActionMessage, "ScheduledActionName">]: (ModifyScheduledActionMessage)[K]
    }>): Request<ScheduledAction, AWSError> {
        this.boot();
