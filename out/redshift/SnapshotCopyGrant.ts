...
export default class extends aws.redshift.SnapshotCopyGrant {
    ...
    invokeCreateClusterSubnetGroup(partialParams: ToOptional<{
      [K in keyof CreateClusterSubnetGroupMessage]: (CreateClusterSubnetGroupMessage)[K]
    ...
    invokeCreateSnapshotCopyGrant(partialParams: ToOptional<{
      [K in keyof CreateSnapshotCopyGrantMessage & keyof Omit<CreateSnapshotCopyGrantMessage, "SnapshotCopyGrantName">]: (CreateSnapshotCopyGrantMessage)[K]
