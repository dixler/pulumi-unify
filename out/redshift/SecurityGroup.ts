...
export default class extends aws.redshift.SecurityGroup {
    ...
    invokeAddPartner(partialParams: ToOptional<{
      [K in keyof PartnerIntegrationInputMessage & keyof PartnerIntegrationInputMessage]: (PartnerIntegrationInputMessage & PartnerIntegrationInputMessage)[K]
    }>): PartnerIntegrationOutputMessage {
    ...
    invokeUpdatePartnerStatus(partialParams: ToOptional<{
      [K in keyof UpdatePartnerStatusInputMessage & keyof UpdatePartnerStatusInputMessage]: (UpdatePartnerStatusInputMessage & UpdatePartnerStatusInputMessage)[K]
    }>): PartnerIntegrationOutputMessage {
