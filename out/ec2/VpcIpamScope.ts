...
export default class extends aws.ec2.VpcIpamScope {
    ...
    invokeModifyIpam(partialParams: ToOptional<{
      [K in keyof ModifyIpamRequest & keyof ModifyIpamRequest & keyof ModifyIpamRequest & keyof Omit<ModifyIpamRequest, "IpamId"> & keyof ModifyIpamRequest]: (ModifyIpamRequest & ModifyIpamRequest & ModifyIpamRequest & Omit<ModifyIpamRequest, "IpamId"> & ModifyIpamRequest)[K]
    }>): ModifyIpamResult {
