...
export default class extends aws.ec2.VpcEndpointServiceAllowedPrinciple {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.ec2.VpcEndpointServiceAllowedPrinciple>) {
        super(...args)
