...
export default class extends aws.ec2.VpcIpamPoolCidrAllocation {
    ...
    invokeCreateFlowLogs(partialParams: ToOptional<{
      [K in keyof CreateFlowLogsRequest & keyof Omit<CreateFlowLogsRequest, "ResourceType">]: (CreateFlowLogsRequest)[K]
    ...
    invokeModifyIpamResourceCidr(partialParams: ToOptional<{
      [K in keyof ModifyIpamResourceCidrRequest & keyof Omit<ModifyIpamResourceCidrRequest, "ResourceId">]: (ModifyIpamResourceCidrRequest)[K]
