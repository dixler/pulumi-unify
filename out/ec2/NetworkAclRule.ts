...
export default class extends aws.ec2.NetworkAclRule {
    ...
    invokeCreateTrafficMirrorFilterRule(partialParams: ToOptional<{
      [K in keyof CreateTrafficMirrorFilterRuleRequest & keyof Omit<CreateTrafficMirrorFilterRuleRequest, "RuleAction">]: (CreateTrafficMirrorFilterRuleRequest)[K]
    ...
    invokeReplaceNetworkAclAssociation(partialParams: ToOptional<{
      [K in keyof ReplaceNetworkAclAssociationRequest & keyof Omit<ReplaceNetworkAclAssociationRequest, "NetworkAclId">]: (ReplaceNetworkAclAssociationRequest)[K]
