...
export default class extends aws.ec2.AmiLaunchPermission {
    ...
    invokeModifyImageAttribute(partialParams: ToOptional<{
      [K in keyof ModifyImageAttributeRequest & keyof Omit<ModifyImageAttributeRequest, "ImageId">]: (ModifyImageAttributeRequest & Omit<ModifyImageAttributeRequest, "ImageId">)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeResetImageAttribute(partialParams: ToOptional<{
      [K in keyof ResetImageAttributeRequest & keyof Omit<ResetImageAttributeRequest, "ImageId">]: (ResetImageAttributeRequest & Omit<ResetImageAttributeRequest, "ImageId">)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeRestoreImageFromRecycleBin(partialParams: ToOptional<{
      [K in keyof RestoreImageFromRecycleBinRequest & keyof Omit<RestoreImageFromRecycleBinRequest, "ImageId">]: (RestoreImageFromRecycleBinRequest & Omit<RestoreImageFromRecycleBinRequest, "ImageId">)[K]
