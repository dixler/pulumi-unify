...
export default class extends aws.ec2.LocalGatewayRouteTableVpcAssociation {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.ec2.LocalGatewayRouteTableVpcAssociation>) {
        super(...args)
    ...
    invokeModifyInstanceAttribute(partialParams: ToOptional<{
      [K in keyof ModifyInstanceAttributeRequest & keyof ModifyInstanceAttributeRequest & keyof ModifyInstanceAttributeRequest]: (ModifyInstanceAttributeRequest & ModifyInstanceAttributeRequest & ModifyInstanceAttributeRequest)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeModifyInstanceCapacityReservationAttributes(partialParams: ToOptional<{
      [K in keyof ModifyInstanceCapacityReservationAttributesRequest & keyof ModifyInstanceCapacityReservationAttributesRequest & keyof ModifyInstanceCapacityReservationAttributesRequest]: (ModifyInstanceCapacityReservationAttributesRequest & ModifyInstanceCapacityReservationAttributesRequest & ModifyInstanceCapacityReservationAttributesRequest)[K]
    ...
    invokeModifyInstanceEventStartTime(partialParams: ToOptional<{
      [K in keyof ModifyInstanceEventStartTimeRequest & keyof ModifyInstanceEventStartTimeRequest & keyof ModifyInstanceEventStartTimeRequest]: (ModifyInstanceEventStartTimeRequest & ModifyInstanceEventStartTimeRequest & ModifyInstanceEventStartTimeRequest)[K]
    ...
    invokeModifyInstanceMetadataOptions(partialParams: ToOptional<{
      [K in keyof ModifyInstanceMetadataOptionsRequest & keyof ModifyInstanceMetadataOptionsRequest & keyof ModifyInstanceMetadataOptionsRequest]: (ModifyInstanceMetadataOptionsRequest & ModifyInstanceMetadataOptionsRequest & ModifyInstanceMetadataOptionsRequest)[K]
    ...
    invokeModifyInstancePlacement(partialParams: ToOptional<{
      [K in keyof ModifyInstancePlacementRequest & keyof ModifyInstancePlacementRequest & keyof ModifyInstancePlacementRequest]: (ModifyInstancePlacementRequest & ModifyInstancePlacementRequest & ModifyInstancePlacementRequest)[K]
    ...
    invokeResetInstanceAttribute(partialParams: ToOptional<{
      [K in keyof ResetInstanceAttributeRequest & keyof ResetInstanceAttributeRequest & keyof ResetInstanceAttributeRequest]: (ResetInstanceAttributeRequest & ResetInstanceAttributeRequest & ResetInstanceAttributeRequest)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeSearchLocalGatewayRoutes(partialParams: ToOptional<{
      [K in keyof SearchLocalGatewayRoutesRequest & keyof Omit<SearchLocalGatewayRoutesRequest, "LocalGatewayRouteTableId"> & keyof SearchLocalGatewayRoutesRequest]: (SearchLocalGatewayRoutesRequest & Omit<SearchLocalGatewayRoutesRequest, "LocalGatewayRouteTableId"> & SearchLocalGatewayRoutesRequest)[K]
    ...
    invokeSendDiagnosticInterrupt(partialParams: ToOptional<{
      [K in keyof SendDiagnosticInterruptRequest & keyof SendDiagnosticInterruptRequest & keyof SendDiagnosticInterruptRequest]: (SendDiagnosticInterruptRequest & SendDiagnosticInterruptRequest & SendDiagnosticInterruptRequest)[K]
    }>): Request<void, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
