...
export default class extends aws.ec2.LocalGatewayRouteTableVpcAssociation {
    ...
    invokeCreateLocalGatewayRoute(partialParams: ToOptional<{
      [K in keyof CreateLocalGatewayRouteRequest & keyof Omit<CreateLocalGatewayRouteRequest, "LocalGatewayRouteTableId">]: (CreateLocalGatewayRouteRequest)[K]
    ...
    invokeCreateLocalGatewayRouteTableVpcAssociation(partialParams: ToOptional<{
      [K in keyof CreateLocalGatewayRouteTableVpcAssociationRequest & keyof Omit<CreateLocalGatewayRouteTableVpcAssociationRequest, "LocalGatewayRouteTableId" | "VpcId">]: (CreateLocalGatewayRouteTableVpcAssociationRequest)[K]
    ...
    invokeDeleteLocalGatewayRoute(partialParams: ToOptional<{
      [K in keyof DeleteLocalGatewayRouteRequest & keyof Omit<DeleteLocalGatewayRouteRequest, "LocalGatewayRouteTableId">]: (DeleteLocalGatewayRouteRequest)[K]
