...
export default class extends aws.ec2.VpcEndpointRouteTableAssociation {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.ec2.VpcEndpointRouteTableAssociation>) {
        super(...args)
