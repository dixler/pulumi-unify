...
export default class extends aws.ec2.VpcEndpointConnectionNotification {
    ...
    invokeCreateVpcEndpointConnectionNotification(partialParams: ToOptional<{
      [K in keyof CreateVpcEndpointConnectionNotificationRequest & keyof Omit<CreateVpcEndpointConnectionNotificationRequest, "ConnectionNotificationArn">]: (CreateVpcEndpointConnectionNotificationRequest)[K]
