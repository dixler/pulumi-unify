...
export default class extends aws.ec2.ManagedPrefixListEntry {
    ...
    invokeRestoreManagedPrefixListVersion(partialParams: ToOptional<{
      [K in keyof RestoreManagedPrefixListVersionRequest & keyof RestoreManagedPrefixListVersionRequest & keyof Omit<RestoreManagedPrefixListVersionRequest, "PrefixListId">]: (RestoreManagedPrefixListVersionRequest & RestoreManagedPrefixListVersionRequest & Omit<RestoreManagedPrefixListVersionRequest, "PrefixListId">)[K]
    ...
    invokeWithdrawByoipCidr(partialParams: ToOptional<{
      [K in keyof Omit<WithdrawByoipCidrRequest, "Cidr"> & keyof WithdrawByoipCidrRequest & keyof WithdrawByoipCidrRequest]: (Omit<WithdrawByoipCidrRequest, "Cidr"> & WithdrawByoipCidrRequest & WithdrawByoipCidrRequest)[K]
