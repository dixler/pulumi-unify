...
export default class extends aws.ec2.VpcPeeringConnectionAccepter {
    ...
    invokeCreateTransitGatewayPeeringAttachment(partialParams: ToOptional<{
      [K in keyof CreateTransitGatewayPeeringAttachmentRequest & keyof Omit<CreateTransitGatewayPeeringAttachmentRequest, "PeerRegion">]: (CreateTransitGatewayPeeringAttachmentRequest)[K]
