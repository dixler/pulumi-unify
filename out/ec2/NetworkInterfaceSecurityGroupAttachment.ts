...
export default class extends aws.ec2.NetworkInterfaceSecurityGroupAttachment {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.ec2.NetworkInterfaceSecurityGroupAttachment>) {
        super(...args)
    ...
    invokeModifyIpamPool(partialParams: ToOptional<{
      [K in keyof ModifyIpamPoolRequest & keyof ModifyIpamPoolRequest]: (ModifyIpamPoolRequest & ModifyIpamPoolRequest)[K]
    }>): ModifyIpamPoolResult {
    ...
    invokeMoveByoipCidrToIpam(partialParams: ToOptional<{
      [K in keyof MoveByoipCidrToIpamRequest & keyof MoveByoipCidrToIpamRequest]: (MoveByoipCidrToIpamRequest & MoveByoipCidrToIpamRequest)[K]
    }>): MoveByoipCidrToIpamResult {
    ...
    invokeProvisionIpamPoolCidr(partialParams: ToOptional<{
      [K in keyof ProvisionIpamPoolCidrRequest & keyof ProvisionIpamPoolCidrRequest]: (ProvisionIpamPoolCidrRequest & ProvisionIpamPoolCidrRequest)[K]
    }>): ProvisionIpamPoolCidrResult {
    ...
    invokeProvisionPublicIpv4PoolCidr(partialParams: ToOptional<{
      [K in keyof ProvisionPublicIpv4PoolCidrRequest & keyof ProvisionPublicIpv4PoolCidrRequest]: (ProvisionPublicIpv4PoolCidrRequest & ProvisionPublicIpv4PoolCidrRequest)[K]
    }>): ProvisionPublicIpv4PoolCidrResult {
    ...
    invokeReleaseIpamPoolAllocation(partialParams: ToOptional<{
      [K in keyof ReleaseIpamPoolAllocationRequest & keyof ReleaseIpamPoolAllocationRequest]: (ReleaseIpamPoolAllocationRequest & ReleaseIpamPoolAllocationRequest)[K]
    }>): ReleaseIpamPoolAllocationResult {
    ...
    invokeResetNetworkInterfaceAttribute(partialParams: ToOptional<{
      [K in keyof Omit<ResetNetworkInterfaceAttributeRequest, "NetworkInterfaceId"> & keyof ResetNetworkInterfaceAttributeRequest]: (Omit<ResetNetworkInterfaceAttributeRequest, "NetworkInterfaceId"> & ResetNetworkInterfaceAttributeRequest)[K]
    }>): void {
    ...
    invokeUnassignIpv6Addresses(partialParams: ToOptional<{
      [K in keyof Omit<UnassignIpv6AddressesRequest, "NetworkInterfaceId"> & keyof UnassignIpv6AddressesRequest]: (Omit<UnassignIpv6AddressesRequest, "NetworkInterfaceId"> & UnassignIpv6AddressesRequest)[K]
    }>): UnassignIpv6AddressesResult {
    ...
    invokeUnassignPrivateIpAddresses(partialParams: ToOptional<{
      [K in keyof Omit<UnassignPrivateIpAddressesRequest, "NetworkInterfaceId"> & keyof UnassignPrivateIpAddressesRequest]: (Omit<UnassignPrivateIpAddressesRequest, "NetworkInterfaceId"> & UnassignPrivateIpAddressesRequest)[K]
    }>): void {
    ...
    invokeWithdrawByoipCidr(partialParams: ToOptional<{
      [K in keyof WithdrawByoipCidrRequest & keyof WithdrawByoipCidrRequest]: (WithdrawByoipCidrRequest & WithdrawByoipCidrRequest)[K]
    }>): WithdrawByoipCidrResult {
