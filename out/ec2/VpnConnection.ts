...
export default class extends aws.ec2.VpnConnection {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.ec2.VpnConnection>) {
        super(...args)
        this.booted = false;
    ...
    invokeCreateVpnConnection(partialParams: ToOptional<{
      [K in keyof CreateVpnConnectionRequest & keyof Omit<CreateVpnConnectionRequest, "CustomerGatewayId" | "Type">]: (CreateVpnConnectionRequest)[K]
