...
export default class extends aws.ec2.TrafficMirrorSession {
    ...
    invokeCreateTrafficMirrorFilterRule(partialParams: ToOptional<{
      [K in keyof CreateTrafficMirrorFilterRuleRequest & keyof Omit<CreateTrafficMirrorFilterRuleRequest, "TrafficMirrorFilterId">]: (CreateTrafficMirrorFilterRuleRequest)[K]
    ...
    invokeCreateTrafficMirrorSession(partialParams: ToOptional<{
      [K in keyof CreateTrafficMirrorSessionRequest & keyof Omit<CreateTrafficMirrorSessionRequest, "NetworkInterfaceId" | "TrafficMirrorTargetId" | "TrafficMirrorFilterId">]: (CreateTrafficMirrorSessionRequest)[K]
    ...
    invokeDeleteTrafficMirrorTarget(partialParams: ToOptional<{
      [K in keyof DeleteTrafficMirrorTargetRequest & keyof Omit<DeleteTrafficMirrorTargetRequest, "TrafficMirrorTargetId">]: (DeleteTrafficMirrorTargetRequest)[K]
