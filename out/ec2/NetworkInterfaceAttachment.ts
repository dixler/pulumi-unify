...
export default class extends aws.ec2.NetworkInterfaceAttachment {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.ec2.NetworkInterfaceAttachment>) {
        super(...args)
    ...
    invokeModifyInstanceCapacityReservationAttributes(partialParams: ToOptional<{
      [K in keyof ModifyInstanceCapacityReservationAttributesRequest & keyof Omit<ModifyInstanceCapacityReservationAttributesRequest, "InstanceId"> & keyof ModifyInstanceCapacityReservationAttributesRequest & keyof ModifyInstanceCapacityReservationAttributesRequest]: (ModifyInstanceCapacityReservationAttributesRequest & Omit<ModifyInstanceCapacityReservationAttributesRequest, "InstanceId"> & ModifyInstanceCapacityReservationAttributesRequest & ModifyInstanceCapacityReservationAttributesRequest)[K]
    }>): ModifyInstanceCapacityReservationAttributesResult {
    ...
    invokeModifyInstanceEventStartTime(partialParams: ToOptional<{
      [K in keyof ModifyInstanceEventStartTimeRequest & keyof Omit<ModifyInstanceEventStartTimeRequest, "InstanceId"> & keyof ModifyInstanceEventStartTimeRequest & keyof ModifyInstanceEventStartTimeRequest]: (ModifyInstanceEventStartTimeRequest & Omit<ModifyInstanceEventStartTimeRequest, "InstanceId"> & ModifyInstanceEventStartTimeRequest & ModifyInstanceEventStartTimeRequest)[K]
    }>): ModifyInstanceEventStartTimeResult {
    ...
    invokeModifyInstanceMetadataOptions(partialParams: ToOptional<{
      [K in keyof ModifyInstanceMetadataOptionsRequest & keyof Omit<ModifyInstanceMetadataOptionsRequest, "InstanceId"> & keyof ModifyInstanceMetadataOptionsRequest & keyof ModifyInstanceMetadataOptionsRequest]: (ModifyInstanceMetadataOptionsRequest & Omit<ModifyInstanceMetadataOptionsRequest, "InstanceId"> & ModifyInstanceMetadataOptionsRequest & ModifyInstanceMetadataOptionsRequest)[K]
    }>): ModifyInstanceMetadataOptionsResult {
    ...
    invokeModifyInstancePlacement(partialParams: ToOptional<{
      [K in keyof ModifyInstancePlacementRequest & keyof Omit<ModifyInstancePlacementRequest, "InstanceId"> & keyof ModifyInstancePlacementRequest & keyof ModifyInstancePlacementRequest]: (ModifyInstancePlacementRequest & Omit<ModifyInstancePlacementRequest, "InstanceId"> & ModifyInstancePlacementRequest & ModifyInstancePlacementRequest)[K]
    }>): ModifyInstancePlacementResult {
    ...
    invokeResetInstanceAttribute(partialParams: ToOptional<{
      [K in keyof ResetInstanceAttributeRequest & keyof Omit<ResetInstanceAttributeRequest, "InstanceId"> & keyof ResetInstanceAttributeRequest & keyof ResetInstanceAttributeRequest]: (ResetInstanceAttributeRequest & Omit<ResetInstanceAttributeRequest, "InstanceId"> & ResetInstanceAttributeRequest & ResetInstanceAttributeRequest)[K]
    }>): void {
    ...
    invokeResetNetworkInterfaceAttribute(partialParams: ToOptional<{
      [K in keyof ResetNetworkInterfaceAttributeRequest & keyof ResetNetworkInterfaceAttributeRequest & keyof Omit<ResetNetworkInterfaceAttributeRequest, "NetworkInterfaceId"> & keyof ResetNetworkInterfaceAttributeRequest]: (ResetNetworkInterfaceAttributeRequest & ResetNetworkInterfaceAttributeRequest & Omit<ResetNetworkInterfaceAttributeRequest, "NetworkInterfaceId"> & ResetNetworkInterfaceAttributeRequest)[K]
    }>): void {
    ...
    invokeSendDiagnosticInterrupt(partialParams: ToOptional<{
      [K in keyof SendDiagnosticInterruptRequest & keyof Omit<SendDiagnosticInterruptRequest, "InstanceId"> & keyof SendDiagnosticInterruptRequest & keyof SendDiagnosticInterruptRequest]: (SendDiagnosticInterruptRequest & Omit<SendDiagnosticInterruptRequest, "InstanceId"> & SendDiagnosticInterruptRequest & SendDiagnosticInterruptRequest)[K]
    }>): void {
    ...
    invokeUnassignIpv6Addresses(partialParams: ToOptional<{
      [K in keyof UnassignIpv6AddressesRequest & keyof UnassignIpv6AddressesRequest & keyof Omit<UnassignIpv6AddressesRequest, "NetworkInterfaceId"> & keyof UnassignIpv6AddressesRequest]: (UnassignIpv6AddressesRequest & UnassignIpv6AddressesRequest & Omit<UnassignIpv6AddressesRequest, "NetworkInterfaceId"> & UnassignIpv6AddressesRequest)[K]
    }>): UnassignIpv6AddressesResult {
