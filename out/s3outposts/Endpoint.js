...
class default_1 extends aws.s3outposts.Endpoint {
    constructor(...args) {
        super(...args);
        this.client = new awssdk.S3Outposts();
        this.ops = (0, parse_1.getResourceOperations)(this, require("../../aws-sdk-js/apis/s3outposts-2017-07-25.normal.json"), this.client);
    }
