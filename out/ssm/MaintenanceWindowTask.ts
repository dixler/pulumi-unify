...
export default class extends aws.ssm.MaintenanceWindowTask {
    ...
    invokeRegisterTargetWithMaintenanceWindow(partialParams: ToOptional<{
      [K in keyof RegisterTargetWithMaintenanceWindowRequest & keyof Omit<RegisterTargetWithMaintenanceWindowRequest, "WindowId">]: (RegisterTargetWithMaintenanceWindowRequest)[K]
    ...
    invokeRegisterTaskWithMaintenanceWindow(partialParams: ToOptional<{
      [K in keyof RegisterTaskWithMaintenanceWindowRequest & keyof Omit<RegisterTaskWithMaintenanceWindowRequest, "WindowId" | "TaskArn" | "TaskType">]: (RegisterTaskWithMaintenanceWindowRequest)[K]
