...
export default class extends aws.ssm.PatchGroup {
    ...
    invokeCreatePatchBaseline(partialParams: ToOptional<{
      [K in keyof CreatePatchBaselineRequest]: (CreatePatchBaselineRequest)[K]
    ...
    invokeGetDocument(partialParams: ToOptional<{
      [K in keyof GetDocumentRequest]: (GetDocumentRequest)[K]
    ...
    invokeListDocumentMetadataHistory(partialParams: ToOptional<{
      [K in keyof ListDocumentMetadataHistoryRequest]: (ListDocumentMetadataHistoryRequest)[K]
    ...
    invokeListDocumentVersions(partialParams: ToOptional<{
      [K in keyof ListDocumentVersionsRequest]: (ListDocumentVersionsRequest)[K]
    ...
    invokeModifyDocumentPermission(partialParams: ToOptional<{
      [K in keyof ModifyDocumentPermissionRequest]: (ModifyDocumentPermissionRequest)[K]
    ...
    invokePutParameter(partialParams: ToOptional<{
      [K in keyof PutParameterRequest]: (PutParameterRequest)[K]
    ...
    invokeUnlabelParameterVersion(partialParams: ToOptional<{
      [K in keyof UnlabelParameterVersionRequest]: (UnlabelParameterVersionRequest)[K]
    ...
    invokeUpdateAssociationStatus(partialParams: ToOptional<{
      [K in keyof UpdateAssociationStatusRequest]: (UpdateAssociationStatusRequest)[K]
    ...
    invokeUpdateDocument(partialParams: ToOptional<{
      [K in keyof UpdateDocumentRequest]: (UpdateDocumentRequest)[K]
    ...
    invokeUpdateDocumentDefaultVersion(partialParams: ToOptional<{
      [K in keyof UpdateDocumentDefaultVersionRequest]: (UpdateDocumentDefaultVersionRequest)[K]
    ...
    invokeUpdateDocumentMetadata(partialParams: ToOptional<{
      [K in keyof UpdateDocumentMetadataRequest]: (UpdateDocumentMetadataRequest)[K]
