...
export default class extends aws.backup.VaultPolicy {
    ...
    invokePutBackupVaultNotifications(partialParams: ToOptional<{
      [K in keyof PutBackupVaultNotificationsInput & keyof Omit<PutBackupVaultNotificationsInput, "BackupVaultName"> & keyof PutBackupVaultNotificationsInput]: (PutBackupVaultNotificationsInput & Omit<PutBackupVaultNotificationsInput, "BackupVaultName"> & PutBackupVaultNotificationsInput)[K]
    }>): void {
