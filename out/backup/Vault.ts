...
export default class extends aws.backup.Vault {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.backup.Vault>) {
        super(...args)
    ...
    invokeDeleteRecoveryPoint(partialParams: ToOptional<{
      [K in keyof Omit<DeleteRecoveryPointInput, "RecoveryPointArn"> & keyof DeleteRecoveryPointInput & keyof DeleteRecoveryPointInput]: (Omit<DeleteRecoveryPointInput, "RecoveryPointArn"> & DeleteRecoveryPointInput & DeleteRecoveryPointInput)[K]
    }>): void {
    ...
    invokeDescribeProtectedResource(partialParams: ToOptional<{
      [K in keyof Omit<DescribeProtectedResourceInput, "ResourceArn"> & keyof DescribeProtectedResourceInput & keyof DescribeProtectedResourceInput]: (Omit<DescribeProtectedResourceInput, "ResourceArn"> & DescribeProtectedResourceInput & DescribeProtectedResourceInput)[K]
    }>): DescribeProtectedResourceOutput {
    ...
    invokeDescribeRecoveryPoint(partialParams: ToOptional<{
      [K in keyof Omit<DescribeRecoveryPointInput, "RecoveryPointArn"> & keyof DescribeRecoveryPointInput & keyof DescribeRecoveryPointInput]: (Omit<DescribeRecoveryPointInput, "RecoveryPointArn"> & DescribeRecoveryPointInput & DescribeRecoveryPointInput)[K]
    }>): DescribeRecoveryPointOutput {
    ...
    invokeDisassociateRecoveryPoint(partialParams: ToOptional<{
      [K in keyof Omit<DisassociateRecoveryPointInput, "RecoveryPointArn"> & keyof DisassociateRecoveryPointInput & keyof DisassociateRecoveryPointInput]: (Omit<DisassociateRecoveryPointInput, "RecoveryPointArn"> & DisassociateRecoveryPointInput & DisassociateRecoveryPointInput)[K]
    }>): void {
    ...
    invokeGetRecoveryPointRestoreMetadata(partialParams: ToOptional<{
      [K in keyof Omit<GetRecoveryPointRestoreMetadataInput, "RecoveryPointArn"> & keyof GetRecoveryPointRestoreMetadataInput & keyof GetRecoveryPointRestoreMetadataInput]: (Omit<GetRecoveryPointRestoreMetadataInput, "RecoveryPointArn"> & GetRecoveryPointRestoreMetadataInput & GetRecoveryPointRestoreMetadataInput)[K]
    }>): GetRecoveryPointRestoreMetadataOutput {
    ...
    invokeListRecoveryPointsByResource(partialParams: ToOptional<{
      [K in keyof Omit<ListRecoveryPointsByResourceInput, "ResourceArn"> & keyof ListRecoveryPointsByResourceInput & keyof ListRecoveryPointsByResourceInput]: (Omit<ListRecoveryPointsByResourceInput, "ResourceArn"> & ListRecoveryPointsByResourceInput & ListRecoveryPointsByResourceInput)[K]
    }>): ListRecoveryPointsByResourceOutput {
    ...
    invokeListTags(partialParams: ToOptional<{
      [K in keyof Omit<ListTagsInput, "ResourceArn"> & keyof ListTagsInput & keyof ListTagsInput]: (Omit<ListTagsInput, "ResourceArn"> & ListTagsInput & ListTagsInput)[K]
    }>): ListTagsOutput {
    ...
    invokePutBackupVaultNotifications(partialParams: ToOptional<{
      [K in keyof Omit<PutBackupVaultNotificationsInput, "SNSTopicArn"> & keyof PutBackupVaultNotificationsInput & keyof PutBackupVaultNotificationsInput]: (Omit<PutBackupVaultNotificationsInput, "SNSTopicArn"> & PutBackupVaultNotificationsInput & PutBackupVaultNotificationsInput)[K]
    }>): void {
    ...
    invokeStartBackupJob(partialParams: ToOptional<{
      [K in keyof Omit<StartBackupJobInput, "ResourceArn"> & keyof StartBackupJobInput & keyof StartBackupJobInput]: (Omit<StartBackupJobInput, "ResourceArn"> & StartBackupJobInput & StartBackupJobInput)[K]
    }>): StartBackupJobOutput {
    ...
    invokeStartCopyJob(partialParams: ToOptional<{
      [K in keyof Omit<StartCopyJobInput, "RecoveryPointArn"|"DestinationBackupVaultArn"> & keyof StartCopyJobInput & keyof StartCopyJobInput]: (Omit<StartCopyJobInput, "RecoveryPointArn"|"DestinationBackupVaultArn"> & StartCopyJobInput & StartCopyJobInput)[K]
    }>): StartCopyJobOutput {
    ...
    invokeStartRestoreJob(partialParams: ToOptional<{
      [K in keyof Omit<StartRestoreJobInput, "RecoveryPointArn"> & keyof StartRestoreJobInput & keyof StartRestoreJobInput]: (Omit<StartRestoreJobInput, "RecoveryPointArn"> & StartRestoreJobInput & StartRestoreJobInput)[K]
    }>): StartRestoreJobOutput {
    ...
    invokeTagResource(partialParams: ToOptional<{
      [K in keyof Omit<TagResourceInput, "ResourceArn"> & keyof TagResourceInput & keyof TagResourceInput]: (Omit<TagResourceInput, "ResourceArn"> & TagResourceInput & TagResourceInput)[K]
    }>): void {
    ...
    invokeUntagResource(partialParams: ToOptional<{
      [K in keyof Omit<UntagResourceInput, "ResourceArn"> & keyof UntagResourceInput & keyof UntagResourceInput]: (Omit<UntagResourceInput, "ResourceArn"> & UntagResourceInput & UntagResourceInput)[K]
    }>): void {
    ...
    invokeUpdateRecoveryPointLifecycle(partialParams: ToOptional<{
      [K in keyof Omit<UpdateRecoveryPointLifecycleInput, "RecoveryPointArn"> & keyof UpdateRecoveryPointLifecycleInput & keyof UpdateRecoveryPointLifecycleInput]: (Omit<UpdateRecoveryPointLifecycleInput, "RecoveryPointArn"> & UpdateRecoveryPointLifecycleInput & UpdateRecoveryPointLifecycleInput)[K]
    }>): UpdateRecoveryPointLifecycleOutput {
