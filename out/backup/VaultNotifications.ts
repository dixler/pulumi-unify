...
export default class extends aws.backup.VaultNotifications {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.backup.VaultNotifications>) {
        super(...args)
    ...
    invokeCreateBackupVault(partialParams: ToOptional<{
      [K in keyof CreateBackupVaultInput & keyof Omit<CreateBackupVaultInput, "BackupVaultName"> & keyof CreateBackupVaultInput]: (CreateBackupVaultInput & Omit<CreateBackupVaultInput, "BackupVaultName"> & CreateBackupVaultInput)[K]
    }>): CreateBackupVaultOutput {
    ...
    invokeDeleteBackupVaultAccessPolicy(partialParams: ToOptional<{
      [K in keyof DeleteBackupVaultAccessPolicyInput & keyof Omit<DeleteBackupVaultAccessPolicyInput, "BackupVaultName"> & keyof DeleteBackupVaultAccessPolicyInput]: (DeleteBackupVaultAccessPolicyInput & Omit<DeleteBackupVaultAccessPolicyInput, "BackupVaultName"> & DeleteBackupVaultAccessPolicyInput)[K]
    }>): void {
    ...
    invokeDeleteBackupVaultLockConfiguration(partialParams: ToOptional<{
      [K in keyof DeleteBackupVaultLockConfigurationInput & keyof Omit<DeleteBackupVaultLockConfigurationInput, "BackupVaultName"> & keyof DeleteBackupVaultLockConfigurationInput]: (DeleteBackupVaultLockConfigurationInput & Omit<DeleteBackupVaultLockConfigurationInput, "BackupVaultName"> & DeleteBackupVaultLockConfigurationInput)[K]
    }>): void {
    ...
    invokeDeleteBackupVaultNotifications(partialParams: ToOptional<{
      [K in keyof DeleteBackupVaultNotificationsInput & keyof Omit<DeleteBackupVaultNotificationsInput, "BackupVaultName"> & keyof DeleteBackupVaultNotificationsInput]: (DeleteBackupVaultNotificationsInput & Omit<DeleteBackupVaultNotificationsInput, "BackupVaultName"> & DeleteBackupVaultNotificationsInput)[K]
    }>): void {
    ...
    invokeDeleteRecoveryPoint(partialParams: ToOptional<{
      [K in keyof DeleteRecoveryPointInput & keyof Omit<DeleteRecoveryPointInput, "BackupVaultName"> & keyof DeleteRecoveryPointInput]: (DeleteRecoveryPointInput & Omit<DeleteRecoveryPointInput, "BackupVaultName"> & DeleteRecoveryPointInput)[K]
    }>): void {
    ...
    invokeDescribeRecoveryPoint(partialParams: ToOptional<{
      [K in keyof DescribeRecoveryPointInput & keyof Omit<DescribeRecoveryPointInput, "BackupVaultName"> & keyof DescribeRecoveryPointInput]: (DescribeRecoveryPointInput & Omit<DescribeRecoveryPointInput, "BackupVaultName"> & DescribeRecoveryPointInput)[K]
    }>): DescribeRecoveryPointOutput {
    ...
    invokeDisassociateRecoveryPoint(partialParams: ToOptional<{
      [K in keyof DisassociateRecoveryPointInput & keyof Omit<DisassociateRecoveryPointInput, "BackupVaultName"> & keyof DisassociateRecoveryPointInput]: (DisassociateRecoveryPointInput & Omit<DisassociateRecoveryPointInput, "BackupVaultName"> & DisassociateRecoveryPointInput)[K]
    }>): void {
    ...
    invokeGetBackupVaultAccessPolicy(partialParams: ToOptional<{
      [K in keyof GetBackupVaultAccessPolicyInput & keyof Omit<GetBackupVaultAccessPolicyInput, "BackupVaultName"> & keyof GetBackupVaultAccessPolicyInput]: (GetBackupVaultAccessPolicyInput & Omit<GetBackupVaultAccessPolicyInput, "BackupVaultName"> & GetBackupVaultAccessPolicyInput)[K]
    }>): GetBackupVaultAccessPolicyOutput {
    ...
    invokeGetBackupVaultNotifications(partialParams: ToOptional<{
      [K in keyof GetBackupVaultNotificationsInput & keyof Omit<GetBackupVaultNotificationsInput, "BackupVaultName"> & keyof GetBackupVaultNotificationsInput]: (GetBackupVaultNotificationsInput & Omit<GetBackupVaultNotificationsInput, "BackupVaultName"> & GetBackupVaultNotificationsInput)[K]
    }>): GetBackupVaultNotificationsOutput {
    ...
    invokeGetRecoveryPointRestoreMetadata(partialParams: ToOptional<{
      [K in keyof GetRecoveryPointRestoreMetadataInput & keyof Omit<GetRecoveryPointRestoreMetadataInput, "BackupVaultName"> & keyof GetRecoveryPointRestoreMetadataInput]: (GetRecoveryPointRestoreMetadataInput & Omit<GetRecoveryPointRestoreMetadataInput, "BackupVaultName"> & GetRecoveryPointRestoreMetadataInput)[K]
    }>): GetRecoveryPointRestoreMetadataOutput {
    ...
    invokeListRecoveryPointsByBackupVault(partialParams: ToOptional<{
      [K in keyof ListRecoveryPointsByBackupVaultInput & keyof Omit<ListRecoveryPointsByBackupVaultInput, "BackupVaultName"> & keyof ListRecoveryPointsByBackupVaultInput]: (ListRecoveryPointsByBackupVaultInput & Omit<ListRecoveryPointsByBackupVaultInput, "BackupVaultName"> & ListRecoveryPointsByBackupVaultInput)[K]
    }>): ListRecoveryPointsByBackupVaultOutput {
    ...
    invokePutBackupVaultAccessPolicy(partialParams: ToOptional<{
      [K in keyof PutBackupVaultAccessPolicyInput & keyof Omit<PutBackupVaultAccessPolicyInput, "BackupVaultName"> & keyof PutBackupVaultAccessPolicyInput]: (PutBackupVaultAccessPolicyInput & Omit<PutBackupVaultAccessPolicyInput, "BackupVaultName"> & PutBackupVaultAccessPolicyInput)[K]
    }>): void {
    ...
    invokePutBackupVaultLockConfiguration(partialParams: ToOptional<{
      [K in keyof PutBackupVaultLockConfigurationInput & keyof Omit<PutBackupVaultLockConfigurationInput, "BackupVaultName"> & keyof PutBackupVaultLockConfigurationInput]: (PutBackupVaultLockConfigurationInput & Omit<PutBackupVaultLockConfigurationInput, "BackupVaultName"> & PutBackupVaultLockConfigurationInput)[K]
    }>): void {
    ...
    invokePutBackupVaultNotifications(partialParams: ToOptional<{
      [K in keyof PutBackupVaultNotificationsInput & keyof Omit<PutBackupVaultNotificationsInput, "BackupVaultName"> & keyof Omit<PutBackupVaultNotificationsInput, "SNSTopicArn">]: (PutBackupVaultNotificationsInput & Omit<PutBackupVaultNotificationsInput, "BackupVaultName"> & Omit<PutBackupVaultNotificationsInput, "SNSTopicArn">)[K]
    }>): void {
    ...
    invokeStartBackupJob(partialParams: ToOptional<{
      [K in keyof StartBackupJobInput & keyof Omit<StartBackupJobInput, "BackupVaultName"> & keyof StartBackupJobInput]: (StartBackupJobInput & Omit<StartBackupJobInput, "BackupVaultName"> & StartBackupJobInput)[K]
    }>): StartBackupJobOutput {
    ...
    invokeStartCopyJob(partialParams: ToOptional<{
      [K in keyof StartCopyJobInput & keyof Omit<StartCopyJobInput, "SourceBackupVaultName"> & keyof StartCopyJobInput]: (StartCopyJobInput & Omit<StartCopyJobInput, "SourceBackupVaultName"> & StartCopyJobInput)[K]
    }>): StartCopyJobOutput {
    ...
    invokeStartRestoreJob(partialParams: ToOptional<{
      [K in keyof StartRestoreJobInput & keyof StartRestoreJobInput & keyof StartRestoreJobInput]: (StartRestoreJobInput & StartRestoreJobInput & StartRestoreJobInput)[K]
    }>): StartRestoreJobOutput {
    ...
    invokeUpdateRecoveryPointLifecycle(partialParams: ToOptional<{
      [K in keyof UpdateRecoveryPointLifecycleInput & keyof Omit<UpdateRecoveryPointLifecycleInput, "BackupVaultName"> & keyof UpdateRecoveryPointLifecycleInput]: (UpdateRecoveryPointLifecycleInput & Omit<UpdateRecoveryPointLifecycleInput, "BackupVaultName"> & UpdateRecoveryPointLifecycleInput)[K]
    }>): UpdateRecoveryPointLifecycleOutput {
