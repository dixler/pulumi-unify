...
export default class extends aws.datasync.NfsLocation {
    ...
    invokeCreateLocationFsxLustre(partialParams: ToOptional<{
      [K in keyof CreateLocationFsxLustreRequest]: (CreateLocationFsxLustreRequest)[K]
    ...
    invokeCreateLocationFsxWindows(partialParams: ToOptional<{
      [K in keyof CreateLocationFsxWindowsRequest]: (CreateLocationFsxWindowsRequest)[K]
    ...
    invokeCreateLocationSmb(partialParams: ToOptional<{
      [K in keyof CreateLocationSmbRequest & keyof Omit<CreateLocationSmbRequest, "Subdirectory" | "ServerHostname">]: (CreateLocationSmbRequest)[K]
