...
export default class extends aws.guardduty.ThreatIntelSet {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.guardduty.ThreatIntelSet>) {
        super(...args)
        this.booted = false;
    ...
    invokeCreateIPSet(partialParams: ToOptional<{
      [K in keyof CreateIPSetRequest & keyof Omit<CreateIPSetRequest, "DetectorId" | "Name" | "Format" | "Location">]: (CreateIPSetRequest)[K]
    ...
    invokeCreateThreatIntelSet(partialParams: ToOptional<{
      [K in keyof CreateThreatIntelSetRequest & keyof Omit<CreateThreatIntelSetRequest, "DetectorId" | "Name" | "Format" | "Location">]: (CreateThreatIntelSetRequest)[K]
