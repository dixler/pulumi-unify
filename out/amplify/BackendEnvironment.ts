...
export default class extends aws.amplify.BackendEnvironment {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.amplify.BackendEnvironment>) {
        super(...args)
    ...
    invokeCreateBranch(partialParams: ToOptional<{
      [K in keyof Omit<CreateBranchRequest, "appId"> & keyof CreateBranchRequest & keyof CreateBranchRequest & keyof CreateBranchRequest & keyof CreateBranchRequest]: (Omit<CreateBranchRequest, "appId"> & CreateBranchRequest & CreateBranchRequest & CreateBranchRequest & CreateBranchRequest)[K]
    ...
    invokeCreateDeployment(partialParams: ToOptional<{
      [K in keyof Omit<CreateDeploymentRequest, "appId"> & keyof CreateDeploymentRequest & keyof CreateDeploymentRequest & keyof CreateDeploymentRequest & keyof CreateDeploymentRequest]: (Omit<CreateDeploymentRequest, "appId"> & CreateDeploymentRequest & CreateDeploymentRequest & CreateDeploymentRequest & CreateDeploymentRequest)[K]
    ...
    invokeCreateWebhook(partialParams: ToOptional<{
      [K in keyof Omit<CreateWebhookRequest, "appId"> & keyof CreateWebhookRequest & keyof CreateWebhookRequest & keyof CreateWebhookRequest & keyof CreateWebhookRequest]: (Omit<CreateWebhookRequest, "appId"> & CreateWebhookRequest & CreateWebhookRequest & CreateWebhookRequest & CreateWebhookRequest)[K]
    ...
    invokeDeleteBranch(partialParams: ToOptional<{
      [K in keyof Omit<DeleteBranchRequest, "appId"> & keyof DeleteBranchRequest & keyof DeleteBranchRequest & keyof DeleteBranchRequest & keyof DeleteBranchRequest]: (Omit<DeleteBranchRequest, "appId"> & DeleteBranchRequest & DeleteBranchRequest & DeleteBranchRequest & DeleteBranchRequest)[K]
    ...
    invokeDeleteJob(partialParams: ToOptional<{
      [K in keyof Omit<DeleteJobRequest, "appId"> & keyof DeleteJobRequest & keyof DeleteJobRequest & keyof DeleteJobRequest & keyof DeleteJobRequest]: (Omit<DeleteJobRequest, "appId"> & DeleteJobRequest & DeleteJobRequest & DeleteJobRequest & DeleteJobRequest)[K]
    ...
    invokeGetBranch(partialParams: ToOptional<{
      [K in keyof Omit<GetBranchRequest, "appId"> & keyof GetBranchRequest & keyof GetBranchRequest & keyof GetBranchRequest & keyof GetBranchRequest]: (Omit<GetBranchRequest, "appId"> & GetBranchRequest & GetBranchRequest & GetBranchRequest & GetBranchRequest)[K]
    ...
    invokeGetJob(partialParams: ToOptional<{
      [K in keyof Omit<GetJobRequest, "appId"> & keyof GetJobRequest & keyof GetJobRequest & keyof GetJobRequest & keyof GetJobRequest]: (Omit<GetJobRequest, "appId"> & GetJobRequest & GetJobRequest & GetJobRequest & GetJobRequest)[K]
    ...
    invokeListArtifacts(partialParams: ToOptional<{
      [K in keyof Omit<ListArtifactsRequest, "appId"> & keyof ListArtifactsRequest & keyof ListArtifactsRequest & keyof ListArtifactsRequest & keyof ListArtifactsRequest]: (Omit<ListArtifactsRequest, "appId"> & ListArtifactsRequest & ListArtifactsRequest & ListArtifactsRequest & ListArtifactsRequest)[K]
    ...
    invokeListJobs(partialParams: ToOptional<{
      [K in keyof Omit<ListJobsRequest, "appId"> & keyof ListJobsRequest & keyof ListJobsRequest & keyof ListJobsRequest & keyof ListJobsRequest]: (Omit<ListJobsRequest, "appId"> & ListJobsRequest & ListJobsRequest & ListJobsRequest & ListJobsRequest)[K]
    ...
    invokeStartDeployment(partialParams: ToOptional<{
      [K in keyof Omit<StartDeploymentRequest, "appId"> & keyof StartDeploymentRequest & keyof StartDeploymentRequest & keyof StartDeploymentRequest & keyof StartDeploymentRequest]: (Omit<StartDeploymentRequest, "appId"> & StartDeploymentRequest & StartDeploymentRequest & StartDeploymentRequest & StartDeploymentRequest)[K]
    ...
    invokeStartJob(partialParams: ToOptional<{
      [K in keyof Omit<StartJobRequest, "appId"> & keyof StartJobRequest & keyof StartJobRequest & keyof StartJobRequest & keyof StartJobRequest]: (Omit<StartJobRequest, "appId"> & StartJobRequest & StartJobRequest & StartJobRequest & StartJobRequest)[K]
    ...
    invokeStopJob(partialParams: ToOptional<{
      [K in keyof Omit<StopJobRequest, "appId"> & keyof StopJobRequest & keyof StopJobRequest & keyof StopJobRequest & keyof StopJobRequest]: (Omit<StopJobRequest, "appId"> & StopJobRequest & StopJobRequest & StopJobRequest & StopJobRequest)[K]
    ...
    invokeUpdateBranch(partialParams: ToOptional<{
      [K in keyof Omit<UpdateBranchRequest, "appId"> & keyof UpdateBranchRequest & keyof UpdateBranchRequest & keyof UpdateBranchRequest & keyof UpdateBranchRequest]: (Omit<UpdateBranchRequest, "appId"> & UpdateBranchRequest & UpdateBranchRequest & UpdateBranchRequest & UpdateBranchRequest)[K]
