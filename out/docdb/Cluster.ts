...
export default class extends aws.docdb.Cluster {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.docdb.Cluster>) {
        super(...args)
    ...
    invokeCreateGlobalCluster(partialParams: ToOptional<{
      [K in keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage]: (CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage)[K]
    }>): CreateGlobalClusterResult {
    ...
    invokeModifyGlobalCluster(partialParams: ToOptional<{
      [K in keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof Omit<ModifyGlobalClusterMessage, "GlobalClusterIdentifier"> & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage]: (ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & Omit<ModifyGlobalClusterMessage, "GlobalClusterIdentifier"> & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage)[K]
    }>): ModifyGlobalClusterResult {
    ...
    invokeRemoveFromGlobalCluster(partialParams: ToOptional<{
      [K in keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof Omit<RemoveFromGlobalClusterMessage, "GlobalClusterIdentifier"> & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage]: (RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & Omit<RemoveFromGlobalClusterMessage, "GlobalClusterIdentifier"> & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage)[K]
    }>): RemoveFromGlobalClusterResult {
