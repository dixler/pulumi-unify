...
export default class extends aws.docdb.ClusterParameterGroup {
    ...
    invokeCreateGlobalCluster(partialParams: ToOptional<{
      [K in keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage & keyof CreateGlobalClusterMessage]: (CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage & CreateGlobalClusterMessage)[K]
    ...
    invokeModifyGlobalCluster(partialParams: ToOptional<{
      [K in keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage & keyof ModifyGlobalClusterMessage]: (ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage & ModifyGlobalClusterMessage)[K]
    ...
    invokeRemoveFromGlobalCluster(partialParams: ToOptional<{
      [K in keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage & keyof RemoveFromGlobalClusterMessage]: (RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage & RemoveFromGlobalClusterMessage)[K]
