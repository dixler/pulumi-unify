...
export default class extends aws.appconfig.ConfigurationProfile {
    ...
    invokeGetDeploymentStrategy(partialParams: ToOptional<{
      [K in keyof GetDeploymentStrategyRequest & keyof GetDeploymentStrategyRequest & keyof GetDeploymentStrategyRequest & keyof GetDeploymentStrategyRequest & keyof GetDeploymentStrategyRequest & keyof GetDeploymentStrategyRequest & keyof GetDeploymentStrategyRequest & keyof GetDeploymentStrategyRequest]: (GetDeploymentStrategyRequest & GetDeploymentStrategyRequest & GetDeploymentStrategyRequest & GetDeploymentStrategyRequest & GetDeploymentStrategyRequest & GetDeploymentStrategyRequest & GetDeploymentStrategyRequest & GetDeploymentStrategyRequest)[K]
    }>): Request<DeploymentStrategy, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeListDeployments(partialParams: ToOptional<{
      [K in keyof Omit<ListDeploymentsRequest, "ApplicationId"> & keyof ListDeploymentsRequest & keyof ListDeploymentsRequest & keyof ListDeploymentsRequest & keyof ListDeploymentsRequest & keyof ListDeploymentsRequest & keyof ListDeploymentsRequest & keyof ListDeploymentsRequest]: (Omit<ListDeploymentsRequest, "ApplicationId"> & ListDeploymentsRequest & ListDeploymentsRequest & ListDeploymentsRequest & ListDeploymentsRequest & ListDeploymentsRequest & ListDeploymentsRequest & ListDeploymentsRequest)[K]
    ...
    invokeStartDeployment(partialParams: ToOptional<{
      [K in keyof Omit<StartDeploymentRequest, "ApplicationId"> & keyof StartDeploymentRequest & keyof Omit<StartDeploymentRequest, "ConfigurationProfileId"> & keyof StartDeploymentRequest & keyof StartDeploymentRequest & keyof StartDeploymentRequest & keyof StartDeploymentRequest & keyof StartDeploymentRequest]: (Omit<StartDeploymentRequest, "ApplicationId"> & StartDeploymentRequest & Omit<StartDeploymentRequest, "ConfigurationProfileId"> & StartDeploymentRequest & StartDeploymentRequest & StartDeploymentRequest & StartDeploymentRequest & StartDeploymentRequest)[K]
    }>): Request<Deployment, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeStopDeployment(partialParams: ToOptional<{
      [K in keyof Omit<StopDeploymentRequest, "ApplicationId"> & keyof StopDeploymentRequest & keyof StopDeploymentRequest & keyof StopDeploymentRequest & keyof StopDeploymentRequest & keyof StopDeploymentRequest & keyof StopDeploymentRequest & keyof StopDeploymentRequest]: (Omit<StopDeploymentRequest, "ApplicationId"> & StopDeploymentRequest & StopDeploymentRequest & StopDeploymentRequest & StopDeploymentRequest & StopDeploymentRequest & StopDeploymentRequest & StopDeploymentRequest)[K]
    }>): Request<Deployment, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateDeploymentStrategy(partialParams: ToOptional<{
      [K in keyof UpdateDeploymentStrategyRequest & keyof UpdateDeploymentStrategyRequest & keyof UpdateDeploymentStrategyRequest & keyof UpdateDeploymentStrategyRequest & keyof UpdateDeploymentStrategyRequest & keyof UpdateDeploymentStrategyRequest & keyof UpdateDeploymentStrategyRequest & keyof UpdateDeploymentStrategyRequest]: (UpdateDeploymentStrategyRequest & UpdateDeploymentStrategyRequest & UpdateDeploymentStrategyRequest & UpdateDeploymentStrategyRequest & UpdateDeploymentStrategyRequest & UpdateDeploymentStrategyRequest & UpdateDeploymentStrategyRequest & UpdateDeploymentStrategyRequest)[K]
    }>): Request<DeploymentStrategy, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
    ...
    invokeUpdateEnvironment(partialParams: ToOptional<{
      [K in keyof Omit<UpdateEnvironmentRequest, "ApplicationId"> & keyof UpdateEnvironmentRequest & keyof UpdateEnvironmentRequest & keyof UpdateEnvironmentRequest & keyof UpdateEnvironmentRequest & keyof UpdateEnvironmentRequest & keyof UpdateEnvironmentRequest & keyof UpdateEnvironmentRequest]: (Omit<UpdateEnvironmentRequest, "ApplicationId"> & UpdateEnvironmentRequest & UpdateEnvironmentRequest & UpdateEnvironmentRequest & UpdateEnvironmentRequest & UpdateEnvironmentRequest & UpdateEnvironmentRequest & UpdateEnvironmentRequest)[K]
    }>): Request<Environment, AWSError> {
        //console.log(this.capitalizedParams['Bucket'])
        //console.log(this.capitalizedParams['Bucket'].value)
        this.boot();
