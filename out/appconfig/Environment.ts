...
export default class extends aws.appconfig.Environment {
    ...
    invokeCreateConfigurationProfile(partialParams: ToOptional<{
      [K in keyof CreateConfigurationProfileRequest & keyof Omit<CreateConfigurationProfileRequest, "ApplicationId" | "Name">]: (CreateConfigurationProfileRequest)[K]
    ...
    invokeCreateHostedConfigurationVersion(partialParams: ToOptional<{
      [K in keyof CreateHostedConfigurationVersionRequest & keyof Omit<CreateHostedConfigurationVersionRequest, "ApplicationId">]: (CreateHostedConfigurationVersionRequest)[K]
    ...
    invokeGetConfigurationProfile(partialParams: ToOptional<{
      [K in keyof GetConfigurationProfileRequest & keyof Omit<GetConfigurationProfileRequest, "ApplicationId">]: (GetConfigurationProfileRequest)[K]
    }>): Request<ConfigurationProfile, AWSError> {
        this.boot();
    ...
    invokeGetHostedConfigurationVersion(partialParams: ToOptional<{
      [K in keyof GetHostedConfigurationVersionRequest & keyof Omit<GetHostedConfigurationVersionRequest, "ApplicationId">]: (GetHostedConfigurationVersionRequest)[K]
    }>): Request<HostedConfigurationVersion, AWSError> {
        this.boot();
    ...
    invokeListHostedConfigurationVersions(partialParams: ToOptional<{
      [K in keyof ListHostedConfigurationVersionsRequest & keyof Omit<ListHostedConfigurationVersionsRequest, "ApplicationId">]: (ListHostedConfigurationVersionsRequest)[K]
    ...
    invokeStartDeployment(partialParams: ToOptional<{
      [K in keyof StartDeploymentRequest & keyof Omit<StartDeploymentRequest, "ApplicationId" | "EnvironmentId">]: (StartDeploymentRequest)[K]
    }>): Request<Deployment, AWSError> {
        this.boot();
    ...
    invokeUpdateConfigurationProfile(partialParams: ToOptional<{
      [K in keyof UpdateConfigurationProfileRequest & keyof Omit<UpdateConfigurationProfileRequest, "ApplicationId">]: (UpdateConfigurationProfileRequest)[K]
    }>): Request<ConfigurationProfile, AWSError> {
        this.boot();
