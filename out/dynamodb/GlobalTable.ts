...
export default class extends aws.dynamodb.GlobalTable {
    ...
    invokeUpdateContinuousBackups(partialParams: ToOptional<{
      [K in keyof UpdateContinuousBackupsInput & keyof UpdateContinuousBackupsInput]: (UpdateContinuousBackupsInput & UpdateContinuousBackupsInput)[K]
    }>): UpdateContinuousBackupsOutput {
    ...
    invokeUpdateContributorInsights(partialParams: ToOptional<{
      [K in keyof UpdateContributorInsightsInput & keyof UpdateContributorInsightsInput]: (UpdateContributorInsightsInput & UpdateContributorInsightsInput)[K]
    }>): UpdateContributorInsightsOutput {
    ...
    invokeUpdateGlobalTable(partialParams: ToOptional<{
      [K in keyof UpdateGlobalTableInput & keyof UpdateGlobalTableInput]: (UpdateGlobalTableInput & UpdateGlobalTableInput)[K]
    }>): UpdateGlobalTableOutput {
    ...
    invokeUpdateGlobalTableSettings(partialParams: ToOptional<{
      [K in keyof UpdateGlobalTableSettingsInput & keyof UpdateGlobalTableSettingsInput]: (UpdateGlobalTableSettingsInput & UpdateGlobalTableSettingsInput)[K]
    }>): UpdateGlobalTableSettingsOutput {
    ...
    invokeUpdateItem(partialParams: ToOptional<{
      [K in keyof UpdateItemInput & keyof UpdateItemInput]: (UpdateItemInput & UpdateItemInput)[K]
    }>): UpdateItemOutput {
    ...
    invokeUpdateTable(partialParams: ToOptional<{
      [K in keyof UpdateTableInput & keyof UpdateTableInput]: (UpdateTableInput & UpdateTableInput)[K]
    }>): UpdateTableOutput {
    ...
    invokeUpdateTableReplicaAutoScaling(partialParams: ToOptional<{
      [K in keyof UpdateTableReplicaAutoScalingInput & keyof UpdateTableReplicaAutoScalingInput]: (UpdateTableReplicaAutoScalingInput & UpdateTableReplicaAutoScalingInput)[K]
    }>): UpdateTableReplicaAutoScalingOutput {
    ...
    invokeUpdateTimeToLive(partialParams: ToOptional<{
      [K in keyof UpdateTimeToLiveInput & keyof UpdateTimeToLiveInput]: (UpdateTimeToLiveInput & UpdateTimeToLiveInput)[K]
    }>): UpdateTimeToLiveOutput {
