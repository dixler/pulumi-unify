...
export default class extends aws.kms.ExternalKey {
    ...
    invokeCancelKeyDeletion(partialParams: ToOptional<{
      [K in keyof CancelKeyDeletionRequest]: (CancelKeyDeletionRequest)[K]
    ...
    invokeCreateGrant(partialParams: ToOptional<{
      [K in keyof CreateGrantRequest]: (CreateGrantRequest)[K]
    ...
    invokeDescribeKey(partialParams: ToOptional<{
      [K in keyof DescribeKeyRequest]: (DescribeKeyRequest)[K]
    ...
    invokeEncrypt(partialParams: ToOptional<{
      [K in keyof EncryptRequest]: (EncryptRequest)[K]
    ...
    invokeGenerateDataKey(partialParams: ToOptional<{
      [K in keyof GenerateDataKeyRequest]: (GenerateDataKeyRequest)[K]
    ...
    invokeGenerateDataKeyPair(partialParams: ToOptional<{
      [K in keyof GenerateDataKeyPairRequest]: (GenerateDataKeyPairRequest)[K]
    ...
    invokeGenerateDataKeyPairWithoutPlaintext(partialParams: ToOptional<{
      [K in keyof GenerateDataKeyPairWithoutPlaintextRequest]: (GenerateDataKeyPairWithoutPlaintextRequest)[K]
    ...
    invokeGenerateDataKeyWithoutPlaintext(partialParams: ToOptional<{
      [K in keyof GenerateDataKeyWithoutPlaintextRequest]: (GenerateDataKeyWithoutPlaintextRequest)[K]
    ...
    invokeGetKeyPolicy(partialParams: ToOptional<{
      [K in keyof GetKeyPolicyRequest]: (GetKeyPolicyRequest)[K]
    ...
    invokeGetKeyRotationStatus(partialParams: ToOptional<{
      [K in keyof GetKeyRotationStatusRequest]: (GetKeyRotationStatusRequest)[K]
    ...
    invokeGetParametersForImport(partialParams: ToOptional<{
      [K in keyof GetParametersForImportRequest]: (GetParametersForImportRequest)[K]
    ...
    invokeImportKeyMaterial(partialParams: ToOptional<{
      [K in keyof ImportKeyMaterialRequest]: (ImportKeyMaterialRequest)[K]
    ...
    invokeListGrants(partialParams: ToOptional<{
      [K in keyof ListGrantsRequest]: (ListGrantsRequest)[K]
    ...
    invokeListKeyPolicies(partialParams: ToOptional<{
      [K in keyof ListKeyPoliciesRequest]: (ListKeyPoliciesRequest)[K]
    ...
    invokeListResourceTags(partialParams: ToOptional<{
      [K in keyof ListResourceTagsRequest]: (ListResourceTagsRequest)[K]
    ...
    invokeReplicateKey(partialParams: ToOptional<{
      [K in keyof ReplicateKeyRequest]: (ReplicateKeyRequest)[K]
    ...
    invokeScheduleKeyDeletion(partialParams: ToOptional<{
      [K in keyof ScheduleKeyDeletionRequest]: (ScheduleKeyDeletionRequest)[K]
    ...
    invokeSign(partialParams: ToOptional<{
      [K in keyof SignRequest]: (SignRequest)[K]
    ...
    invokeVerify(partialParams: ToOptional<{
      [K in keyof VerifyRequest]: (VerifyRequest)[K]
