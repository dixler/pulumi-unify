...
export default class extends aws.kms.Grant {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.kms.Grant>) {
        super(...args)
    ...
    invokePutKeyPolicy(partialParams: ToOptional<{
      [K in keyof PutKeyPolicyRequest & keyof PutKeyPolicyRequest & keyof PutKeyPolicyRequest & keyof Omit<PutKeyPolicyRequest, "KeyId"> & keyof PutKeyPolicyRequest & keyof PutKeyPolicyRequest]: (PutKeyPolicyRequest & PutKeyPolicyRequest & PutKeyPolicyRequest & Omit<PutKeyPolicyRequest, "KeyId"> & PutKeyPolicyRequest & PutKeyPolicyRequest)[K]
    }>): void {
    ...
    invokeRevokeGrant(partialParams: ToOptional<{
      [K in keyof Omit<RevokeGrantRequest, "GrantId"> & keyof RevokeGrantRequest & keyof RevokeGrantRequest & keyof Omit<RevokeGrantRequest, "KeyId"> & keyof RevokeGrantRequest & keyof RevokeGrantRequest]: (Omit<RevokeGrantRequest, "GrantId"> & RevokeGrantRequest & RevokeGrantRequest & Omit<RevokeGrantRequest, "KeyId"> & RevokeGrantRequest & RevokeGrantRequest)[K]
    }>): void {
    ...
    invokeUpdateKeyDescription(partialParams: ToOptional<{
      [K in keyof UpdateKeyDescriptionRequest & keyof UpdateKeyDescriptionRequest & keyof UpdateKeyDescriptionRequest & keyof Omit<UpdateKeyDescriptionRequest, "KeyId"> & keyof UpdateKeyDescriptionRequest & keyof UpdateKeyDescriptionRequest]: (UpdateKeyDescriptionRequest & UpdateKeyDescriptionRequest & UpdateKeyDescriptionRequest & Omit<UpdateKeyDescriptionRequest, "KeyId"> & UpdateKeyDescriptionRequest & UpdateKeyDescriptionRequest)[K]
    }>): void {
