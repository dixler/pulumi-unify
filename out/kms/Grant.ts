...
export default class extends aws.kms.Grant {
    ...
    invokeCreateGrant(partialParams: ToOptional<{
      [K in keyof CreateGrantRequest & keyof Omit<CreateGrantRequest, "KeyId" | "GranteePrincipal">]: (CreateGrantRequest)[K]
    ...
    invokeListRetirableGrants(partialParams: ToOptional<{
      [K in keyof ListRetirableGrantsRequest & keyof Omit<ListRetirableGrantsRequest, "RetiringPrincipal">]: (ListRetirableGrantsRequest)[K]
    }>): Request<ListGrantsResponse, AWSError> {
        this.boot();
