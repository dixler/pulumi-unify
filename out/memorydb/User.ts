...
export default class extends aws.memorydb.User {
    ...
    invokeCreateUser(partialParams: ToOptional<{
      [K in keyof Omit<CreateUserRequest, "AccessString"> & keyof CreateUserRequest & keyof CreateUserRequest & keyof CreateUserRequest]: (Omit<CreateUserRequest, "AccessString"> & CreateUserRequest & CreateUserRequest & CreateUserRequest)[K]
    }>): CreateUserResponse {
