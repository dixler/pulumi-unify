...
export default class extends aws.schemas.Discoverer {
    ...
    invokeCreateDiscoverer(partialParams: ToOptional<{
      [K in keyof CreateDiscovererRequest & keyof Omit<CreateDiscovererRequest, "SourceArn">]: (CreateDiscovererRequest)[K]
    ...
    invokeCreateRegistry(partialParams: ToOptional<{
      [K in keyof CreateRegistryRequest]: (CreateRegistryRequest)[K]
    ...
    invokeCreateSchema(partialParams: ToOptional<{
      [K in keyof CreateSchemaRequest]: (CreateSchemaRequest)[K]
    ...
    invokeDescribeCodeBinding(partialParams: ToOptional<{
      [K in keyof DescribeCodeBindingRequest]: (DescribeCodeBindingRequest)[K]
    ...
    invokeDescribeSchema(partialParams: ToOptional<{
      [K in keyof DescribeSchemaRequest]: (DescribeSchemaRequest)[K]
    ...
    invokeExportSchema(partialParams: ToOptional<{
      [K in keyof ExportSchemaRequest]: (ExportSchemaRequest)[K]
    ...
    invokeGetCodeBindingSource(partialParams: ToOptional<{
      [K in keyof GetCodeBindingSourceRequest]: (GetCodeBindingSourceRequest)[K]
    ...
    invokeListSchemaVersions(partialParams: ToOptional<{
      [K in keyof ListSchemaVersionsRequest]: (ListSchemaVersionsRequest)[K]
    ...
    invokeListSchemas(partialParams: ToOptional<{
      [K in keyof ListSchemasRequest]: (ListSchemasRequest)[K]
    ...
    invokePutCodeBinding(partialParams: ToOptional<{
      [K in keyof PutCodeBindingRequest]: (PutCodeBindingRequest)[K]
    ...
    invokeSearchSchemas(partialParams: ToOptional<{
      [K in keyof SearchSchemasRequest]: (SearchSchemasRequest)[K]
    ...
    invokeUpdateRegistry(partialParams: ToOptional<{
      [K in keyof UpdateRegistryRequest]: (UpdateRegistryRequest)[K]
    ...
    invokeUpdateSchema(partialParams: ToOptional<{
      [K in keyof UpdateSchemaRequest]: (UpdateSchemaRequest)[K]
