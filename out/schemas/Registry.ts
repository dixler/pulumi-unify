...
export default class extends aws.schemas.Registry {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.schemas.Registry>) {
        super(...args)
        this.booted = false;
    ...
    invokeCreateSchema(partialParams: ToOptional<{
      [K in keyof CreateSchemaRequest & keyof Omit<CreateSchemaRequest, "RegistryName">]: (CreateSchemaRequest)[K]
    ...
    invokeDescribeCodeBinding(partialParams: ToOptional<{
      [K in keyof DescribeCodeBindingRequest & keyof Omit<DescribeCodeBindingRequest, "RegistryName">]: (DescribeCodeBindingRequest)[K]
    ...
    invokeDescribeSchema(partialParams: ToOptional<{
      [K in keyof DescribeSchemaRequest & keyof Omit<DescribeSchemaRequest, "RegistryName">]: (DescribeSchemaRequest)[K]
    ...
    invokeExportSchema(partialParams: ToOptional<{
      [K in keyof ExportSchemaRequest & keyof Omit<ExportSchemaRequest, "RegistryName">]: (ExportSchemaRequest)[K]
    ...
    invokeGetCodeBindingSource(partialParams: ToOptional<{
      [K in keyof GetCodeBindingSourceRequest & keyof Omit<GetCodeBindingSourceRequest, "RegistryName">]: (GetCodeBindingSourceRequest)[K]
    ...
    invokeUpdateSchema(partialParams: ToOptional<{
      [K in keyof UpdateSchemaRequest & keyof Omit<UpdateSchemaRequest, "RegistryName">]: (UpdateSchemaRequest)[K]
