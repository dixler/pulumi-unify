...
export default class extends aws.iam.Policy {
    ...
    invokeCreatePolicy(partialParams: ToOptional<{
      [K in keyof CreatePolicyRequest & keyof Omit<CreatePolicyRequest, "PolicyName">]: (CreatePolicyRequest)[K]
    ...
    invokeCreatePolicyVersion(partialParams: ToOptional<{
      [K in keyof CreatePolicyVersionRequest & keyof Omit<CreatePolicyVersionRequest, "PolicyArn">]: (CreatePolicyVersionRequest)[K]
    ...
    invokeGetGroupPolicy(partialParams: ToOptional<{
      [K in keyof GetGroupPolicyRequest & keyof Omit<GetGroupPolicyRequest, "PolicyName">]: (GetGroupPolicyRequest)[K]
    ...
    invokeGetPolicy(partialParams: ToOptional<{
      [K in keyof GetPolicyRequest & keyof Omit<GetPolicyRequest, "PolicyArn">]: (GetPolicyRequest)[K]
    ...
    invokeGetPolicyVersion(partialParams: ToOptional<{
      [K in keyof GetPolicyVersionRequest & keyof Omit<GetPolicyVersionRequest, "PolicyArn">]: (GetPolicyVersionRequest)[K]
    ...
    invokeGetRolePolicy(partialParams: ToOptional<{
      [K in keyof GetRolePolicyRequest & keyof Omit<GetRolePolicyRequest, "PolicyName">]: (GetRolePolicyRequest)[K]
    ...
    invokeGetUserPolicy(partialParams: ToOptional<{
      [K in keyof GetUserPolicyRequest & keyof Omit<GetUserPolicyRequest, "PolicyName">]: (GetUserPolicyRequest)[K]
    ...
    invokeListEntitiesForPolicy(partialParams: ToOptional<{
      [K in keyof ListEntitiesForPolicyRequest & keyof Omit<ListEntitiesForPolicyRequest, "PolicyArn">]: (ListEntitiesForPolicyRequest)[K]
    ...
    invokeListPolicyTags(partialParams: ToOptional<{
      [K in keyof ListPolicyTagsRequest & keyof Omit<ListPolicyTagsRequest, "PolicyArn">]: (ListPolicyTagsRequest)[K]
    ...
    invokeListPolicyVersions(partialParams: ToOptional<{
      [K in keyof ListPolicyVersionsRequest & keyof Omit<ListPolicyVersionsRequest, "PolicyArn">]: (ListPolicyVersionsRequest)[K]
