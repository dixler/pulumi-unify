...
export default class extends aws.iam.SamlProvider {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.iam.SamlProvider>) {
        super(...args)
    ...
    invokeUpdateSAMLProvider(partialParams: ToOptional<{
      [K in keyof UpdateSAMLProviderRequest & keyof UpdateSAMLProviderRequest & keyof Omit<UpdateSAMLProviderRequest, "SAMLMetadataDocument"> & keyof UpdateSAMLProviderRequest]: (UpdateSAMLProviderRequest & UpdateSAMLProviderRequest & Omit<UpdateSAMLProviderRequest, "SAMLMetadataDocument"> & UpdateSAMLProviderRequest)[K]
    }>): UpdateSAMLProviderResponse {
