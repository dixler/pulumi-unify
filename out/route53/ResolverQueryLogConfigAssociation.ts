...
export default class extends aws.route53.ResolverQueryLogConfigAssociation {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.route53.ResolverQueryLogConfigAssociation>) {
        super(...args)
    ...
    invokeTestDNSAnswer(partialParams: ToOptional<{
      [K in keyof TestDNSAnswerRequest & keyof Omit<TestDNSAnswerRequest, "HostedZoneId">]: (TestDNSAnswerRequest & Omit<TestDNSAnswerRequest, "HostedZoneId">)[K]
    ...
    invokeUpdateHostedZoneComment(partialParams: ToOptional<{
      [K in keyof UpdateHostedZoneCommentRequest & keyof Omit<UpdateHostedZoneCommentRequest, "Id">]: (UpdateHostedZoneCommentRequest & Omit<UpdateHostedZoneCommentRequest, "Id">)[K]
