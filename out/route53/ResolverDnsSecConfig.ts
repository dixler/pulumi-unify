...
export default class extends aws.route53.ResolverDnsSecConfig {
    ...
    invokeTestDNSAnswer(partialParams: ToOptional<{
      [K in keyof TestDNSAnswerRequest & keyof TestDNSAnswerRequest & keyof Omit<TestDNSAnswerRequest, "HostedZoneId"> & keyof TestDNSAnswerRequest]: (TestDNSAnswerRequest & TestDNSAnswerRequest & Omit<TestDNSAnswerRequest, "HostedZoneId"> & TestDNSAnswerRequest)[K]
    ...
    invokeUpdateHostedZoneComment(partialParams: ToOptional<{
      [K in keyof UpdateHostedZoneCommentRequest & keyof UpdateHostedZoneCommentRequest & keyof Omit<UpdateHostedZoneCommentRequest, "Id"> & keyof UpdateHostedZoneCommentRequest]: (UpdateHostedZoneCommentRequest & UpdateHostedZoneCommentRequest & Omit<UpdateHostedZoneCommentRequest, "Id"> & UpdateHostedZoneCommentRequest)[K]
