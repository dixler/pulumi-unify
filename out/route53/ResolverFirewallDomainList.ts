...
export default class extends aws.route53.ResolverFirewallDomainList {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    constructor(...args: ConstructorParameters<typeof aws.route53.ResolverFirewallDomainList>) {
        super(...args)
    ...
    invokeTestDNSAnswer(partialParams: ToOptional<{
      [K in keyof TestDNSAnswerRequest & keyof TestDNSAnswerRequest]: (TestDNSAnswerRequest & TestDNSAnswerRequest)[K]
