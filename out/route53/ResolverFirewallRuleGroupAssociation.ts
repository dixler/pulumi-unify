...
export default class extends aws.route53.ResolverFirewallRuleGroupAssociation {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.route53.ResolverFirewallRuleGroupAssociation>) {
        super(...args)
