...
export default class extends aws.route53.Zone {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.route53.Zone>) {
        super(...args)
        this.booted = false;
    ...
    invokeGetReusableDelegationSetLimit(partialParams: ToOptional<{
      [K in keyof GetReusableDelegationSetLimitRequest & keyof Omit<GetReusableDelegationSetLimitRequest, "DelegationSetId">]: (GetReusableDelegationSetLimitRequest)[K]
    ...
    invokeUpdateTrafficPolicyComment(partialParams: ToOptional<{
      [K in keyof UpdateTrafficPolicyCommentRequest & keyof Omit<UpdateTrafficPolicyCommentRequest, "Comment">]: (UpdateTrafficPolicyCommentRequest)[K]
