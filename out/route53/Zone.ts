...
export default class extends aws.route53.Zone {
    ...
    invokeUpdateTrafficPolicyComment(partialParams: ToOptional<{
      [K in keyof UpdateTrafficPolicyCommentRequest & keyof Omit<UpdateTrafficPolicyCommentRequest, "Comment"> & keyof UpdateTrafficPolicyCommentRequest & keyof UpdateTrafficPolicyCommentRequest & keyof UpdateTrafficPolicyCommentRequest]: (UpdateTrafficPolicyCommentRequest & Omit<UpdateTrafficPolicyCommentRequest, "Comment"> & UpdateTrafficPolicyCommentRequest & UpdateTrafficPolicyCommentRequest & UpdateTrafficPolicyCommentRequest)[K]
