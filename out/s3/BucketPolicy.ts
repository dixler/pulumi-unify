...
export default class extends aws.s3.BucketPolicy {
    private ops: any
    private client: any
    constructor(...args: ConstructorParameters<typeof aws.s3.BucketPolicy>) {
        super(...args)
    ...
    invokePutBucketPolicy(partialParams: ToOptional<{
      [K in keyof Omit<PutBucketPolicyRequest, "Bucket"> & keyof Omit<PutBucketPolicyRequest, "Policy">]: (Omit<PutBucketPolicyRequest, "Bucket"> & Omit<PutBucketPolicyRequest, "Policy">)[K]
    }>): void {
