...
export default class extends aws.s3.ObjectCopy {
    public ops: any // TODO make private
    private client: any
    capitalizedParams: {[key: string]: any}
    booted: boolean
    constructor(...args: ConstructorParameters<typeof aws.s3.ObjectCopy>) {
        super(...args)
        this.booted = false;
    ...
    invokeAbortMultipartUpload(partialParams: ToOptional<{
      [K in keyof AbortMultipartUploadRequest & keyof Omit<AbortMultipartUploadRequest, "Bucket" | "Key">]: (AbortMultipartUploadRequest)[K]
    ...
    invokeCompleteMultipartUpload(partialParams: ToOptional<{
      [K in keyof CompleteMultipartUploadRequest & keyof Omit<CompleteMultipartUploadRequest, "Bucket" | "Key">]: (CompleteMultipartUploadRequest)[K]
    ...
    invokeCopyObject(partialParams: ToOptional<{
      [K in keyof CopyObjectRequest & keyof Omit<CopyObjectRequest, "Bucket" | "Key">]: (CopyObjectRequest)[K]
    ...
    invokeCreateMultipartUpload(partialParams: ToOptional<{
      [K in keyof CreateMultipartUploadRequest & keyof Omit<CreateMultipartUploadRequest, "Bucket" | "Key">]: (CreateMultipartUploadRequest)[K]
    ...
    invokeDeleteObject(partialParams: ToOptional<{
      [K in keyof DeleteObjectRequest & keyof Omit<DeleteObjectRequest, "Bucket" | "Key">]: (DeleteObjectRequest)[K]
    ...
    invokeDeleteObjectTagging(partialParams: ToOptional<{
      [K in keyof DeleteObjectTaggingRequest & keyof Omit<DeleteObjectTaggingRequest, "Bucket" | "Key">]: (DeleteObjectTaggingRequest)[K]
    ...
    invokeGetObject(partialParams: ToOptional<{
      [K in keyof GetObjectRequest & keyof Omit<GetObjectRequest, "Bucket" | "Key">]: (GetObjectRequest)[K]
    ...
    invokeGetObjectAcl(partialParams: ToOptional<{
      [K in keyof GetObjectAclRequest & keyof Omit<GetObjectAclRequest, "Bucket" | "Key">]: (GetObjectAclRequest)[K]
    ...
    invokeGetObjectLegalHold(partialParams: ToOptional<{
      [K in keyof GetObjectLegalHoldRequest & keyof Omit<GetObjectLegalHoldRequest, "Bucket" | "Key">]: (GetObjectLegalHoldRequest)[K]
    ...
    invokeGetObjectRetention(partialParams: ToOptional<{
      [K in keyof GetObjectRetentionRequest & keyof Omit<GetObjectRetentionRequest, "Bucket" | "Key">]: (GetObjectRetentionRequest)[K]
    ...
    invokeGetObjectTagging(partialParams: ToOptional<{
      [K in keyof GetObjectTaggingRequest & keyof Omit<GetObjectTaggingRequest, "Bucket" | "Key">]: (GetObjectTaggingRequest)[K]
    ...
    invokeGetObjectTorrent(partialParams: ToOptional<{
      [K in keyof GetObjectTorrentRequest & keyof Omit<GetObjectTorrentRequest, "Bucket" | "Key">]: (GetObjectTorrentRequest)[K]
    ...
    invokeHeadObject(partialParams: ToOptional<{
      [K in keyof HeadObjectRequest & keyof Omit<HeadObjectRequest, "Bucket" | "Key">]: (HeadObjectRequest)[K]
    ...
    invokeListParts(partialParams: ToOptional<{
      [K in keyof ListPartsRequest & keyof Omit<ListPartsRequest, "Bucket" | "Key">]: (ListPartsRequest)[K]
    ...
    invokePutObject(partialParams: ToOptional<{
      [K in keyof PutObjectRequest & keyof Omit<PutObjectRequest, "Bucket" | "Key">]: (PutObjectRequest)[K]
    ...
    invokePutObjectAcl(partialParams: ToOptional<{
      [K in keyof PutObjectAclRequest & keyof Omit<PutObjectAclRequest, "Bucket" | "Key">]: (PutObjectAclRequest)[K]
    ...
    invokePutObjectLegalHold(partialParams: ToOptional<{
      [K in keyof PutObjectLegalHoldRequest & keyof Omit<PutObjectLegalHoldRequest, "Bucket" | "Key">]: (PutObjectLegalHoldRequest)[K]
    ...
    invokePutObjectRetention(partialParams: ToOptional<{
      [K in keyof PutObjectRetentionRequest & keyof Omit<PutObjectRetentionRequest, "Bucket" | "Key">]: (PutObjectRetentionRequest)[K]
    ...
    invokePutObjectTagging(partialParams: ToOptional<{
      [K in keyof PutObjectTaggingRequest & keyof Omit<PutObjectTaggingRequest, "Bucket" | "Key">]: (PutObjectTaggingRequest)[K]
    ...
    invokeRestoreObject(partialParams: ToOptional<{
      [K in keyof RestoreObjectRequest & keyof Omit<RestoreObjectRequest, "Bucket" | "Key">]: (RestoreObjectRequest)[K]
    ...
    invokeSelectObjectContent(partialParams: ToOptional<{
      [K in keyof SelectObjectContentRequest & keyof Omit<SelectObjectContentRequest, "Bucket" | "Key">]: (SelectObjectContentRequest)[K]
    ...
    invokeUploadPart(partialParams: ToOptional<{
      [K in keyof UploadPartRequest & keyof Omit<UploadPartRequest, "Bucket" | "Key">]: (UploadPartRequest)[K]
    ...
    invokeUploadPartCopy(partialParams: ToOptional<{
      [K in keyof UploadPartCopyRequest & keyof Omit<UploadPartCopyRequest, "Bucket" | "Key">]: (UploadPartCopyRequest)[K]
