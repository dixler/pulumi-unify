...
export default class extends aws.quicksight.User {
    ...
    invokeCreateGroup(partialParams: ToOptional<{
      [K in keyof CreateGroupRequest & keyof Omit<CreateGroupRequest, "AwsAccountId" | "Namespace">]: (CreateGroupRequest)[K]
    ...
    invokeCreateGroupMembership(partialParams: ToOptional<{
      [K in keyof CreateGroupMembershipRequest & keyof Omit<CreateGroupMembershipRequest, "AwsAccountId" | "Namespace">]: (CreateGroupMembershipRequest)[K]
    ...
    invokeDeleteGroup(partialParams: ToOptional<{
      [K in keyof DeleteGroupRequest & keyof Omit<DeleteGroupRequest, "AwsAccountId" | "Namespace">]: (DeleteGroupRequest)[K]
    ...
    invokeDeleteGroupMembership(partialParams: ToOptional<{
      [K in keyof DeleteGroupMembershipRequest & keyof Omit<DeleteGroupMembershipRequest, "AwsAccountId" | "Namespace">]: (DeleteGroupMembershipRequest)[K]
    ...
    invokeDeleteUser(partialParams: ToOptional<{
      [K in keyof DeleteUserRequest & keyof Omit<DeleteUserRequest, "UserName" | "AwsAccountId" | "Namespace">]: (DeleteUserRequest)[K]
    ...
    invokeDescribeGroup(partialParams: ToOptional<{
      [K in keyof DescribeGroupRequest & keyof Omit<DescribeGroupRequest, "AwsAccountId" | "Namespace">]: (DescribeGroupRequest)[K]
    ...
    invokeDescribeUser(partialParams: ToOptional<{
      [K in keyof DescribeUserRequest & keyof Omit<DescribeUserRequest, "UserName" | "AwsAccountId" | "Namespace">]: (DescribeUserRequest)[K]
    ...
    invokeGenerateEmbedUrlForRegisteredUser(partialParams: ToOptional<{
      [K in keyof GenerateEmbedUrlForRegisteredUserRequest & keyof Omit<GenerateEmbedUrlForRegisteredUserRequest, "AwsAccountId" | "UserArn">]: (GenerateEmbedUrlForRegisteredUserRequest)[K]
    ...
    invokeGetDashboardEmbedUrl(partialParams: ToOptional<{
      [K in keyof GetDashboardEmbedUrlRequest & keyof Omit<GetDashboardEmbedUrlRequest, "AwsAccountId" | "IdentityType">]: (GetDashboardEmbedUrlRequest)[K]
    ...
    invokeListGroupMemberships(partialParams: ToOptional<{
      [K in keyof ListGroupMembershipsRequest & keyof Omit<ListGroupMembershipsRequest, "AwsAccountId" | "Namespace">]: (ListGroupMembershipsRequest)[K]
    ...
    invokeListIAMPolicyAssignmentsForUser(partialParams: ToOptional<{
      [K in keyof ListIAMPolicyAssignmentsForUserRequest & keyof Omit<ListIAMPolicyAssignmentsForUserRequest, "AwsAccountId" | "UserName" | "Namespace">]: (ListIAMPolicyAssignmentsForUserRequest)[K]
    ...
    invokeListUserGroups(partialParams: ToOptional<{
      [K in keyof ListUserGroupsRequest & keyof Omit<ListUserGroupsRequest, "UserName" | "AwsAccountId" | "Namespace">]: (ListUserGroupsRequest)[K]
    ...
    invokeRegisterUser(partialParams: ToOptional<{
      [K in keyof RegisterUserRequest & keyof Omit<RegisterUserRequest, "IdentityType" | "Email" | "UserRole" | "AwsAccountId" | "Namespace">]: (RegisterUserRequest)[K]
    ...
    invokeUpdateGroup(partialParams: ToOptional<{
      [K in keyof UpdateGroupRequest & keyof Omit<UpdateGroupRequest, "AwsAccountId" | "Namespace">]: (UpdateGroupRequest)[K]
    ...
    invokeUpdateUser(partialParams: ToOptional<{
      [K in keyof UpdateUserRequest & keyof Omit<UpdateUserRequest, "UserName" | "AwsAccountId" | "Namespace" | "Email">]: (UpdateUserRequest)[K]
