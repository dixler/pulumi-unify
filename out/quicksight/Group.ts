...
export default class extends aws.quicksight.Group {
    ...
    invokeListGroupMemberships(partialParams: ToOptional<{
      [K in keyof ListGroupMembershipsRequest & keyof Omit<ListGroupMembershipsRequest, "AwsAccountId"> & keyof ListGroupMembershipsRequest & keyof Omit<ListGroupMembershipsRequest, "GroupName"> & keyof ListGroupMembershipsRequest]: (ListGroupMembershipsRequest & Omit<ListGroupMembershipsRequest, "AwsAccountId"> & ListGroupMembershipsRequest & Omit<ListGroupMembershipsRequest, "GroupName"> & ListGroupMembershipsRequest)[K]
    }>): ListGroupMembershipsResponse {
    ...
    invokeUpdateGroup(partialParams: ToOptional<{
      [K in keyof UpdateGroupRequest & keyof Omit<UpdateGroupRequest, "AwsAccountId"> & keyof UpdateGroupRequest & keyof Omit<UpdateGroupRequest, "GroupName"> & keyof Omit<UpdateGroupRequest, "Namespace">]: (UpdateGroupRequest & Omit<UpdateGroupRequest, "AwsAccountId"> & UpdateGroupRequest & Omit<UpdateGroupRequest, "GroupName"> & Omit<UpdateGroupRequest, "Namespace">)[K]
    }>): UpdateGroupResponse {
